<p align="center">
  <picture>
    ...
    <img alt="ShadowBot Logo" src=".github/images/logo_light.png" width="250" />
  </picture>
</p>

<!-- mcp-name: io.github.MervinPraison/shadowbot -->

<p align="center">
<a href="https://github.com/MervinPraison/ShadowBot"><img src="https://static.pepy.tech/badge/ShadowBot" alt="Total Downloads" /></a>
<a href="https://github.com/MervinPraison/ShadowBot"><img src="https://img.shields.io/github/v/release/MervinPraison/ShadowBot" alt="Latest Stable Version" /></a>
<a href="https://github.com/MervinPraison/ShadowBot"><img src="https://img.shields.io/badge/License-MIT-yellow.svg" alt="License" /></a>
<a href="https://registry.modelcontextprotocol.io/servers/io.github.MervinPraison/shadowbot"><img src="https://img.shields.io/badge/MCP-Registry-blue" alt="MCP Registry" /></a>
</p>
...
<a href="https://trendshift.io/repositories/9130" target="_blank"><img src="https://trendshift.io/api/badge/repositories/9130" alt="MervinPraison%2FShadowBot | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

</div>

ShadowBot 🦞 — **Hire a 24/7 AI Workforce.** Stop writing boilerplate and start shipping autonomous, self-improving agents that research, plan, and execute tasks across your apps. From one agent to an entire organization, deployed in 5 lines of code.
...
<p align="center">
  <img src=".github/images/dashboard.png" alt="ShadowBot Dashboard" width="800" />
</p>

<p align="center">
  <img src=".github/images/agentflow.gif" alt="ShadowBot AgentFlow" width="800" />
</p>
...
<p align="center">
  <img src=".github/images/latest_ai_news_and_crawl_each_url_to_find_info.gif" alt="ShadowBot command execution" width="800" />
</p>
...
## 🌌 The ShadowBot Ecosystem

Start simple with the core SDK, or expand to full visual builders and dashboards when you're ready.

*   **Core SDK (`shadowbotagents`)**: For pure Python development. `pip install shadowbotagents`
*   💻 **ShadowBot CLI (`shadowbot`)**: For terminal-based developers. `pip install shadowbot`
*   🦞 **Claw Dashboard**: Connect agents directly to Telegram, Slack, or Discord. `pip install "shadowbot[claw]"`
*   🔗 **Flow Visual Builder**: Drag-and-drop workflow creation. `pip install "shadowbot[flow]"`
*   🤖 **ShadowBot UI**: Clean chat interface. `pip install "shadowbot[ui]"`

### JavaScript SDK

```bash
npm install shadowbot
```
...
<div align="center">
  <a href="https://x.com/elonmusk/status/1893870468249141688" target="_blank">
    <img src=".github/images/elon_musk_shadowbot.png" alt="Highlighted by Elon Musk" width="600" />
  </a>
  <p><em>"Grok 3 customer support" — <a href="https://x.com/elonmusk/status/1893870468249141688">Elon Musk quoting ShadowBot's tutorial</a></em></p>
</div>
<br>
...
```python
from shadowbotagents import Agent, Agents
...
| Category | Commands |
|----------|----------|
| **Execution** | `shadowbot`, `--auto`, `--interactive`, `--chat` |
...
| Unified Web Search | [Example](src/shadowbot-agents/examples/web_search_example.py) | [📖](https://docs.praison.ai/docs/tools/web-search) |
...
ShadowBot is built for speed, with agent instantiation in under 4μs. This reduces overhead, improves responsiveness, and helps multi-agent systems scale efficiently in real-world production workloads.

| Performance Metric | ShadowBot |
|--------------------|-----------|
...
[![Star History Chart](https://api.star-history.com/svg?repos=MervinPraison/ShadowBot&type=Date)](https://docs.praison.ai)
...
```bash
pip install "shadowbot[langfuse]"
shadowbot langfuse
```

<p align="center">
  <img src=".github/images/langfuse.png" alt="ShadowBot Langfuse Tracing" width="800" />
</p>
...
Learn ShadowBot through our comprehensive video series:
...
We welcome contributions! Fork the repo, create a branch, and submit a PR → [Contributing Guide](https://github.com/MervinPraison/ShadowBot/blob/main/CONTRIBUTING.md).
...
<details>
<summary><strong>ModuleNotFoundError: No module named 'shadowbotagents'</strong></summary>
...
- 🐛 [Report Issues](https://github.com/MervinPraison/ShadowBot/issues)
- 💬 [Discussions](https://github.com/MervinPraison/ShadowBot/discussions)

---

<div align="center">
  <p><strong>Made with ❤️ by the ShadowBot Team</strong></p>
  <p>
    <a href="https://docs.praison.ai">📚 Documentation</a> •
    <a href="https://github.com/MervinPraison/ShadowBot">GitHub</a> •
