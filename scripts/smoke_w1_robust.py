...
Run::
    ...
    PYTHONPATH=src/shadowbot-agents:src/shadowbot python scripts/smoke_w1_robust.py
"""
...
async def test_three_platform_unification(tmp_path: Path, model: str) -> bool:
    ...
    from shadowbotagents.session import (
...
async def test_self_improving_probe(tmp_path: Path, model: str) -> bool:
    ...
    from shadowbotagents import Agent
    from shadowbotagents.session import FileIdentityResolver, DefaultSessionStore
    from shadowbot.bots._session import BotSessionManager
