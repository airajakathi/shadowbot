"""
Performance Benchmark Example for ShadowBot.

This example demonstrates how to measure and verify performance metrics
for ShadowBot CLI and SDK imports.
...
def main():
    print("=" * 60)
    print("ShadowBot Performance Benchmark")
    print("=" * 60)
    ...
    from shadowbot.cli.main import ShadowBot as ShadowBot2
    current, peak = tracemalloc.get_traced_memory()
    tracemalloc.stop()
    ...
    heavy_modules = ['litellm', 'instructor', 'shadowbot.auto']
