#!/usr/bin/env python3
"""
ShadowBot Recipe Server Advanced Features Example
...
# Reload Registry
from shadowbot.recipe.core import reload_registry
reload_registry()
...
""")
    ...
    try:
        from shadowbot.recipe.serve import create_rate_limiter, MetricsCollector, get_openapi_spec
        from shadowbot.recipe.core import get_template_search_paths, reload_registry
...
def main():
    ...
    print("=" * 60)
    print("ShadowBot Recipe Server Advanced Features")
    print("=" * 60)
