...
Usage:
    ...
    # Test with curl:
    curl http://localhost:8765/__shadowbot__/discovery
...
def main():
    ...
    try:
        ...
        print("Install with: pip install shadowbotagents fastapi uvicorn")
        sys.exit(1)
    ...
    # Discovery endpoint
    @app.get("/__shadowbot__/discovery")
    async def discovery():
        return {
            "schema_version": "1.0.0",
            "server_name": "shadowbot-unified",
            "providers": [
    ...
    async def agent_card():
        return {
            ...
            "description": "Unified ShadowBot server with multiple agents",
    ...
    print("\nEndpoints:")
    print("  GET  /__shadowbot__/discovery - Discovery document")
