...
def main():
    ...
    try:
        ...
        print("Error: shadowbotagents not installed")
        print("Install with: pip install shadowbotagents")
        sys.exit(1)
...
def launch_manual(agents):
    ...
    app = FastAPI(title="ShadowBot Multi-Agent API")
    ...
    async def discovery():
        return {
            ...
            "server_name": "shadowbot-agents-router",
    ...
    async def root():
        return {
            "message": "ShadowBot Multi-Agent Router",
