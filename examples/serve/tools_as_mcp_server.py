...
def main():
    ...
    try:
        ...
        print("Error: shadowbotagents[mcp] not installed")
        print("Install with: pip install 'shadowbotagents[mcp]'")
    ...
    # Create MCP server
    server = ToolsMCPServer(name="shadowbot-tools")
...
def run_manual_server():
    ...
    app = FastAPI(title="ShadowBot Tools MCP Server")
    ...
    async def discovery():
        return {
            ...
            "server_name": "shadowbot-tools-mcp",
