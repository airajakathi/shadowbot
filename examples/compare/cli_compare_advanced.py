...
from shadowbot.cli.features.compare import (
    CompareHandler,
    CompareResult,
    ModeResult,
    get_mode_config,
...
print("""
# Basic comparison
shadowbot "What is AI?" --compare "basic,tools"

# Compare with specific model
shadowbot "Explain quantum computing" --compare "basic,planning,research" --model gpt-4o

# Save results to file
shadowbot "Latest tech news" --compare "basic,tools,web_search" --compare-output results.json

# Verbose output
shadowbot "Write a poem" --compare "basic,planning" --verbose
""")
