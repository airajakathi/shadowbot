...
This example demonstrates how to use ShadowBot policy packs for managing tool permissions, data policies, and execution modes.
...
```bash
# Show default policy
shadowbot recipe policy show

# Show policy from file
shadowbot recipe policy show my-policy.yaml

# Create policy template
shadowbot recipe policy init -o my-policy.yaml

# Validate policy file
shadowbot recipe policy validate my-policy.yaml
```
...
shadowbot recipe run my-recipe --policy my-policy.yaml --mode prod
```
