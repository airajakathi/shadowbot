...
This example demonstrates how to use the PostgreSQL tool with ShadowBot agents.

Requirements:
    pip install "shadowbot[tools]"
    Docker: docker run -d --name postgres -e POSTGRES_PASSWORD=praison123 -e POSTGRES_DB=shadowbot -p 5432:5432 postgres:16

Usage:
    python tool.py
"""

from shadowbot_tools import PostgresTool
