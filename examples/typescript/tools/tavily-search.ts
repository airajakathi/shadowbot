 ...
 * 
 * Prerequisites:
 *   npm install shadowbot @tavily/ai-sdk
 *   export TAVILY_API_KEY=your-api-key
 *   export OPENAI_API_KEY=your-api-key
 */

// For local development, use relative imports
// For production, use: import { Agent, tavilySearch } from 'shadowbot-ts'
import { Agent } from '../../../src/shadowbot-ts/src';
import { tavilySearch, tavilyExtract, tavilyCrawl } from '../../../src/shadowbot-ts/src/tools/builtins';
