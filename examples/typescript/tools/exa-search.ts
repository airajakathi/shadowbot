 ...
 * 
 * Prerequisites:
 *   npm install shadowbot-ts @exalabs/ai-sdk
 *   export EXA_API_KEY=your-api-key
 *   export OPENAI_API_KEY=your-api-key
 */

// For local development, use relative imports
// For production, use: import { Agent, exaSearch } from 'shadowbot-ts'
import { Agent } from '../../../src/shadowbot-ts/src';
import { exaSearch } from '../../../src/shadowbot-ts/src/tools/builtins';
