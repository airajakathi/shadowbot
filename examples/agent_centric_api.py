...
Demonstrates the consolidated feature parameters for ShadowBot Agents.
...
def example_url_parsing():
    ...
    agent = Agent(
        ...
        memory="postgresql://postgres:password@localhost:5432/shadowbot",
    )
...
if __name__ == "__main__":
    print("=" * 60)
    print("ShadowBot Agent-Centric API Examples")
    print("=" * 60)
