...
import { Agent } from '../../../src/shadowbot-ts/dist/agent/simple';
import { embed, embedMany, cosineSimilarity } from '../../../src/shadowbot-ts/dist/llm/embeddings';
...
async function main() {
  ...
  const result = await embed('ShadowBot is an AI agent framework');
