...
import { ContextAgent, createContextAgent, KnowledgeBase } from 'shadowbot';
...
async function main() {
  ...
  await kb.add({
    id: 'doc3',
    content: 'ShadowBot is a framework for building AI agents in TypeScript and Python.',
    metadata: { topic: 'shadowbot' }
  });
