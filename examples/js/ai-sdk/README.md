...
Examples demonstrating the AI SDK integration in ShadowBot TypeScript.

## Prerequisites

```bash
npm install shadowbot ai @ai-sdk/openai @ai-sdk/anthropic @ai-sdk/google zod
```
...
- [AI SDK Documentation](https://docs.shadowbot.com/docs/js/ai-sdk)
- [AI SDK CLI](https://docs.shadowbot.com/docs/js/ai-sdk-cli)
