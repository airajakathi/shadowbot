...
def run_command(args, description):
    """Run a shadowbot command and display results."""
    print(f"\n[{description}]")
    print(f"Command: shadowbot {' '.join(args)}")
    print("-" * 40)
    
    result = subprocess.run(
        ["python3", "-m", "shadowbot"] + args,
        capture_output=True,
        text=True
    )
...
def main():
    print("=" * 60)
    print("ShadowBot Package Manager Example")
    print("=" * 60)
    ...
    print("  shadowbot install requests")
    print("  shadowbot install 'requests>=2.28'")
    print("  shadowbot install requests httpx --upgrade")
    
    print("\nTo uninstall packages, use:")
    print("  shadowbot uninstall requests")
    print("  shadowbot uninstall requests --yes")
    ...
    print("  shadowbot install pkg --extra-index-url https://other.index.com/simple")
    print("  → Error: Extra index URLs not allowed")
    
    print("\nExample (explicitly allowed):")
    print("  shadowbot install pkg --extra-index-url https://other.index.com/simple --allow-extra-index")
