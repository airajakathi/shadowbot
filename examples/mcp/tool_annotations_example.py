...
import json
from shadowbot.mcp_server.registry import MCPToolDefinition, MCPToolRegistry
...
def demo_tool_with_title():
    ...
    tool = MCPToolDefinition(
        name="shadowbot.workflow.run",
        description="Execute a ShadowBot workflow from YAML definition",
