"""
Storage Backends Example for ShadowBot Agents.
...
from shadowbotagents.storage import (
    FileBackend,
    SQLiteBackend,
    BaseJSONStore,
    get_backend,
...
def example_training_storage_with_backend():
    ...
    try:
        ...
        print("shadowbot package not installed, skipping training example")
...
def example_session_manager_with_backend():
    ...
    try:
        from shadowbot.cli.state.sessions import SessionManager
        ...
        print("shadowbot package not installed, skipping session example")
...
def example_run_history_with_backend():
    ...
    try:
        ...
        print("shadowbot package not installed, skipping run history example")
...
def example_mcp_tool_index_with_backend():
    ...
    try:
        ...
        print("shadowbot package not installed, skipping MCP example")
...
if __name__ == "__main__":
    print("ShadowBot Storage Backends Examples")
    print("=" * 50)
