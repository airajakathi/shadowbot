...
test_content = """
# ShadowBot Framework Overview

ShadowBot is an AI agents framework that enables building sophisticated AI applications.
...
print("-" * 40)
response = agent.chat("What are the key features of ShadowBot?")
print(response)
