...
Demonstrates transcription and text-to-speech using ShadowBot capabilities.
"""

from shadowbot.capabilities import transcribe, speech
...
print("See CLI: shadowbot audio transcribe <file>")
print("See CLI: shadowbot audio speech <text>")
