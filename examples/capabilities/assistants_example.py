...
Demonstrates OpenAI Assistants API using ShadowBot capabilities.
"""
...
print("\nSee CLI: shadowbot assistants list")
print("See CLI: shadowbot assistants create --name 'My Assistant'")
