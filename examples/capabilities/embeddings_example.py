...
Demonstrates text embedding generation using ShadowBot capabilities.
Both `embed` and `embedding` work identically - use whichever you prefer.
"""

from shadowbot import embed, embedding  # Both work from top-level
# Or: from shadowbot.capabilities import embed, embedding
