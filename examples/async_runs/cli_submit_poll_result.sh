...
#
# This example demonstrates how to use the ShadowBot CLI to:
...
echo "============================================================"
echo "ShadowBot Async Jobs CLI Example"
echo "============================================================"
...
if ! curl -s "$API_URL/health" > /dev/null 2>&1; then
    ...
    echo "  Start the server with: python -m uvicorn shadowbot.jobs.server:create_app --port 8005 --factory"
    exit 1
fi
