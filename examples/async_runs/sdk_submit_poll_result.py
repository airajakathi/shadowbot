...
This example demonstrates how to use the ShadowBot Jobs SDK to:
...
def main():
    print("=" * 60)
    print("ShadowBot Async Jobs SDK Example")
    print("=" * 60)
    ...
    try:
        ...
        print("  Start the server with: python -m uvicorn shadowbot.jobs.server:create_app --port 8005 --factory")
        return
