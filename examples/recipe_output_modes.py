...
CLI Usage:
    shadowbot recipe run my-recipe --output status
    shadowbot recipe run my-recipe --output trace
    shadowbot recipe run my-recipe -v  # alias for --output verbose
"""
...
if __name__ == "__main__":
    ...
    print("Create one with: shadowbot recipe init my-recipe")
    print()
