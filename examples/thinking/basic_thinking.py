#!/usr/bin/env python3
"""
Basic Thinking Budgets Example for ShadowBot Agents.
...
from shadowbotagents.thinking import ThinkingBudget, ThinkingTracker
from shadowbotagents.thinking.budget import BudgetLevel
