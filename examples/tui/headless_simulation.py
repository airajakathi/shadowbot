"""
Headless TUI Simulation Example for ShadowBot.
...
import asyncio
from shadowbot.cli.features.tui import (
    TuiOrchestrator,
    SimulationRunner,
    MockProvider,
)
from shadowbot.cli.features.tui.orchestrator import OutputMode
...
def main():
    """Main entry point."""
    print("ShadowBot TUI Headless Simulation Example")
    print("=" * 50)
