#!/usr/bin/env python3
"""
Basic Doctor Example - Programmatic health checks for ShadowBot
...
# Add the shadowbot path for development
sys.path.insert(0, '/Users/praison/shadowbot-package/src/shadowbot')

from shadowbot.cli.features.doctor import DoctorEngine
from shadowbot.cli.features.doctor.models import DoctorConfig, CheckCategory
from shadowbot.cli.features.doctor.registry import get_registry
from shadowbot.cli.features.doctor.checks import register_all_checks
from shadowbot.cli.features.doctor.formatters import get_formatter
...
if __name__ == "__main__":
    print("ShadowBot Doctor - Programmatic Usage Examples\n")
