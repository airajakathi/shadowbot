...
This example demonstrates how to integrate ShadowBot Doctor
...
def run_doctor_ci():
    ...
    print("Running ShadowBot Doctor in CI mode...")
    
    result = subprocess.run(
        [sys.executable, "-m", "shadowbot", "doctor", "ci"],
        capture_output=True,
        text=True,
        timeout=120
    )
...
def run_specific_checks_ci():
    ...
    result = subprocess.run(
        [
            sys.executable, "-m", "shadowbot", "doctor",
            "--json",
...
if __name__ == "__main__":
    print("ShadowBot Doctor - CI Integration Examples\n")
    print("=" * 60)
