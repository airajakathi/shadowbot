...
def demo_token_budget():
    ...
    from shadowbotagents.rag.budget import TokenBudget, get_model_context_window
...
def demo_strategy_selection():
    ...
    from shadowbotagents.rag.strategy import select_strategy, get_strategy_description, RetrievalStrategy
    from shadowbotagents.knowledge.indexing import CorpusStats
...
def demo_smart_retriever():
    ...
    from shadowbotagents.rag.retriever import SmartRetriever, SimpleReranker
