# ShadowBot Performance Monitoring Examples

This directory contains 10 comprehensive examples demonstrating how to integrate performance monitoring with ShadowBot agents. Each example builds upon the basic pattern while showcasing different aspects of the monitoring system.
...
from shadowbotagents.telemetry import monitor_function, track_api_call
...
1. **Install ShadowBot with performance monitoring support:**
   ```bash
...
- [ShadowBot Documentation](https://docs.shadowbot.com)
- [Performance Monitoring Guide](../../../src/shadowbot-agents/shadowbotagents/telemetry/README.md)
- [API Reference](../../../src/shadowbot-agents/shadowbotagents/telemetry/__init__.py)
