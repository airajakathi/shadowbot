# ShadowBot Example Plugin

This is a template for creating tool plugins for ShadowBot Agents.
...
pip install shadowbot-example-plugin
```
...
from shadowbot_example_plugin import GreetTool, MathTool, reverse_text
