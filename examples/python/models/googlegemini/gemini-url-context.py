...
through ShadowBot. The URL Context tool allows the model to fetch and analyze
...
def main():
    ...
    url_tasks = [
        ...
        {
            "url": "https://github.com/MervinPraison/ShadowBot",
            "task": "Analyze this GitHub repository and explain what ShadowBot does"
        },
        {
    ...
    for i, item in enumerate(url_tasks, 1):
        ...
        try:
            ...
            # In ShadowBot, this would need to be accessed through the LLM response
