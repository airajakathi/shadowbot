...
This example demonstrates how to use various AWS Bedrock models with ShadowBot agents.

Requirements:
    pip install shadowbotagents boto3
...
def main():
    """
    Example of using AWS Bedrock models with ShadowBot agents
    """
