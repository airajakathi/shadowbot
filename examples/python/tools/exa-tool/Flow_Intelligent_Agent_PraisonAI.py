# # -*- coding: utf-8 -*-
# """Flow_Intelligent_Agent_ShadowBot.ipynb
...
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DhivyaBharathy-web/ShadowBot/blob/main/examples/cookbooks/Flow_Intelligent_Agent_ShadowBot.ipynb)

# ## Tools
# - `shadowbotagents` – Intelligent Agent framework
...
# pip install shadowbotagents duckduckgo-search pyyaml openai
