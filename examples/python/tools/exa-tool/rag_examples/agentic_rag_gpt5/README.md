...
An agentic RAG application built with the ShadowBot Agents framework, featuring GPT-5 and built-in vector search for efficient knowledge retrieval and question answering.
...
- **"What is ShadowBot?"** - Learn about the ShadowBot Agents framework
- **"Teams in ShadowBot"** - Understand how teams work in ShadowBot
...
- **`Agent`**: ShadowBot Agents framework for intelligent Q&A
...
- **Storage**: Local storage managed by ShadowBot Agents
- **Search**: Automatic similarity search

### Model Configuration
- **LLM**: OpenAI GPT-5-nano
- **Embeddings**: Automatic handling by ShadowBot Agents
...
### Default Knowledge
- Starts with ShadowBot documentation: `https://docs.shadowbot.com/introduction/agents.md`
...
- Check if ShadowBot Agents is properly installed
...
**Built with ❤️ using ShadowBot Agents and GPT-5**
