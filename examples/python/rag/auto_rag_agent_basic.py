...
import os
from shadowbotagents import Agent, AutoRagAgent
...
with open(sample_doc, "w") as f:
    f.write("""
ShadowBot Framework Documentation

ShadowBot is an AI agents framework that supports:
...
response = auto_rag.chat("What features does ShadowBot support?")
