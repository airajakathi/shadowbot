"""MCP Server with Built-in ShadowBot Tools

Expose ShadowBot's built-in tools as an MCP server.
...
from shadowbotagents.mcp import launch_tools_mcp_server


if __name__ == "__main__":
    # Expose built-in ShadowBot tools as MCP server
