...
This example demonstrates callback systems using ShadowBot's built-in
callback functionality for monitoring agent interactions and tool usage.
"""

from shadowbotagents import Agent, Task, AgentTeam
from shadowbotagents.display_callback import register_display_callback
...
# Register callbacks with ShadowBot's callback system
