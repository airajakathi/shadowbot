#!/usr/bin/env python3
"""
Human Approval Example for ShadowBot Agents
...
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', '..', 'src', 'shadowbot-agents'))

from shadowbotagents import Agent, Task, AgentTeam
from shadowbotagents.tools import python_tools, file_tools, shell_tools
from shadowbotagents.main import register_approval_callback
...
def main():
    ...
    print("🤖 ShadowBot Human Approval System Demo")
    print("=" * 50)
