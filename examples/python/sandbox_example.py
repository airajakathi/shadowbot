...
from shadowbotagents.sandbox import SecurityPolicy
...
if __name__ == "__main__":
    ...
    print("  shadowbot sandbox run \"print('Hello, World!')\"")
    print("  shadowbot sandbox run --file script.py")
    print("  shadowbot sandbox shell")
