"""Motion Graphics — single-agent factory (requires shadowbotagents + LLM key).
...
Requirements:
    pip install shadowbot-tools[video-motion] shadowbotagents[llm]
...
from shadowbot_tools.video.motion_graphics import create_motion_graphics_agent
