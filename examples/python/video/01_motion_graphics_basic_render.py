...
Requirements:
    pip install shadowbot-tools[video-motion]
...
from shadowbot_tools.video.motion_graphics import HtmlRenderBackend, RenderOpts
...
async def main() -> None:
    ...
    opts = RenderOpts(output_name="shadowbot_demo.mp4", fps=30, quality="standard")
