...
from shadowbotagents.tools import read_csv, write_csv
...
def method_1_simple_loop():
    """
    The easiest way to process CSV files with ShadowBot agents.
...
if __name__ == "__main__":
    print("CSV Processing with ShadowBot Agents - Multiple Methods Demo")
    print("=" * 70)
    ...
    try:
        ...
        print("- shadowbotagents package installed (pip install shadowbotagents)")
