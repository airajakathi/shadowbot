...
in combination with other ShadowBot agents. It shows how Context Engineering can
...
from shadowbotagents import Agent, Task, AgentTeam, create_context_agent
