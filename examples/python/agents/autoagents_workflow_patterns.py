...
from shadowbot.auto import AutoGenerator, WorkflowAutoGenerator
import os
import tempfile
...
shadowbot workflow auto "Research and write a report" --pattern sequential
shadowbot workflow auto "Research from multiple sources" --pattern parallel
shadowbot workflow auto "Comprehensive market analysis" --pattern orchestrator-workers
shadowbot workflow auto "Refine content quality" --pattern evaluator-optimizer

# With output file
shadowbot workflow auto "Customer support routing" --pattern routing --output support.yaml
""")
