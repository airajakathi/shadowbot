...
Demonstrates how to use ShadowBot's code editing tools with SEARCH/REPLACE diffs.
"""
...
# Write a file
print("\nWriting test file:")
code_write_file("test_output.txt", "Hello from ShadowBot Code Tools!")
...
diff = """
<<<<<<< SEARCH
Hello from ShadowBot Code Tools!
=======
Hello from ShadowBot Code Tools!
