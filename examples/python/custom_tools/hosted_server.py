"""
Hosted MCP Server implementation for ShadowBot Agents.
...
Note: This is an example implementation. To use it, ensure you have installed:
  pip install shadowbotagents[mcp] starlette>=0.27.0
"""
...
try:
    ...
    raise ImportError(
        ...
        "Please install with: pip install shadowbotagents[mcp] starlette>=0.27.0"
    )
