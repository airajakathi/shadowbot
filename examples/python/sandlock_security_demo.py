...
Requires: pip install 'shadowbot[sandbox]' (installs sandlock)
"""

import asyncio
from shadowbotagents.sandbox import ResourceLimits, SecurityPolicy, SandboxConfig
...
async def demonstrate_sandlock_security():
    ...
    try:
        ...
        print("❌ SandlockSandbox requires: pip install 'shadowbot[sandbox]'")
        print("   Falling back to SubprocessSandbox (less secure)")
        from shadowbot.sandbox import SubprocessSandbox
