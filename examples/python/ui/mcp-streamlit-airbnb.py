...
if st.session_state.agent_initialized and st.session_state.agent:
    ...
    with st.expander("ℹ️ About this Application"):
        ...
        tools with ShadowBot Agents in a Streamlit environment.
...
st.markdown(
    ...
    <div style='text-align: center; color: gray;'>
        Built with ShadowBot Agents + MCP • 
        <a href='https://github.com/MervinPraison/ShadowBot' target='_blank'>GitHub</a> • 
        <a href='https://docs.shadowbot.com' target='_blank'>Documentation</a>
    </div>
    """, 
