...
for a ShadowBot Agent. The agent runs in Anthropic's managed infrastructure.

Prerequisites:
    export ANTHROPIC_API_KEY="your-key"
    pip install 'anthropic>=0.94.0' shadowbotagents shadowbot
...
def example_1_standalone():
    """Example 1: Use ManagedAgentIntegration directly (no ShadowBot Agent)."""
    print("\n" + "=" * 60)
...
def example_2_with_agent():
    """Example 2: Use ManagedAgentIntegration as a ShadowBot Agent backend."""
    print("\n" + "=" * 60)
    print("Example 2: ShadowBot Agent with managed backend")
    print("=" * 60)
