...
Demonstrates using ShadowBot Agent with all social media tools
...
Required environment variables (set only the ones you need):
    ...
    # WordPress (uses shadowbotwp-cli config — no env vars needed)
...
result = agent.start(
    ...
    "'ShadowBot v2.0 is here! Build AI agents in 3 lines of code. "
    "Multi-agent workflows, memory, tools, and more. Try it: pip install shadowbotagents'"
)
print(result)
