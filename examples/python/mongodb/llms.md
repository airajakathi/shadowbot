# ShadowBot Documentation

## Docs

- [AI Agents](https://docs.praison.ai/docs/agents/agents.md): Overview of all available ShadowBot agents and their capabilities
...
- [Agent Module](https://docs.praison.ai/docs/api/shadowbotagents/agent/agent.md): Documentation for the shadowbotagents.agent.agent module