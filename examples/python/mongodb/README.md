# MongoDB Integration Examples for ShadowBot Agents

This directory contains comprehensive examples demonstrating how to integrate MongoDB with ShadowBot agents for memory, knowledge, and data operations.

## Features

MongoDB integration with ShadowBot provides:
...
```bash
# Install ShadowBot with MongoDB support
pip install 'shadowbotagents[mongodb]'
```
...
- **Python 3.10+**: Required for ShadowBot
...
Demonstrates using MongoDB as a memory provider for ShadowBot agents.
...
These examples are provided under the same license as ShadowBot.