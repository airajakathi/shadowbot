#!/usr/bin/env python3
"""
MongoDB Memory Example for ShadowBot Agents

This example demonstrates how to use MongoDB as a memory provider for ShadowBot agents.
...
def main():
    ...
    try:
        ...
        try:
            ...
            print("Memory features not available - install with: pip install 'shadowbotagents[memory]'")
...
if __name__ == "__main__":
    print("MongoDB Memory Example for ShadowBot Agents")
    print("=" * 50)
