...
def example_file_indexer():
    ...
    from shadowbotagents.context.fast.indexer import FileIndexer
...
def example_symbol_indexer():
    ...
    from shadowbotagents.context.fast.indexer import SymbolIndexer, SymbolType
...
def example_context_injector():
    ...
    from shadowbotagents.context.fast import FastContext
    from shadowbotagents.context.fast.context_injector import (
        ContextInjector,
        InjectionConfig
    )
