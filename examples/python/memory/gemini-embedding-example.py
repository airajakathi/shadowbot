#!/usr/bin/env python3
"""
Example: Using Gemini Embedding Models with ShadowBot Memory

This example demonstrates how to configure ShadowBot to use Google's Gemini
...
Prerequisites:
1. Install shadowbotagents with memory support:
   pip install "shadowbotagents[memory]"

2. Set your Google API key:
   export GOOGLE_API_KEY='your-api-key'

3. Ensure litellm is installed (comes with shadowbotagents)
"""
