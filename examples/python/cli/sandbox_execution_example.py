"""
Sandbox Execution Example for ShadowBot CLI.

Secure isolated command execution (--sandbox flag).
Docs: https://docs.praison.ai/cli/sandbox-execution
"""

from shadowbot.cli.features import SandboxExecutorHandler
from shadowbot.cli.features.sandbox_executor import SandboxMode
