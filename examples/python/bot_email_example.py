...
This example shows how to deploy ShadowBot agents as email bots
...
def example_with_config():
    ...
    from shadowbot.bots import Bot
    from shadowbotagents import BotConfig
...
# ── Example 6: YAML config (for shadowbot bot CLI) ───────────────

YAML_EXAMPLE = """
# bot.yaml — Save this file and run: shadowbot bot --config bot.yaml
agent:
  name: email_support
  instructions: >
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] in examples:
        ...
        print("ShadowBot Email Bot Examples")
        print("=" * 40)
        print()
