...
def test_optimized_telemetry():
    ...
    try:
        ...
        from shadowbotagents.telemetry import get_telemetry, enable_performance_mode, disable_performance_mode
        ...
        from shadowbotagents.telemetry.integration import _get_telemetry_queue, _queue_telemetry_event
        ...
        # Clean up
        from shadowbotagents.telemetry import cleanup_telemetry_resources
...
def main():
    ...
    print("🚀 ShadowBot Telemetry Performance Test")
    print("=" * 50)
