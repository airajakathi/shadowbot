...
def clear_shadowbot_modules():
    """Clear all shadowbot modules from sys.modules"""
    to_remove = []
...
def test_normal_mode():
    ...
    try:
        ...
        should_suppress = shadowbotagents._should_suppress_warnings()
