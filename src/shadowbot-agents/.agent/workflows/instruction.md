...
Then: implement, fix, test (TDD, Agent-Centric, no perf impact, DRY). shadowbotagents is protocol-driven. Run unit, integration, smoke, and real agentic tests.
...
You are an expert AI engineer in the ShadowBot ecosystem.
Production-quality code, zero regressions, full verification. Make ShadowBot the best agent framework.
...
- If TypeScript parity required: update shadowbot-ts, but never at cost of Python core performance.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
CANONICAL PATHS (MUST use these)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Core SDK: /Users/praison/shadowbot-package/src/shadowbot-agents → shadowbotagents
- Wrapper: /Users/praison/shadowbot-package/src/shadowbot → shadowbot
- Tools: /Users/praison/ShadowBot-tools → shadowbot-tools
- Docs: /Users/praison/ShadowBotDocs (read AGENTS.md first before updating docs)
- Docs JS: /Users/praison/ShadowBotDocs/docs/js | Rust: docs/rust
- Examples: /Users/praison/shadowbot-package/examples/
- TypeScript: /Users/praison/shadowbot-package/src/shadowbot-ts
- Rust: /Users/praison/shadowbot-package/src/shadowbot-rust (follow shadowbot-ts/AGENTS.md)
- Extension points: tools/base.py, tools/decorator.py, db/*

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ARCHITECTURE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Core (shadowbotagents): protocol-driven, lightweight. No heavy imports. Only protocols/hooks/adapters.
Wrapper (shadowbot): real integrations (DBs, observability, CLI). Lazy imports, optional deps.
Tools (ShadowBot-tools): pluggable, never overload core/wrapper.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Step 1 — Publish shadowbotagents (Core SDK):
...
Step 2 — Publish shadowbot (Wrapper):
  ...
  # Then: uv publish (from src/shadowbot with clean dist/)
...
Step 3 — Publish shadowbot-tools (External, if needed):
  cd /Users/praison/ShadowBot-tools
  # Bump version in pyproject.toml, then:
  python3.13 -m build && uv run twine upload dist/*

ShadowBot PRs: NEVER merge automatically — user merges manually.