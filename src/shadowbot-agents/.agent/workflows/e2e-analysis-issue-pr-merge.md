...
- **Protocol-driven core**: `shadowbotagents` = lightweight, protocol-first (protocols/hooks/adapters only).
...
Tools:       /Users/praison/ShadowBot-tools
Docs:        /Users/praison/ShadowBotDocs
TypeScript:  /Users/praison/shadowbot-package/src/shadowbot-ts
AGENTS.md:   /Users/praison/shadowbot-package/src/shadowbot-agents/AGENTS.md
```
...
## Phase 3 — ShadowBot Codebase Inventory
...
```bash
# Core SDK
ls /Users/praison/shadowbot-package/src/shadowbot-agents/shadowbotagents/
grep -r "class.*Protocol" shadowbotagents/ --include="*.py" | wc -l

# Wrapper
ls /Users/praison/shadowbot-package/src/shadowbot/shadowbot/
ls /Users/praison/shadowbot-package/src/shadowbot/shadowbot/cli/commands/

# TypeScript
ls /Users/praison/shadowbot-package/src/shadowbot-ts/src/
```
...
- [ ] Protocol-driven core (no heavy impls in `shadowbotagents`)
...
# Smoke test
python -c "from shadowbotagents import <Feature>; print('OK')"
...
```bash
ISSUE_NUM=$(gh issue view <number> --repo MervinPraison/ShadowBot --json number --jq '.number')
...
```bash
REPO_URL=https://github.com/MervinPraison/ShadowBot.git
BRANCH=<branch-name>
...
import sys
from shadowbot.observability import <NewThing>  # example
...
timeout 30 python -c "import time; t=time.time(); import shadowbotagents; print(f'{(time.time()-t)*1000:.1f} ms')"
```
...
- [ ] **Protocol-driven core (§4.1)**: no heavy implementations leaked into `shadowbotagents`.
