...
allowed_dirs = [
    "/Users/praison/shadowbot-package/src/shadowbot-agents",
]
...
filesystem_agent.start("List files in /Users/praison/shadowbot-package/src/shadowbot-agents directory using MCP list_files")