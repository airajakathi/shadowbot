...
context_output = context_agent.start("https://github.com/MervinPraison/ShadowBot/ Need to add Authentication")
...
try:
    ...
    search_terms = ["authentication", "security", "implementation", "requirements", "ShadowBot"]
