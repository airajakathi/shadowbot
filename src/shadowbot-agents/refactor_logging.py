...
target_dir = '/Users/praison/shadowbot-package/src/shadowbot-agents/shadowbotagents'
...
for path in files_to_check:
    ...
    if 'logging.getLogger' in content:
        ...
        if 'from shadowbotagents._logging import get_logger' not in content:
            ...
            if 'import logging' in content:
                ...
                content = 'from shadowbotagents._logging import get_logger\n' + content
