...
import os
from shadowbotagents.telemetry import get_telemetry, disable_telemetry, enable_telemetry
...
import shadowbotagents.telemetry.telemetry as telemetry_module
reload(telemetry_module)

from shadowbotagents.telemetry import get_telemetry as get_new_telemetry
...
from shadowbotagents.telemetry.telemetry import TelemetryCollector
