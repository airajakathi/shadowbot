...
import shadowbotagents.telemetry
print("   Telemetry module imported")

print("\n2. Check if auto_instrument_all was called...")
print(f"   _initialized: {shadowbotagents.telemetry._initialized}")
...
from shadowbotagents.telemetry.integration import auto_instrument_all
auto_instrument_all()
