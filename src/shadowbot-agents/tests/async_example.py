...
from shadowbotagents import Agent, Task, AgentTeam, TaskOutput
from shadowbotagents.main import (
    display_error,
    display_interaction,
    display_tool_call,
    display_instruction,
...
async def main():
    ...
    display_instruction("Starting ShadowBot Agents Examples...", console)
