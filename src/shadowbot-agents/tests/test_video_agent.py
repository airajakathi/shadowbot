...
class TestVideoAgentImport:
    ...
    def test_import_from_shadowbotagents(self):
        ...
        from shadowbotagents import VideoAgent, VideoConfig
    ...
    def test_import_from_agent_module(self):
        ...
        from shadowbotagents.agent import VideoAgent, VideoConfig
        assert VideoAgent is not None
        assert VideoConfig is not None
    
    def test_import_direct(self):
        """Test direct import from video_agent module."""
        from shadowbotagents.agent.video_agent import VideoAgent, VideoConfig
        assert VideoAgent is not None
        assert VideoConfig is not None
...
class TestVideoConfig:
    ...
    def test_default_values(self):
        ...
        from shadowbotagents import VideoConfig
