...
class TestFileMatch:
    ...
    def test_add_line_range(self):
        ...
        from shadowbotagents.context.fast.result import FileMatch, LineRange
...
class TestFastContextResult:
    ...
    def test_add_file(self):
        """Test adding files."""
        from shadowbotagents.context.fast.result import FastContextResult, FileMatch
    ...
    def test_add_duplicate_file_merges(self):
        ...
        from shadowbotagents.context.fast.result import (
