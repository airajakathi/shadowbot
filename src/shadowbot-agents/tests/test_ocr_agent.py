...
class TestOCRAgentImports:
    ...
    def test_import_from_package(self):
        ...
        from shadowbotagents import OCRAgent, OCRConfig
    ...
    def test_import_from_agent_module(self):
        ...
        from shadowbotagents.agent import OCRAgent, OCRConfig
        assert OCRAgent is not None
        assert OCRConfig is not None
...
class TestOCRAgentInit:
    ...
    def test_default_init(self):
        ...
        from shadowbotagents import OCRAgent
        agent = OCRAgent()
...
class TestOCRConfig:
    ...
    def test_default_config(self):
        ...
        from shadowbotagents import OCRConfig
        config = OCRConfig()
...
class TestOCRAgentOperations:
    ...
    @patch('shadowbotagents.agent.ocr_agent.OCRAgent.litellm', new_callable=lambda: MagicMock())
