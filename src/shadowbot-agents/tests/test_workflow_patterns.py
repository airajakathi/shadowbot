...
import tempfile
import os
from shadowbotagents import Workflow, WorkflowContext, StepResult, Pipeline
from shadowbotagents.workflows import (
...
class TestBackwardCompatibility:
    ...
    def test_import_from_memory_workflows(self):
        """Test imports from shadowbotagents.memory.workflows still work."""
        from shadowbotagents.memory.workflows import (
    ...
    def test_import_from_memory_module(self):
        """Test imports from shadowbotagents.memory still work."""
        from shadowbotagents.memory import Workflow, Pipeline, route, parallel
    ...
    def test_step_input_output_aliases(self):
        ...
        from shadowbotagents.workflows import StepInput, StepOutput
...
"""
        with tempfile.TemporaryDirectory() as tmpdir:
            workflows_dir = os.path.join(tmpdir, ".shadowbot", "workflows")
