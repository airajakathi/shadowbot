...
class TestToolConfigTranslation:
    def test_string_tools_pass_through(self):
        from shadowbot.integrations.managed_local import _translate_anthropic_tools
        result = _translate_anthropic_tools(["execute_command", "read_file"])
        assert result == ["execute_command", "read_file"]

    def test_empty_returns_defaults(self):
        from shadowbot.integrations.managed_local import _translate_anthropic_tools, _DEFAULT_TOOLS
...
class TestManagedSandboxSafety:
    ...
    def test_install_packages_without_compute_raises(self):
        ...
        import pytest
        from shadowbot.integrations.managed_local import LocalManagedAgent, LocalManagedConfig
        from shadowbot.integrations.managed_agents import ManagedSandboxRequired
    ...
    def test_install_packages_with_host_packages_ok_succeeds(self):
        ...
        with patch('shadowbot.integrations.managed_local.subprocess.run') as mock_run:
    ...
    def test_empty_packages_no_error(self):
        ...
        from shadowbot.integrations.managed_local import LocalManagedConfig, LocalManagedAgent
...
class TestAnthropicManagedAgentBackwardCompat:
    def test_class_exists(self):
        from shadowbot.integrations.managed_agents import AnthropicManagedAgent
