...
class TestToolAliasConsistency(TestCase):
    ...
    def test_tool_alias_single_source_of_truth(self):
        ...
        from shadowbot.integrations._tool_aliases import TOOL_ALIAS_MAP as shared_map
        
        # Import the mapping as used in managed_agents.py
        from shadowbot.integrations.managed_agents import TOOL_ALIAS_MAP as agents_map
        
        # Import the mapping as used in managed_local.py
        from shadowbot.integrations.managed_local import TOOL_ALIAS_MAP as local_map
    ...
    def test_known_aliases_stable(self):
        ...
        from shadowbot.integrations._tool_aliases import TOOL_ALIAS_MAP
    ...
    def test_resolved_conflicts(self):
        ...
        # (matches ShadowBot grep_tool.py built-in)
        ...
        # (matches ShadowBot code/tools/apply_diff.py)  
    ...
    def test_no_duplicate_definitions(self):
        ...
        from shadowbot import integrations
        ...
        import shadowbot.integrations.managed_local as managed_local_module
