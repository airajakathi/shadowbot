...
class TestComputeProtocol:
    def test_protocol_importable(self):
        from shadowbotagents.managed.protocols import ComputeProviderProtocol
    ...
    def test_instance_info_defaults(self):
        from shadowbotagents.managed.protocols import InstanceInfo, InstanceStatus
    ...
    def test_instance_status_enum(self):
        from shadowbotagents.managed.protocols import InstanceStatus
...
class TestLocalCompute:
    ...
    def test_provision_and_execute(self):
        from shadowbot.integrations.compute.local import LocalCompute
        from shadowbotagents.managed.protocols import ComputeConfig, InstanceStatus
...
class TestExportsFromManagedInit:
    def test_protocol_exports(self):
        from shadowbotagents.managed import (
