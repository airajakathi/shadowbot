...
- Test converting AG-UI messages to ShadowBot format
- Test converting ShadowBot messages to AG-UI format
- Test handling of tool calls
- Test handling of tool results
- Test edge cases (empty messages, missing fields)
"""

class TestAGUIToShadowBotConversion:
    """Test converting AG-UI messages to ShadowBot format."""
    
    def test_convert_user_message(self):
        """Test converting a user message."""
        from shadowbotagents.ui.agui.conversion import agui_messages_to_shadowbot
        from shadowbotagents.ui.agui.types import Message
        
        agui_messages = [Message(role="user", content="Hello")]
        result = agui_messages_to_shadowbot(agui_messages)
    ...
    def test_convert_assistant_with_tool_calls(self):
        ...
        from shadowbotagents.ui.agui.conversion import agui_messages_to_shadowbot
        from shadowbotagents.ui.agui.types import Message, ToolCall, FunctionCall
    ...
    def test_convert_empty_messages(self):
        ...
        result = agui_messages_to_shadowbot([])
        assert result == []
...
class TestShadowBotToAGUIConversion:
    """Test converting ShadowBot messages to AG-UI format."""
    
    def test_convert_user_message(self):
        """Test converting a user message."""
        from shadowbotagents.ui.agui.conversion import shadowbot_messages_to_agui
        
        praison_messages = [{"role": "user", "content": "Hello"}]
        result = shadowbot_messages_to_agui(praison_messages)
    ...
    def test_convert_empty_messages(self):
        ...
        result = shadowbot_messages_to_agui([])
        assert result == []
...
class TestStateConversion:
    ...
    def test_validate_dict_state(self):
        ...
        from shadowbotagents.ui.agui.conversion import validate_state
...
class TestExtractUserInput:
    ...
    def test_extract_last_user_message(self):
        ...
        from shadowbotagents.ui.agui.conversion import extract_user_input
        from shadowbotagents.ui.agui.types import Message
