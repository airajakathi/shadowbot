...
class TestA2AToShadowBot:
    """Tests for converting A2A messages to ShadowBot format."""
    
    def test_convert_user_message(self):
        """Test converting A2A user message to ShadowBot format."""
        from shadowbotagents.ui.a2a.conversion import a2a_to_shadowbot_messages
        ...
        result = a2a_to_shadowbot_messages([a2a_msg])
    ...
    def test_convert_agent_message(self):
        """Test converting A2A agent message to ShadowBot format."""
        from shadowbotagents.ui.a2a.conversion import a2a_to_shadowbot_messages
        from shadowbotagents.ui.a2a.types import Message, Role, TextPart
    ...
    def test_convert_conversation_history(self):
        ...
        result = a2a_to_shadowbot_messages(messages)
...
class TestShadowBotToA2A:
    """Tests for converting ShadowBot responses to A2A format."""
    
    def test_convert_string_response(self):
        """Test converting string response to A2A Message."""
        from shadowbotagents.ui.a2a.conversion import shadowbot_to_a2a_message
        
        response = "This is the agent's response."
        
        result = shadowbot_to_a2a_message(response)
    ...
    def test_convert_response_with_context(self):
        ...
        result = shadowbot_to_a2a_message(response, context_id="ctx-123")
    ...
    def test_convert_response_with_task(self):
        ...
        result = shadowbot_to_a2a_message(response, task_id="task-456")
...
class TestArtifactConversion:
    ...
    def test_create_artifact_from_response(self):
        ...
        from shadowbotagents.ui.a2a.conversion import create_artifact
