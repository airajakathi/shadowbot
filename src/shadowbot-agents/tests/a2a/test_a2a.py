...
class TestA2APartConversion:
    ...
    def test_parse_message_with_url_part(self):
        ...
        from shadowbotagents.ui.a2a.a2a import _parse_message
    ...
    def test_conversion_url_part_to_openai(self):
        ...
        from shadowbotagents.ui.a2a.types import Message, FilePart, Role
        ...
        result = a2a_to_shadowbot_messages([msg])
        assert len(result) == 1
    ...
    def test_conversion_data_part_to_openai(self):
        ...
        from shadowbotagents.ui.a2a.conversion import a2a_to_shadowbot_messages
        from shadowbotagents.ui.a2a.types import Message, DataPart, Role
    ...
    def test_extract_user_input_with_url_parts(self):
        ...
        from shadowbotagents.ui.a2a.types import Message, FilePart, TextPart, Role
...
class TestA2AExtendedCard:
    ...
    def test_get_extended_card_with_callback(self):
        ...
        from fastapi.testclient import TestClient
        from shadowbotagents.ui.a2a.types import AgentCard, AgentSkill
...
class TestA2AClient:
    ...
    def test_client_import(self):
        ...
        from shadowbotagents.ui.a2a.client import A2AClient
