"""
Context Management Benchmarks for ShadowBot Agents.
...
def benchmark_context_disabled():
    ...
    from shadowbotagents.context import ContextManager, ManagerConfig
...
def benchmark_token_estimation():
    ...
    from shadowbotagents.context import estimate_messages_tokens
...
def benchmark_optimization_small():
    ...
    from shadowbotagents.context import get_optimizer, OptimizerStrategy
...
def benchmark_store_operations():
    ...
    from shadowbotagents.context import ContextStoreImpl, reset_global_store
...
def benchmark_effective_history_filter():
    ...
    from shadowbotagents.context import get_effective_history
