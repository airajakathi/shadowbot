...
class TestMem0IntegrationLive:
    ...
    def test_rag_context_builder_with_mem0_results(self):
        ...
        from shadowbotagents.rag.context import build_context, deduplicate_chunks
...
class TestImportPerformance:
    ...
    def test_core_import_does_not_load_mem0(self):
        """Test that importing shadowbotagents doesn't load mem0."""
        ...
        if 'shadowbotagents' in sys.modules:
            importlib.reload(sys.modules['shadowbotagents'])
        else:
    ...
    def test_knowledge_import_does_not_load_mem0(self):
        ...
        from shadowbotagents import Knowledge  # noqa: F401
