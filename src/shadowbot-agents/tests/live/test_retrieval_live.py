...
def test_knowledge_dir():
    ...
    3. ShadowBot is an AI agents framework.
    
    ## Details
    
    Paris is known for the Eiffel Tower.
    Python was created by Guido van Rossum.
    ShadowBot supports multi-agent workflows.
    """
...
class TestLiveRetrieval:
    ...
    def test_retrieval_config_policy_auto(self, test_knowledge_dir):
        ...
        from shadowbotagents import Agent
        from shadowbotagents.rag.retrieval_config import RetrievalConfig, RetrievalPolicy
        ...
        response = agent.chat("What is ShadowBot?")
...
class TestLiveExports:
    ...
    def test_retrieval_config_creation(self):
        ...
        from shadowbotagents import RetrievalConfig, RetrievalPolicy, CitationsMode
