...
class TestEvaluationLoopIntegration:
    ...
    def test_evaluation_loop_with_agent_and_judge(self):
        ...
        from shadowbotagents.eval import EvaluationLoop, EvaluationLoopResult
        
        with patch('shadowbotagents.agent.agent.Agent.chat') as mock_chat, \
...
class TestEvaluationLoopResultSerialization:
    ...
    def test_result_to_json(self):
        ...
        from shadowbotagents.eval.results import IterationResult, EvaluationLoopResult
        import json
