...
Tests the improved ShadowBot comment format with:
...
# Add shadowbot wrapper to path
PRAISONAI_ROOT = Path(__file__).parent.parent.parent.parent.parent / "src" / "shadowbot"
...
class TestEnhancedStickyComment:
    ...
    def test_enhanced_body_structure(self):
        ...
        sticky.add_usage_example("from shadowbot import cool_feature\ncool_feature.run()")
        ...
        assert "🤖 ShadowBot completed" in body  # Header
        ...
        assert "Powered by [ShadowBot]" in body  # Footer
    ...
    def test_progressive_sections_appear(self):
        ...
        assert "Powered by [ShadowBot]" in body
    ...
    def test_clickable_file_links(self):
        ...
        sticky = StickyComment(
            ...
            title="Test",
            run_url="",
            repo_name="MervinPraison/ShadowBot"
        )
        ...
        assert "https://github.com/MervinPraison/ShadowBot/blob/feature/test/src/main.py" in body
...
class TestEnhancedIntegration:
    ...
    def test_live_comment_updates(self):
        ...
        Steps:
        1. Create test issue
        2. Run: shadowbot github triage --issue <NUM>
