...
from shadowbotagents.config.feature_configs import (
...
class TestMethodExistence:
    ...
    def test_mixin_inheritance(self):
        ...
        from shadowbotagents.agent.tool_execution import ToolExecutionMixin
        from shadowbotagents.agent.chat_mixin import ChatMixin
        from shadowbotagents.agent.memory_mixin import MemoryMixin
        from shadowbotagents.agent.execution_mixin import ExecutionMixin
