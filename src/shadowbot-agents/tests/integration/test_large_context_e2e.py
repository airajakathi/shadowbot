...
class TestLargeContextE2E:
    ...
    def test_full_indexing_pipeline(self):
        ...
        from shadowbotagents.knowledge.indexing import CorpusStats, IndexResult
    ...
    def test_strategy_selection_by_corpus_size(self):
        ...
        from shadowbotagents.rag.strategy import select_strategy, RetrievalStrategy
    ...
    def test_token_budget_enforcement(self):
        ...
        from shadowbotagents.rag.budget import TokenBudget, DefaultBudgetEnforcer
    ...
    def test_compression_pipeline(self):
        ...
        from shadowbotagents.rag.compressor import ContextCompressor
    ...
    def test_smart_retriever_filtering(self):
        ...
        from shadowbotagents.rag.retriever import SmartRetriever
...
class TestPerformance:
    ...
    def test_import_time_acceptable(self):
        ...
        cmd = [
            sys.executable, "-c",
            "import time; start=time.time(); import shadowbotagents; print(time.time()-start)"
        ]
    ...
    def test_no_heavy_deps_at_import(self):
        ...
        cmd = [
            sys.executable, "-c",
            "import sys; import shadowbotagents; print('mem0' in sys.modules)"
        ]
        result = subprocess.run(cmd, capture_output=True, text=True, timeout=30)
