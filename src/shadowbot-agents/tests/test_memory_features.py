...
from shadowbotagents.memory import (
    FileMemory,
    RulesManager,
)
...
class TestAiDecisionActivation(unittest.TestCase):
    ...
    def test_ai_decision_rule_loaded(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            rules_dir = Path(tmpdir) / ".shadowbot" / "rules"
            rules_dir.mkdir(parents=True)
...
class TestAutoMemory(unittest.TestCase):
    ...
    def test_extract_name(self):
        ...
        from shadowbotagents.memory import AutoMemoryExtractor
    ...
    def test_auto_memory_wrapper(self):
        ...
        from shadowbotagents.memory import AutoMemory
...
class TestWorkflows(unittest.TestCase):
    ...
    def test_workflow_discovery(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            workflows_dir = Path(tmpdir) / ".shadowbot" / "workflows"
...
class TestHooks(unittest.TestCase):
    ...
    def test_hooks_config_loading(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            config_dir = Path(tmpdir) / ".shadowbot"
            config_dir.mkdir()
    ...
    def test_create_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config_path = Path(tmpdir) / ".shadowbot" / "hooks.json"
