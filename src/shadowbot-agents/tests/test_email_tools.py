...
class TestEmailTools(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import shadowbotagents.tools.email_tools as et
        et._client = None
    ...
    def test_send_email_success(self):
        ...
        with patch.dict("sys.modules", {"agentmail": mock_mod}):
            from shadowbotagents.tools.email_tools import send_email
            import shadowbotagents.tools.email_tools as et
    ...
    def test_list_emails_success(self):
        ...
        with patch.dict("sys.modules", {"agentmail": mock_mod}):
            from shadowbotagents.tools.email_tools import list_emails
            import shadowbotagents.tools.email_tools as et
            et._client = None
    ...
    def test_read_email_success(self):
        ...
        with patch.dict("sys.modules", {"agentmail": mock_mod}):
            from shadowbotagents.tools.email_tools import read_email
            import shadowbotagents.tools.email_tools as et
            et._client = None
    ...
    def test_list_inboxes_success(self):
        ...
        with patch.dict("sys.modules", {"agentmail": mock_mod}):
            from shadowbotagents.tools.email_tools import list_inboxes
            import shadowbotagents.tools.email_tools as et
            et._client = None
    ...
    def test_email_profile_exists(self):
        from shadowbotagents.tools.profiles import get_profile
    ...
    def test_lazy_import_from_tools_package(self):
        from shadowbotagents.tools import send_email
        from shadowbotagents.tools.email_tools import send_email as direct
    ...
    def test_reply_email_success(self):
        ...
        with patch.dict("sys.modules", {"agentmail": mock_mod}):
            from shadowbotagents.tools.email_tools import reply_email
            import shadowbotagents.tools.email_tools as et
            et._client = None
    ...
    def test_create_inbox_success(self):
        ...
        with patch.dict("sys.modules", {"agentmail": mock_mod}):
            from shadowbotagents.tools.email_tools import create_inbox
            import shadowbotagents.tools.email_tools as et
            et._client = None
    ...
    def test_smtp_send_email_missing_creds(self):
        ...
        from shadowbotagents.tools.email_tools import smtp_send_email
    ...
    def test_smtp_read_inbox_missing_creds(self):
        os.environ.pop("EMAIL_ADDRESS", None)
        os.environ.pop("EMAIL_PASSWORD", None)
        from shadowbotagents.tools.email_tools import smtp_read_inbox
    ...
    def test_smtp_lazy_import_from_tools_package(self):
        from shadowbotagents.tools import smtp_send_email
        from shadowbotagents.tools.email_tools import smtp_send_email as direct
