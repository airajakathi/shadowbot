...
from shadowbotagents.auth.subscription.protocols import SubscriptionCredentials
...
def test_claude_code_auth_flow():
    ...
    with patch('litellm.completion') as mock_completion:
        ...
        with patch('shadowbotagents.auth.resolve_subscription_credentials') as mock_resolve:
...
def test_auth_refresh_on_401():
    ...
    with patch('litellm.completion') as mock_completion:
        ...
        with patch('shadowbotagents.auth.resolve_subscription_credentials') as mock_resolve:
            ...
            with patch('shadowbotagents.auth.subscription.registry.get_subscription_provider') as mock_provider:
...
def test_codex_experimental_error():
    ...
    from shadowbotagents.auth.subscription.protocols import AuthError
