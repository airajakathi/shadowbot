...
class TestPromptExpanderImports:
    ...
    def test_import_from_package(self):
        ...
        from shadowbotagents import PromptExpanderAgent, ExpandStrategy, ExpandResult
    ...
    def test_import_from_agent_module(self):
        ...
        from shadowbotagents.agent import PromptExpanderAgent, ExpandStrategy, ExpandResult
        assert PromptExpanderAgent is not None
        assert ExpandStrategy is not None
        assert ExpandResult is not None
...
class TestExpandStrategy:
    ...
    def test_strategy_values(self):
        ...
        from shadowbotagents import ExpandStrategy
...
class TestExpandResult:
    ...
    def test_result_creation(self):
        ...
        from shadowbotagents import ExpandResult, ExpandStrategy
...
class TestPromptExpanderAgentInit:
    ...
    def test_default_initialization(self):
        ...
        from shadowbotagents import PromptExpanderAgent
...
class TestPromptExpansion:
    ...
    def test_expand_preserves_task_intent(self):
        ...
        from shadowbotagents import PromptExpanderAgent, ExpandResult
