"""
Example demonstrating telemetry usage in ShadowBot Agents.
...
from shadowbotagents.tools import DuckDuckGoSearchTool
...
def advanced_telemetry_example():
    ...
    telemetry = enable_telemetry(
        backend="opentelemetry",
        service_name="shadowbot-production",
...
if __name__ == "__main__":
    print("ShadowBot Agents Telemetry Examples")
    print("===================================")
