...
class TestMCPOptionalImport:
    ...
    def test_shadowbotagents_import_without_mcp(self):
        """Test that shadowbotagents can be imported without mcp installed."""
        # This should not raise any ImportError
        import shadowbotagents
        assert shadowbotagents is not None
    ...
    def test_mcp_lazy_loading(self):
        ...
        from shadowbotagents import MCP  # noqa: F401
    ...
    def test_mcp_module_import_no_crash(self):
        ...
        try:
            from shadowbotagents.mcp import mcp as mcp_module
    ...
    def test_mcp_sse_module_import_no_crash(self):
        ...
        try:
            from shadowbotagents.mcp import mcp_sse
    ...
    def test_mcp_http_stream_module_import_no_crash(self):
        ...
        try:
            from shadowbotagents.mcp import mcp_http_stream
    ...
    def test_mcp_raises_import_error_when_unavailable(self):
        ...
        import shadowbotagents.mcp.mcp as mcp_module
        ...
        try:
            from shadowbotagents.mcp.mcp import MCP
            with pytest.raises(ImportError) as exc_info:
                MCP('test-command')

            error_msg = str(exc_info.value)
            assert 'pip install shadowbotagents[mcp]' in error_msg
    ...
    def test_sse_client_raises_import_error_when_unavailable(self):
        ...
        import shadowbotagents.mcp.mcp_sse as sse_module

        original_available = sse_module.MCP_AVAILABLE
        sse_module.MCP_AVAILABLE = False

        try:
            from shadowbotagents.mcp.mcp_sse import SSEMCPClient
            with pytest.raises(ImportError) as exc_info:
    ...
    def test_http_stream_client_raises_import_error_when_mcp_unavailable(self):
        ...
        import shadowbotagents.mcp.mcp_http_stream as http_module

        original_available = http_module.MCP_AVAILABLE
        http_module.MCP_AVAILABLE = False

        try:
            from shadowbotagents.mcp.mcp_http_stream import HTTPStreamMCPClient
            with pytest.raises(ImportError) as exc_info:
