...
Demonstrates usage of tavily_search and tavily_extract from shadowbot-tools.
Also shows how to define variables in tools.py.
"""

# Import tavily tools from shadowbot-tools
from shadowbot_tools.tools import tavily_search, tavily_extract
