...
class TestAgentsPlanningTools:
    ...
    def test_shadowbotagents_accepts_planning_tools(self):
    ...
    def test_shadowbotagents_planning_tools_default_none(self):
    ...
    def test_shadowbotagents_passes_tools_to_planning_agent(self):
...
class TestAgentsPlanningReasoning:
    ...
    def test_shadowbotagents_accepts_planning_reasoning(self):
    ...
    def test_shadowbotagents_planning_reasoning_default_false(self):
    ...
    def test_shadowbotagents_passes_reasoning_to_planning_agent(self):
...
class TestResearchToolsList:
    ...
    def test_research_tools_list_exists(self):
        ...
        from shadowbotagents.planning import RESEARCH_TOOLS
