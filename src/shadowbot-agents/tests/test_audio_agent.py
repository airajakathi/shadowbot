...
class TestAudioAgentImport:
    ...
    def test_import_from_shadowbotagents(self):
        """Test import from main package."""
        from shadowbotagents import AudioAgent, AudioConfig
    ...
    def test_import_from_agent_module(self):
        ...
        from shadowbotagents.agent import AudioAgent, AudioConfig
        assert AudioAgent is not None
        assert AudioConfig is not None
    
    def test_import_direct(self):
        """Test direct import from audio_agent module."""
        from shadowbotagents.agent.audio_agent import AudioAgent, AudioConfig
        assert AudioAgent is not None
        assert AudioConfig is not None
...
class TestAudioAgentInit:
    ...
    def test_default_initialization(self):
        ...
        from shadowbotagents import AudioAgent
...
class TestAudioConfig:
    ...
    def test_default_values(self):
        ...
        from shadowbotagents import AudioConfig
