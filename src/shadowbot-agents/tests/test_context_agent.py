...
- Integration with existing ShadowBot structure
"""
...
def test_agent_inheritance():
    ...
    try:
        from shadowbotagents import ContextAgent, Agent
...
def test_context_engineering_methods():
    ...
    try:
        from shadowbotagents import create_context_agent
...
def test_protocol_compliance():
    ...
    try:
        from shadowbotagents import ContextAgent, create_context_agent
        from shadowbotagents.agent import ContextEngineerProtocol
...
def test_backward_compatibility():
    """Test that existing ShadowBot functionality still works."""
    print("\\n🧪 Testing Backward Compatibility...")
    
    try:
        # Test that we can still import and use existing agents
        from shadowbotagents import Agent, ImageAgent
        ...
        # Test that we can import other ShadowBot components
        from shadowbotagents import Task, AgentTeam
        ...
        for export in expected_exports:
            assert hasattr(shadowbotagents, export), f"Missing export: {export}"
...
def test_syntax_validation():
    ...
    try:
        ...
        context_agent_file = project_root / "shadowbotagents" / "agent" / "context_agent.py"
