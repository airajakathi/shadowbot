...
class TestToolsMCPServerInit:
    ...
    def test_init_with_name(self):
        ...
        from shadowbotagents.mcp.mcp_server import ToolsMCPServer
    ...
    def test_init_with_default_name(self):
        ...
        assert server.name == "shadowbot-tools"
...
class TestLaunchToolsMCPServer:
    ...
    def test_launch_function_exists(self):
        ...
        from shadowbotagents.mcp.mcp_server import launch_tools_mcp_server
