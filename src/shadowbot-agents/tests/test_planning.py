...
class TestPlanStep:
    ...
    def test_plan_step_creation_minimal(self):
        ...
        from shadowbotagents.planning import PlanStep
...
class TestPlan:
    ...
    def test_plan_creation_minimal(self):
        ...
        from shadowbotagents.planning import Plan
    ...
    def test_plan_creation_with_steps(self):
        ...
        from shadowbotagents.planning import Plan, PlanStep
...
class TestTodoItem:
    ...
    def test_todo_item_creation(self):
        ...
        from shadowbotagents.planning import TodoItem
...
class TestTodoList:
    ...
    def test_todo_list_creation(self):
        ...
        from shadowbotagents.planning import TodoList
    ...
    def test_todo_list_add_item(self):
        ...
        from shadowbotagents.planning import TodoList, TodoItem
    ...
    def test_todo_list_from_plan(self):
        ...
        from shadowbotagents.planning import TodoList, Plan, PlanStep
...
class TestPlanStorage:
    ...
    def test_storage_initialization(self, temp_dir):
        ...
        from shadowbotagents.planning import PlanStorage
    ...
    def test_storage_save_plan(self, temp_dir):
        """Test saving a plan."""
        from shadowbotagents.planning import PlanStorage, Plan, PlanStep
    ...
    def test_storage_list_plans(self, temp_dir):
        ...
        from shadowbotagents.planning import PlanStorage, Plan
    ...
    def test_storage_save_todo(self, temp_dir):
        ...
        from shadowbotagents.planning import PlanStorage, TodoList, TodoItem
...
class TestPlanningAgent:
    ...
    def test_planning_agent_creation(self):
        ...
        from shadowbotagents.planning import PlanningAgent
    ...
    async def test_planning_agent_create_plan(self):
        ...
        from shadowbotagents.planning import PlanningAgent, Plan
    ...
    async def test_planning_agent_refine_plan(self):
        ...
        from shadowbotagents.planning import PlanningAgent, Plan, PlanStep
...
class TestAgentsPlanningIntegration:
    ...
    def test_agents_planning_custom_llm(self):
        ...
        from shadowbotagents.config import MultiAgentPlanningConfig
        agents = AgentTeam(
            agents=[agent],
            tasks=[task],
...
class TestReadOnlyMode:
    ...
    def test_agent_plan_mode_enabled(self):
        ...
        from shadowbotagents import Agent
        from shadowbotagents.config import PlanningConfig
    ...
    def test_agent_read_only_tools_filter(self):
        ...
        from shadowbotagents import Agent
        from shadowbotagents.config import PlanningConfig
        from shadowbotagents.planning import READ_ONLY_TOOLS
    ...
    def test_restricted_tools_list(self):
        ...
        from shadowbotagents.planning import RESTRICTED_TOOLS
...
class TestApprovalFlow:
    ...
    def test_approval_callback_creation(self):
        ...
        from shadowbotagents.planning import ApprovalCallback
    ...
    def test_approval_callback_auto_approve(self):
        ...
        from shadowbotagents.planning import ApprovalCallback, Plan
    ...
    def test_approval_with_modifications(self):
        ...
        from shadowbotagents.planning import ApprovalCallback, Plan, PlanStep
...
class TestFullIntegration:
    ...
    async def test_full_planning_workflow(self, temp_dir):
        ...
        from shadowbotagents.planning import (
    ...
    def test_plan_persistence_roundtrip(self, temp_dir):
        ...
        from shadowbotagents.planning import Plan, PlanStep, PlanStorage
    ...
    def test_todo_list_sync_with_plan(self, temp_dir):
        ...
        from shadowbotagents.planning import Plan, PlanStep, TodoList
