...
3. Organized imports work (from shadowbotagents.config import X)
4. Namespace style works (import shadowbotagents as pa)
...
class TestCoreImports:
    ...
    def test_agents_import(self):
        ...
        from shadowbotagents import Agents
    ...
    def test_tools_class_import(self):
        ...
        from shadowbotagents import Tools
...
class TestBackwardsCompatImports:
    ...
    def test_knowledge_config_import(self):
        ...
        from shadowbotagents import KnowledgeConfig
    ...
    def test_execution_config_import(self):
        ...
        from shadowbotagents import ExecutionConfig
    ...
    def test_reflection_config_import(self):
        ...
        from shadowbotagents import ReflectionConfig
...
class TestOrganizedImports:
    ...
    def test_tools_base_tool(self):
        ...
        from shadowbotagents.tools.base import BaseTool
        assert BaseTool is not None
    ...
    def test_workflows_workflow(self):
        ...
        from shadowbotagents.workflows import Workflow
        assert Workflow is not None


class TestNamespaceStyle:
    """Test that 'import shadowbotagents as pa' style works."""
    
    def test_pa_agent(self):
        """pa.Agent works."""
        import shadowbotagents as pa
...
class TestAllSizeLimited:
    ...
    def test_all_size_under_29(self):
        ...
        assert len(shadowbotagents.__all__) < 29, \
            f"__all__ has {len(shadowbotagents.__all__)} items, expected < 29"
    ...
    def test_all_contains_core(self):
        ...
        for symbol in core:
            assert symbol in shadowbotagents.__all__, \
    ...
    def test_all_contains_subpackages(self):
        ...
        for pkg in subpackages:
            assert pkg in shadowbotagents.__all__, \
    ...
    def test_dir_matches_all(self):
        ...
        dir_items = set(dir(shadowbotagents))
        all_items = set(shadowbotagents.__all__)
...
class TestImportPerformance:
    ...
    def test_import_time_under_200ms(self):
        ...
        result = subprocess.run(
            [sys.executable, '-c', 
             'import time; t=time.time(); import shadowbotagents; print(time.time()-t)'],
            capture_output=True,
            text=True,
