...
from shadowbotagents.llm.rate_limiter import RateLimiter
from shadowbotagents.agent.handoff import Handoff
from shadowbotagents.workflows.workflows import Parallel, parallel
...
class TestParallelWorkersConfiguration:
    ...
    def test_parallel_default_cap_constant(self):
        ...
        from shadowbotagents.workflows.workflows import DEFAULT_MAX_PARALLEL_WORKERS
