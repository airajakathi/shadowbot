...
from shadowbotagents.config.feature_configs import LearnConfig, LearnScope, MemoryConfig
from shadowbotagents.memory.learn.stores import (
    PersonaStore,
    InsightStore,
    ThreadStore,
    PatternStore,
...
class TestBackendWiring:
    ...
    def test_sqlite_backend_round_trip(self):
        ...
        from shadowbotagents.config.feature_configs import LearnBackend
        config = LearnConfig(
...
class TestNoCortexParam:
    ...
    def test_no_cortex_module_in_agents(self):
        """shadowbotagents should not have cortex module."""
        import importlib.util
        
        spec = importlib.util.find_spec("shadowbotagents.cortex")
        assert spec is None, "shadowbotagents.cortex module should not exist"
