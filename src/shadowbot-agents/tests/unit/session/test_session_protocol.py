...
class TestSessionStoreProtocolExists:
    ...
    def test_import_from_session_package(self):
        ...
        from shadowbotagents.session import SessionStoreProtocol
        assert SessionStoreProtocol is not None
...
class TestHierarchicalSessionStoreConformance:
    ...
    def test_isinstance_check(self):
        ...
        from shadowbotagents.session.protocols import SessionStoreProtocol
        from shadowbotagents.session.hierarchy import HierarchicalSessionStore
...
class TestSessionExports:
    ...
    def test_hierarchy_exports(self):
        ...
        from shadowbotagents.session import HierarchicalSessionStore
    ...
    def test_session_snapshot_export(self):
        ...
        from shadowbotagents.session import SessionSnapshot
    ...
    def test_extended_session_data_export(self):
        ...
        from shadowbotagents.session import ExtendedSessionData
