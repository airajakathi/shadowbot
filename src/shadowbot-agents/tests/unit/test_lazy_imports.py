"""
Tests for lazy import behavior in shadowbotagents.
...
def clear_modules():
    """Clear all shadowbot, litellm, and requests related modules from cache."""
...
class TestLazyImports:
    ...
    def test_litellm_not_loaded_on_import(self):
        """litellm should NOT be loaded when importing shadowbotagents."""
    ...
    def test_requests_not_loaded_on_import(self):
        """requests should NOT be loaded when importing shadowbotagents."""
        import shadowbotagents  # noqa: F401
    ...
    def test_chromadb_not_loaded_on_import(self):
        """chromadb should NOT be loaded when importing shadowbotagents."""
    ...
    def test_session_available_via_getattr(self):
        ...
        Session = shadowbotagents.Session
    ...
    def test_knowledge_available_via_getattr(self):
        ...
        Knowledge = shadowbotagents.Knowledge
    ...
    def test_tools_loaded_eagerly(self):
        ...
        assert hasattr(shadowbotagents, 'Tools')
        assert shadowbotagents.Tools is not None
    
    def test_all_exports_accessible(self):
        """All items in __all__ should be accessible."""
        import shadowbotagents
        
        for name in shadowbotagents.__all__:
            # Some items may be None if optional deps not installed
            try:
                _ = getattr(shadowbotagents, name)
...
class TestLitePackage:
    ...
    def test_lite_import_fast(self):
        ...
        from shadowbotagents.lite import LiteAgent  # noqa: F401
    ...
    def test_lite_agent_no_litellm(self):
        ...
        from shadowbotagents.lite import LiteAgent
...
class TestTelemetryConfig:
    ...
    def test_telemetry_disabled_by_default(self):
        ...
        from shadowbotagents._config import TELEMETRY_ENABLED
    ...
    def test_telemetry_enabled_via_env(self):
        ...
        clear_modules()
        from shadowbotagents._config import _get_telemetry_enabled
