...
class TestCompletionDetection:
    ...
    @patch("shadowbotagents.agent.agent.Agent.chat")
...
class TestDoomLoopTrackerDelegation:
    ...
    def test_tracker_has_delegate(self):
        ...
        from shadowbotagents.escalation.doom_loop import DoomLoopDetector
...
class TestEscalationExports:
    ...
    def test_escalation_stage_importable(self):
        from shadowbotagents import EscalationStage
...
class TestAutonomySignalDeprecation:
    ...
    def test_autonomy_signal_still_works(self):
        ...
        from shadowbotagents.agent.autonomy import AutonomySignal
...
class TestDeescalation:
    ...
    @patch("shadowbotagents.agent.agent.Agent.chat")
    @patch("shadowbotagents.agent.agent.Agent.get_recommended_stage", return_value="planned")
...
class TestCLILoopParity:
    ...
    def test_loop_command_has_observe_flag(self):
        ...
        from shadowbot.cli.commands.loop import loop_main
        import inspect
...
class TestContentStreamingDetection:
    ...
    def test_repeated_chunks_detected(self):
        ...
        from shadowbotagents.escalation.doom_loop import DoomLoopDetector, DoomLoopConfig
