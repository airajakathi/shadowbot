...
class TestWorkflowContextPropagation:
    ...
    def test_workflow_context_true_propagates_to_temp_agents(self):
        ...
        from shadowbotagents import Workflow, Task
        ...
        with patch('shadowbotagents.agent.agent.Agent') as MockAgent:
...
class TestParallelLoopContextIsolation:
    ...
    def test_parallel_loop_workers_have_isolated_chat_history(self):
        ...
        from shadowbotagents.workflows.workflows import Workflow, Loop, Task
...
class TestWorkflowHandoffCycleState:
    ...
    def test_handoff_chain_resets_between_runs(self):
        ...
        from shadowbotagents.workflows.workflows import Workflow, Task
