...
import pytest
from shadowbotagents import Workflow, WorkflowContext, StepResult
from shadowbotagents.workflows import loop, Loop, Parallel, parallel, route
...
class TestConditionalBranching:
    ...
    def test_if_pattern_creation(self):
        ...
        from shadowbotagents.workflows import if_, If
    ...
    def test_if_inside_loop(self):
        ...
        # Reimport all classes fresh to avoid module cache pollution
        from shadowbotagents import Workflow, WorkflowContext, StepResult
        from shadowbotagents.workflows import if_, loop
...
class TestYAMLParsing:
    ...
    def test_parse_nested_loop_yaml(self):
        ...
        from shadowbotagents.workflows import Loop
        import tempfile
        import os
...
"""
    ...
    def test_parse_if_yaml(self):
        ...
        from shadowbotagents.workflows.yaml_parser import YAMLWorkflowParser
        from shadowbotagents.workflows import If
        import tempfile
        import os
