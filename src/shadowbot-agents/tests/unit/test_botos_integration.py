...
class TestBotWithMockAdapter:
    ...
    def setup_method(self):
        from shadowbot.bots._registry import register_platform, _custom_platforms
...
class TestRealAgentInBot:
    """Tests with a real shadowbotagents.Agent inside Bot."""
...
class TestAgentFlowInBotOS:
    ...
    def test_agent_flow_in_bot(self):
        from shadowbot.bots import Bot
        from shadowbotagents import Agent, AgentFlow, Task
...
class TestPlatformExtensibility:
    ...
    def teardown_method(self):
        from shadowbot.bots._registry import _custom_platforms
    ...
    def test_register_and_use_custom_platform(self):
        from shadowbot.bots._registry import register_platform, resolve_adapter
    ...
    def test_resolve_unknown_platform_raises(self):
        from shadowbot.bots._registry import resolve_adapter
...
class TestSmoke:
    ...
    def test_all_import_paths(self):
        ...
        from shadowbotagents.bots.protocols import BotOSProtocol
        from shadowbotagents.bots.config import BotOSConfig
        from shadowbotagents.bots import BotOSProtocol as P2
        from shadowbotagents.bots import BotOSConfig as C2
        from shadowbotagents import BotOSProtocol as P3
        from shadowbotagents import BotOSConfig as C3
        from shadowbot.bots import Bot, BotOS
        from shadowbot.bots._registry import (
    ...
    def test_protocol_identity(self):
        ...
        from shadowbotagents.bots.protocols import BotOSProtocol as A
        from shadowbotagents import BotOSProtocol as B
        assert A is B

    def test_config_identity(self):
        from shadowbotagents.bots.config import BotOSConfig as A
        from shadowbotagents import BotOSConfig as B
        assert A is B
    ...
    def test_builtin_platforms_count(self):
        from shadowbot.bots._registry import list_platforms
