...
from shadowbotagents.bots import BotMessage, BotUser, BotChannel
...
class TestMessageHookMixin:
    ...
    def test_import_mixin(self):
        ...
        from shadowbot.bots._protocol_mixin import MessageHookMixin
    ...
    def test_fire_message_sending_cancel(self):
        ...
        from shadowbot.bots._protocol_mixin import MessageHookMixin
        from shadowbotagents.hooks import HookRegistry, HookRunner
...
class TestMessageHookEventInputs:
    ...
    def test_message_received_input_exists(self):
        ...
        from shadowbotagents.hooks.events import MessageReceivedInput
    ...
    def test_message_sending_input_exists(self):
        ...
        from shadowbotagents.hooks.events import MessageSendingInput
    ...
    def test_message_sent_input_exists(self):
        ...
        from shadowbotagents.hooks.events import MessageSentInput
...
class TestGatewayStreamRelay:
    ...
    def test_process_agent_message_streams_tokens(self):
        ...
        from shadowbotagents.gateway import EventType
