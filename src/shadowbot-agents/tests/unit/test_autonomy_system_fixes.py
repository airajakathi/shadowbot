...
class TestF1_AgentManagerAutonomyPropagation:
    ...
    def test_autonomy_bool_propagated(self):
        ...
        from shadowbotagents.agents.agents import AgentManager
...
class TestF4_AutonomyConfigLevel:
    ...
    def test_autonomy_level_reexported(self):
        """AutonomyLevel should be importable from shadowbotagents."""
        from shadowbotagents import AutonomyLevel
        assert AutonomyLevel.SUGGEST.value == "suggest"

    def test_autonomy_config_reexported(self):
        """AutonomyConfig should be importable from shadowbotagents."""
        from shadowbotagents import AutonomyConfig
        cfg = AutonomyConfig()
...
class TestDRY_Exports:
    ...
    def test_autonomy_level_in_all(self):
        """AutonomyLevel should be in shadowbotagents.__all__."""
        import shadowbotagents
        assert "AutonomyLevel" in shadowbotagents.__all__

    def test_autonomy_config_in_all(self):
        """AutonomyConfig should be in shadowbotagents.__all__."""
        import shadowbotagents
        assert "AutonomyConfig" in shadowbotagents.__all__

    def test_autonomy_result_importable(self):
        """AutonomyResult should be importable."""
        from shadowbotagents.agent.autonomy import AutonomyResult
    ...
    def test_autonomy_stage_importable(self):
        ...
        from shadowbotagents.agent.autonomy import AutonomyStage
        from shadowbotagents.escalation.types import EscalationStage
...
class TestIntegration_AutonomyWiring:
    ...
    def test_autoagents_propagates_autonomy(self):
        ...
        from shadowbotagents.agents.autoagents import AutoAgents
