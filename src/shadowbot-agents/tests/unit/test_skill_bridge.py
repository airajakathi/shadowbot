...
class TestSkillInfo:
    ...
    def test_defaults(self):
        from shadowbotagents.tools.skill_bridge import SkillInfo
        info = SkillInfo()
        assert info.name == ""
...
class TestScanSkills:
    ...
    def test_scan_empty_dir(self, tmp_path):
        from shadowbotagents.tools.skill_bridge import scan_skills
...
class TestImportSkill:
    ...
    def test_import_extracts_functions(self, tmp_path):
        from shadowbotagents.tools.skill_bridge import import_skill
        skill = tmp_path / "my_skill"
        skill.mkdir()
...
class TestFormatScanReport:
    ...
    def test_format_empty(self):
        from shadowbotagents.tools.skill_bridge import format_scan_report
        assert format_scan_report([]) == "No skills found."

    def test_format_with_skills(self):
        from shadowbotagents.tools.skill_bridge import SkillInfo, format_scan_report
        skills = [
