...
class TestIndexResult:
    ...
    def test_import_index_result(self):
        ...
        from shadowbotagents.knowledge.indexing import IndexResult
...
class TestIgnoreMatcher:
    ...
    def test_import_ignore_matcher(self):
        ...
        from shadowbotagents.knowledge.indexing import IgnoreMatcher
...
class TestFileTracker:
    ...
    def test_import_file_tracker(self):
        ...
        from shadowbotagents.knowledge.indexing import FileTracker
