...
class TestBudgetExceededError:
    ...
    def test_import_from_agent_module(self):
        from shadowbotagents.agent.agent import BudgetExceededError
        assert issubclass(BudgetExceededError, Exception)

    def test_import_from_package(self):
        from shadowbotagents import BudgetExceededError
        assert issubclass(BudgetExceededError, Exception)
...
class TestAgentBudgetInit:
    ...
    def test_budget_from_execution_config(self):
        ...
        from shadowbotagents import Agent, ExecutionConfig
        agent = Agent(
            name="test",
            instructions="test",
