...
class TestTaskStatus:
    ...
    def test_enum_values(self):
        from shadowbotagents.task.protocols import TaskStatus
...
class TestTaskLifecycleManager:
    ...
    def test_valid_transitions(self):
        from shadowbotagents.task.protocols import TaskLifecycleManager, TaskStatus
    ...
    def test_invalid_transition_raises(self):
        from shadowbotagents.task.protocols import TaskLifecycleManager, TaskStatus, InvalidTransitionError
        mgr = TaskLifecycleManager()
