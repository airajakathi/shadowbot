"""
Tests for ShadowBot Robustness Improvements.
...
class TestIncludeWorkflow:
    ...
    def test_include_with_recipe(self):
        ...
        from shadowbotagents.workflows import include
    ...
    def test_include_with_workflow(self):
        ...
        from shadowbotagents.workflows import include, Workflow
...
class TestWhenAlias:
    ...
    def test_when_function_exists(self):
        ...
        from shadowbotagents.workflows import when
        assert callable(when)
    
    def test_when_returns_if_object(self):
        """when() should return an If object."""
        from shadowbotagents.workflows import when, If
    ...
    def test_if_function_works(self):
        ...
        from shadowbotagents.workflows import if_
...
class TestExportsAndImports:
    ...
    def test_when_exported_from_workflows(self):
        """when should be exported from shadowbotagents.workflows."""
        from shadowbotagents.workflows import when
        assert callable(when)
    
    def test_when_in_workflows_all(self):
        """when should be in workflows __all__."""
        import shadowbotagents.workflows as workflows_module
