...
class TestDoomLoopFiring:
    ...
    @patch("shadowbotagents.agent.agent.Agent.get_recommended_stage", return_value="heuristic")
...
class TestDRYAutonomyMixin:
    ...
    def test_autonomy_mixin_has_no_run_autonomous(self):
        ...
        from shadowbotagents.agent.autonomy import AutonomyMixin
    ...
    def test_autonomy_module_exports_helper_classes(self):
        ...
        from shadowbotagents.agent.autonomy import (
            AutonomyConfig,
            AutonomyResult,
            AutonomyStage,
            AutonomySignal,
...
class TestApprovalUnification:
    ...
    def test_cli_autonomy_mode_derives_from_sdk(self):
        ...
        try:
            from shadowbot.cli.features.autonomy_mode import AutonomyMode
            from shadowbotagents.config.feature_configs import AutonomyLevel
            ...
            pytest.skip("shadowbot wrapper not installed")

    def test_cli_autonomy_manager_bridges_to_sdk(self):
        """CLI AutonomyManager.set_mode(FULL_AUTO) must set PRAISONAI_AUTO_APPROVE."""
        try:
            from shadowbot.cli.features.autonomy_mode import AutonomyManager, AutonomyMode
...
class TestInteractiveFixes:
    ...
    def test_interactive_config_autonomy_field_exists(self):
        ...
        try:
            from shadowbot.cli.interactive.config import InteractiveConfig
...
class TestIntegrationSmoke:
    ...
    def test_autonomy_exports_available(self):
        ...
        from shadowbotagents import AutonomyConfig, AutonomyLevel
        from shadowbotagents.agent.autonomy import (
    ...
    def test_doom_loop_tracker_standalone(self):
        ...
        from shadowbotagents.agent.autonomy import DoomLoopTracker
    ...
    def test_autonomy_trigger_stages(self):
        ...
        from shadowbotagents.agent.autonomy import AutonomyTrigger, AutonomyStage
