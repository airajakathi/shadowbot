"""Tests for shadowbot.cli.features.approval — resolve_approval_backend."""

import os
import sys
import pytest

# Ensure shadowbot wrapper package is importable
...
class TestValidBackends:
    ...
    def test_valid_backends_list(self):
        from shadowbot.cli.features.approval import VALID_BACKENDS
