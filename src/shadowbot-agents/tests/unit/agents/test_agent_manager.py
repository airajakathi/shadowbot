...
- ShadowBotAgents has been REMOVED entirely
"""
import pytest
import warnings
...
class TestAgentManagerRename:
    ...
    def test_agent_manager_importable(self):
        """AgentManager should be importable from shadowbotagents."""
        from shadowbotagents import AgentManager
    ...
    def test_agents_is_silent_alias_v4(self):
        ...
        import sys
        _backup = {}
        modules_to_remove = [k for k in sys.modules.keys() if 'shadowbotagents' in k]
        ...
        try:
            ...
            _added = [k for k in sys.modules.keys() if 'shadowbotagents' in k and k not in _backup]
            for mod in _added:
                del sys.modules[mod]
            # Restore the backup
    ...
    def test_agent_manager_in_all(self):
        ...
        import shadowbotagents
        assert 'AgentManager' in shadowbotagents.__all__
...
class TestAgentManagerFunctionality:
    ...
    def test_agent_manager_instantiation(self):
        ...
        from shadowbotagents import AgentManager, Agent
    ...
    def test_agents_alias_instantiation(self):
        ...
        from shadowbotagents import Agents, Agent
...
class TestBackwardCompatibility:
    ...
    def test_praison_ai_agents_removed_v4(self):
        """ShadowBotAgents has been removed in v4 - should raise ImportError."""
