...
class TestEditorOutputImports:
    ...
    def test_import_from_output_module(self):
        ...
        from shadowbotagents.output import EditorOutput
        assert EditorOutput is not None
    
    def test_import_enable_disable(self):
        """Test enable/disable functions can be imported."""
        from shadowbotagents.output import enable_editor_output, disable_editor_output
    ...
    def test_import_tool_labels(self):
        ...
        from shadowbotagents.output import TOOL_LABELS
    ...
    def test_import_block_types(self):
        ...
        from shadowbotagents.output import BlockType, DisplayBlock
...
class TestEditorOutputBasic:
    ...
    def test_init_default(self):
        ...
        from shadowbotagents.output.editor import EditorOutput
...
class TestToolCall:
    ...
    def test_tool_call_with_known_tool(self):
        ...
        from shadowbotagents.output.editor import EditorOutput, TOOL_LABELS
        editor = EditorOutput(use_rich=False)
...
class TestAdditionalMethods:
    ...
    def test_narrative(self):
        ...
        from shadowbotagents.output.editor import EditorOutput, BlockType
        editor = EditorOutput(use_rich=False)
...
class TestEnableDisable:
    ...
    def test_enable_returns_editor(self):
        ...
        from shadowbotagents.output.editor import enable_editor_output, disable_editor_output, EditorOutput
    ...
    def test_is_enabled(self):
        ...
        from shadowbotagents.output.editor import (
...
class TestLlmContentCallback:
    ...
    def setup_method(self):
        ...
        from shadowbotagents.main import sync_display_callbacks
        from shadowbotagents.output.editor import disable_editor_output
    ...
    def test_llm_content_in_supported_types(self):
        ...
        from shadowbotagents.main import SUPPORTED_CALLBACK_TYPES
    ...
    def test_enable_editor_output_registers_llm_content(self):
        ...
        from shadowbotagents.output.editor import enable_editor_output
        from shadowbotagents.main import sync_display_callbacks
    ...
    def test_llm_content_callback_fires_narrative(self):
        ...
        from shadowbotagents.output.editor import enable_editor_output, get_editor_output, BlockType
        from shadowbotagents.main import execute_sync_callback
