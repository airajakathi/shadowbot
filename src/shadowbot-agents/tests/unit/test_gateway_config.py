...
from shadowbotagents.gateway import GatewayConfig, SessionConfig
...
class TestChannelRouteConfig:
    ...
    def test_import(self):
        ...
        from shadowbotagents.gateway import ChannelRouteConfig
...
class TestMultiChannelGatewayConfig:
    ...
    def test_import(self):
        ...
        from shadowbotagents.gateway import MultiChannelGatewayConfig
    ...
    def test_creation_with_channels(self):
        ...
        from shadowbotagents.gateway import MultiChannelGatewayConfig, ChannelRouteConfig
    ...
    def test_stdlib_only(self):
        ...
        import sys
        from shadowbotagents.gateway.config import ChannelRouteConfig, MultiChannelGatewayConfig
        module = sys.modules["shadowbotagents.gateway.config"]
...
class TestChatCommandInfo:
    ...
    def test_import(self):
        ...
        from shadowbotagents.bots import ChatCommandInfo
    ...
    def test_stdlib_only(self):
        ...
        import sys
        from shadowbotagents.bots.protocols import BotProtocol
        module = sys.modules["shadowbotagents.bots.protocols"]
        source_file = module.__file__
        with open(source_file, "r") as f:
            content = f.read()
