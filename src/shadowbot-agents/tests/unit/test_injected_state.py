...
class TestInjectedTypeExists:
    ...
    def test_injected_type_exists(self):
        """Injected type should exist in shadowbotagents.tools."""
        from shadowbotagents.tools import Injected
...
class TestToolExecutionInjection:
    ...
    def test_injected_state_provided_at_runtime(self):
        ...
        from shadowbotagents.tools.injected import with_injection_context
    ...
    def test_injected_dict_state(self):
        ...
        from shadowbotagents import tool
        from shadowbotagents.tools import Injected
        from shadowbotagents.tools.injected import with_injection_context, AgentState
...
class TestInjectionContextManager:
    ...
    def test_context_manager_sets_state(self):
        ...
        from shadowbotagents.tools.injected import (
