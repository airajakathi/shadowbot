...
class TestJudgeProtocol:
    ...
    def test_judge_protocol_exists(self):
        ...
        from shadowbotagents.eval.protocols import JudgeProtocol
...
class TestJudgeResult:
    ...
    def test_judge_result_exists(self):
        ...
        from shadowbotagents.eval.results import JudgeResult
...
class TestJudgeClass:
    ...
    @patch('shadowbotagents.eval.judge.Judge._get_litellm')
...
class TestJudgeConfig:
    ...
    def test_judge_config_exists(self):
        ...
        from shadowbotagents.eval import JudgeConfig
...
class TestBackwardCompatibility:
    ...
    def test_accuracy_evaluator_still_works(self):
        ...
        from shadowbotagents.eval import AccuracyEvaluator
...
class TestLazyLoading:
    ...
    def test_import_does_not_load_litellm(self):
        ...
        import shadowbotagents.eval  # noqa: F401
