...
from shadowbotagents.eval.grader import BaseLLMGrader, GradeResult
...
REASONING: Invalid"""
    ...
    def test_grade_success(self):
        ...
        import shadowbotagents.eval.grader as grader_module
...
class TestProtocolCompliance:
    ...
    def test_grader_protocol_compliance(self):
        ...
        from shadowbotagents.eval.protocols import GraderProtocol
    ...
    def test_grade_result_protocol_compliance(self):
        ...
        from shadowbotagents.eval.protocols import GradeResultProtocol
