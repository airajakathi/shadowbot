...
class TestIterationResult:
    ...
    def test_iteration_result_creation(self):
        ...
        from shadowbotagents.eval.results import IterationResult
...
class TestEvaluationLoopResult:
    ...
    def test_evaluation_loop_result_creation(self):
        ...
        from shadowbotagents.eval.results import EvaluationLoopResult, IterationResult
    ...
    def test_evaluation_loop_result_empty_iterations(self):
        ...
        from shadowbotagents.eval.results import EvaluationLoopResult
...
class TestEvaluationLoop:
    ...
    def test_evaluation_loop_init_defaults(self):
        ...
        from shadowbotagents.eval.loop import EvaluationLoop
...
class TestAgentRunUntil:
    ...
    def test_agent_run_until_basic(self):
        ...
        with patch('shadowbotagents.eval.loop.EvaluationLoop') as MockLoop:
...
class TestEvaluationLoopProtocol:
    ...
    def test_protocol_exists(self):
        ...
        from shadowbotagents.eval.protocols import EvaluationLoopProtocol
...
class TestLazyLoading:
    ...
    def test_lazy_import_from_eval(self):
        ...
        from shadowbotagents.eval import EvaluationLoop
    ...
    def test_lazy_import_results(self):
        ...
        from shadowbotagents.eval import IterationResult, EvaluationLoopResult
