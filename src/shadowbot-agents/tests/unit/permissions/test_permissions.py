...
from shadowbotagents.permissions import (
    PermissionManager,
    PermissionRule,
    PermissionAction,
    PermissionResult,
...
from shadowbotagents.permissions.rules import PersistentApproval
...
class TestPermissionMode:
    ...
    def test_mode_values(self):
        ...
        from shadowbotagents.permissions.rules import PermissionMode
