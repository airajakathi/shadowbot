"""
Tests for advanced features in ShadowBot.
...
# Check if shadowbot wrapper is installed (for tests that depend on CLI features)
_PRAISONAI_WRAPPER_INSTALLED = importlib.util.find_spec("shadowbot") is not None
requires_wrapper = pytest.mark.skipif(
    not _PRAISONAI_WRAPPER_INSTALLED,
    reason="shadowbot wrapper package not installed"
)
...
class TestAutoSummarization:
    ...
    def test_old_summarization_params_rejected(self):
        ...
        from shadowbotagents.agent import Agent
    ...
    def test_token_tracking_for_summarization(self):
        ...
        from shadowbotagents.agent.summarization import SummarizationManager
...
class TestMessageQueue:
    ...
    def test_queue_creation(self):
        ...
        from shadowbotagents.agent.message_queue import AgentMessageQueue
...
class TestMCPDisabledTools:
    ...
    def test_mcp_disabled_tools_param(self):
        ...
        from shadowbotagents.mcp import MCP
    ...
    def test_disabled_tools_filtering(self):
        ...
        from shadowbotagents.mcp.mcp_utils import filter_disabled_tools
...
class TestPermissionAllowlist:
    ...
    def test_allowlist_creation(self):
        ...
        from shadowbotagents.approval import PermissionAllowlist
...
class TestBackgroundJobManagement:
    ...
    def test_job_manager_creation(self):
        ...
        from shadowbotagents.background.job_manager import BackgroundJobManager
    ...
    def test_job_status_tracking(self):
        ...
        from shadowbotagents.background.job_manager import BackgroundJobManager, JobStatus
...
class TestSafeBashExecution:
    ...
    def test_banned_commands_list(self):
        ...
        from shadowbot.cli.features.safe_shell import BANNED_COMMANDS
    ...
    def test_command_validation(self):
        ...
        from shadowbot.cli.features.safe_shell import validate_command
    ...
    def test_safe_execute(self):
        ...
        from shadowbot.cli.features.safe_shell import safe_execute
...
class TestFileHistory:
    ...
    def test_history_creation(self):
        ...
        from shadowbot.cli.features.file_history import FileHistoryManager
...
class TestLSPDiagnostics:
    ...
    def test_diagnostics_hook_exists(self):
        ...
        from shadowbot.cli.features.lsp_diagnostics import DiagnosticsHook
...
class TestHierarchicalConfig:
    ...
    def test_config_precedence(self):
        ...
        from shadowbot.cli.features.config_hierarchy import HierarchicalConfig
    ...
    def test_config_schema_validation(self):
        ...
        from shadowbot.cli.features.config_hierarchy import HierarchicalConfig, ConfigValidationError
...
class TestCLIModes:
    ...
    def test_compact_mode_flag(self):
        ...
        from shadowbot.cli.features.output_modes import OutputMode
    ...
    def test_verbose_mode_flag(self):
        ...
        from shadowbot.cli.features.output_modes import OutputMode, get_default_mode
        
        assert get_default_mode() == OutputMode.VERBOSE
        
    def test_logs_command_tail(self):
        """Test logs command with tail option."""
        from shadowbot.cli.features.logs import LogsHandler
...
class TestGitAttribution:
    ...
    def test_attribution_trailer_generation(self):
        ...
        from shadowbot.cli.features.git_attribution import AttributionManager
        
        manager = AttributionManager(model="gpt-4o")
        
        trailer = manager.generate_trailer(style="assisted-by")
        assert "Assisted-by:" in trailer or "ShadowBot" in trailer
        
    def test_attribution_styles(self):
        """Test different attribution styles."""
        from shadowbot.cli.features.git_attribution import AttributionManager, AttributionStyle
    ...
    def test_add_attribution_to_message(self):
        ...
        assert "Assisted-by:" in attributed or "ShadowBot" in attributed
...
class TestSourcegraphTool:
    ...
    Note: sourcegraph_tools has been moved to shadowbot-tools package.
    These tests are skipped as the tool is no longer in core SDK.
    """
    
    @pytest.mark.skip(reason="sourcegraph_tools moved to shadowbot-tools package")
