...
class TestMemoryToolImports:
    ...
    def test_import_directly(self):
        ...
        from shadowbotagents.tools.memory import store_memory, search_memory
        assert callable(store_memory)
        assert callable(search_memory)

    def test_no_collision_with_memory_package(self):
        """tools.memory does not collide with memory/ package."""
        import shadowbotagents.memory as mem_pkg
        import shadowbotagents.tools.memory as tools_mem
...
class TestStoreMemory:
    ...
    def test_store_memory_with_memory_instance(self):
        ...
        from shadowbotagents.tools.memory import store_memory
        from shadowbotagents.tools.injected import AgentState, with_injection_context
    ...
    def test_store_memory_no_state(self):
        ...
        from shadowbotagents.tools.memory import store_memory
        from shadowbotagents.tools.injected import set_current_state
...
class TestSearchMemory:
    ...
    def test_search_memory_with_results(self):
        ...
        from shadowbotagents.tools.memory import search_memory
        from shadowbotagents.tools.injected import AgentState, with_injection_context
...
class TestMemoryToolSchema:
    ...
    def test_store_memory_injected_hidden(self):
        ...
        from shadowbotagents.tools.memory import store_memory
        from shadowbotagents.tools.injected import get_injected_params
