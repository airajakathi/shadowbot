...
class TestAstGrepToolAvailability:
    ...
    def test_is_available_when_installed(self):
        ...
        from shadowbotagents.tools.ast_grep_tool import is_ast_grep_available
    ...
    def test_is_not_available_when_not_installed(self):
        ...
        from shadowbotagents.tools import ast_grep_tool
        from shadowbotagents.tools.ast_grep_tool import is_ast_grep_available
        
        # Clear cache to ensure fresh check
        ast_grep_tool._availability_cache = None
        
        with patch('shadowbotagents.tools.ast_grep_tool.shutil.which') as mock_which:
...
class TestAstGrepToolGracefulFallback:
    ...
    def test_search_returns_error_when_not_installed(self):
        ...
        from shadowbotagents.tools.ast_grep_tool import ast_grep_search
        
        with patch('shadowbotagents.tools.ast_grep_tool.is_ast_grep_available') as mock_avail:
    ...
    def test_rewrite_returns_error_when_not_installed(self):
        ...
        from shadowbotagents.tools.ast_grep_tool import ast_grep_rewrite
    ...
    def test_scan_returns_error_when_not_installed(self):
        ...
        from shadowbotagents.tools.ast_grep_tool import ast_grep_scan
    ...
    def test_tool_does_not_crash_when_not_installed(self):
        ...
        from shadowbotagents.tools.ast_grep_tool import (
...
class TestAstGrepToolAgentIntegration:
    ...
    def test_tool_import_via_lazy_loading(self):
        ...
        from shadowbotagents.tools import ast_grep_search
...
class TestAstGrepToolAutonomyIntegration:
    ...
    def test_autonomy_default_tools_includes_ast_grep(self):
        ...
        from shadowbotagents.tools.ast_grep_tool import get_ast_grep_tools
...
class TestAstGrepToolImportPerformance:
    ...
    def test_lazy_import_no_subprocess_on_import(self):
        ...
        with patch('subprocess.run') as mock_run:
            # Re-import to test
            import importlib
            import shadowbotagents.tools.ast_grep_tool as module
