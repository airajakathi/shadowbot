...
class TestToolProfileDataclass:
    ...
    def test_tool_profile_has_required_fields(self):
        ...
        from shadowbotagents.tools.profiles import ToolProfile
...
class TestBuiltinProfiles:
    ...
    def test_builtin_profiles_dict_exists(self):
        ...
        from shadowbotagents.tools.profiles import BUILTIN_PROFILES
...
class TestAutonomyProfile:
    ...
    def test_autonomy_profile_exists(self):
        ...
        from shadowbotagents.tools.profiles import AUTONOMY_PROFILE
...
class TestProfileRegistry:
    ...
    def test_register_profile_adds_custom(self):
        ...
        from shadowbotagents.tools.profiles import (
...
class TestProfileExports:
    ...
    def test_import_from_tools_package(self):
        """ToolProfile should be importable from shadowbotagents.tools."""
        from shadowbotagents.tools import ToolProfile
        
        assert ToolProfile is not None
    
    def test_import_register_profile(self):
        """register_profile should be importable from shadowbotagents.tools."""
        from shadowbotagents.tools import register_profile
        
        assert callable(register_profile)
    
    def test_import_resolve_profiles(self):
        """resolve_profiles should be importable from shadowbotagents.tools."""
        from shadowbotagents.tools import resolve_profiles
        
        assert callable(resolve_profiles)
    
    def test_import_autonomy_profile(self):
        """AUTONOMY_PROFILE should be importable from shadowbotagents.tools."""
        from shadowbotagents.tools import AUTONOMY_PROFILE
