"""
Tests for Protocol definitions in shadowbotagents.
...
class TestAgentProtocol:
    ...
    def test_protocol_is_importable(self):
        ...
        from shadowbotagents.agent.protocols import AgentProtocol
...
class TestMemoryProtocol:
    ...
    def test_memory_implements_protocol(self):
        ...
        from shadowbotagents.memory.memory import Memory
...
class TestToolProtocol:
    ...
    def test_protocol_is_importable(self):
        ...
        from shadowbotagents.tools.protocols.tool_protocol import ToolProtocol
