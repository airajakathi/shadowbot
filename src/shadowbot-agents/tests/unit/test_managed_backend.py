...
class TestManagedBackendProtocol:
    ...
    def test_protocol_importable(self):
        from shadowbotagents.agent.protocols import ManagedBackendProtocol
    ...
    def test_lazy_import_from_top_level(self):
        """ManagedBackendProtocol should be accessible via shadowbotagents.__getattr__."""
        from shadowbotagents import ManagedBackendProtocol
        assert ManagedBackendProtocol is not None
...
class TestToolMapping:
    """Test tool name mapping between managed agent and ShadowBot."""
