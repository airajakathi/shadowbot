...
class TestConditionProtocolExists:
    ...
    def test_condition_protocol_importable(self):
        ...
        from shadowbotagents.conditions.protocols import ConditionProtocol
...
class TestExpressionCondition:
    ...
    def test_expression_condition_importable(self):
        ...
        from shadowbotagents.conditions.evaluator import ExpressionCondition
...
class TestDictCondition:
    ...
    def test_dict_condition_importable(self):
        ...
        from shadowbotagents.conditions.evaluator import DictCondition
...
class TestConditionExports:
    ...
    def test_exports_from_conditions_module(self):
        ...
        from shadowbotagents.conditions import (
            ConditionProtocol,
            ExpressionCondition,
            DictCondition,
            evaluate_condition,
    ...
    def test_exports_from_main_package(self):
        """Test exports from main shadowbotagents package."""
        from shadowbotagents import ConditionProtocol, evaluate_condition
        assert ConditionProtocol is not None
        assert evaluate_condition is not None
