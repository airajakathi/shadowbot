...
class TestProfilerBasics:
    ...
    def test_profiler_disabled_by_default(self):
        ...
        from shadowbotagents.profiling import Profiler
...
class TestStreamingTracker:
    ...
    def test_streaming_ttft(self):
        ...
        from shadowbotagents.profiling import Profiler, StreamingTracker
...
class TestProfileDecorators:
    ...
    def test_profile_func_decorator(self):
        ...
        from shadowbotagents.profiling import Profiler, profile_func
...
class TestProfileBlock:
    ...
    def test_profile_block(self):
        ...
        from shadowbotagents.profiling import Profiler, profile_block
