...
class TestAdapterImport:
    ...
    def test_default_creds_dir(self):
        """Default creds dir is ~/.shadowbot/whatsapp."""
        from shadowbot.bots._whatsapp_web_adapter import DEFAULT_CREDS_DIR
        assert ".shadowbot" in DEFAULT_CREDS_DIR
...
class TestAdapterConstruction:
    ...
    def test_default_construction(self):
        ...
        assert ".shadowbot" in adapter.creds_dir
