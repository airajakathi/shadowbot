...
class TestAgentLearnParam:
    ...
    def test_agent_accepts_learn_config(self):
        ...
        from shadowbotagents import Agent
        from shadowbotagents.config.feature_configs import LearnConfig
...
class TestLearnConfigExport:
    ...
    def test_learn_config_exported(self):
        """LearnConfig should be importable from shadowbotagents."""
    ...
    def test_learn_scope_exported(self):
        """LearnScope should be importable from shadowbotagents."""
        from shadowbotagents import LearnScope
