...
class TestPermissionPresets:
    ...
    def test_presets_exist(self):
        from shadowbotagents.approval.registry import PERMISSION_PRESETS
    ...
    def test_safe_blocks_all_dangerous(self):
        from shadowbotagents.approval.registry import PERMISSION_PRESETS, DEFAULT_DANGEROUS_TOOLS
...
class TestPermissionCheck:
    ...
    def test_safe_allows_read_file(self):
        ...
        with patch("shadowbotagents.approval.get_approval_registry", return_value=mock_registry):
            agent = Agent(name="test", instructions="test", approval="safe")
