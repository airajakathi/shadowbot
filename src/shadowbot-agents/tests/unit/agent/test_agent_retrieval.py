...
class TestAgentRetrievalConfig:
    ...
    def test_agent_accepts_knowledge_config(self):
        ...
        from shadowbotagents import Agent, KnowledgeConfig
...
class TestAgentQueryMethod:
    ...
    def test_query_returns_rag_result(self):
        ...
        from shadowbotagents import Agent
        from shadowbotagents.rag.models import RAGResult, Citation
