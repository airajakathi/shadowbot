...
from shadowbotagents.tools.validators import (
...
class TestC2CancelToken:
    ...
    def test_preset_cancelled_token_aborts_chat_before_llm(self, monkeypatch):
        ...
        from shadowbotagents.agent.interrupt import InterruptController
...
class TestC7PIIRedaction:
    def test_enable_pii_redaction_is_importable(self):
        from shadowbotagents.trace.redact import enable_pii_redaction
    ...
    def test_enable_pii_redaction_is_idempotent(self):
        ...
        from shadowbotagents.trace.redact import (
    ...
    def test_pii_scrubber_scrubs_api_keys(self):
        ...
        from shadowbotagents.trace.redact import scrub_pii_text
...
def _pii_state_snapshot():
    ...
    from shadowbotagents.hooks import get_default_registry
