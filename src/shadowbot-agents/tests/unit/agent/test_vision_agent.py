...
class TestVisionAgentInit:
    ...
    def test_import_vision_agent(self):
        """VisionAgent should be importable from shadowbotagents."""
        from shadowbotagents import VisionAgent
        assert VisionAgent is not None
    
    def test_import_vision_config(self):
        """VisionConfig should be importable."""
        from shadowbotagents import VisionConfig
...
class TestVisionConfig:
    ...
    def test_default_config(self):
        ...
        from shadowbotagents.agent.vision_agent import VisionConfig
        config = VisionConfig()
