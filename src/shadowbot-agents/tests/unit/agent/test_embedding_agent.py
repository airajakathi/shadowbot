...
class TestEmbeddingAgentInit:
    ...
    def test_import_embedding_agent(self):
        """EmbeddingAgent should be importable from shadowbotagents."""
        from shadowbotagents import EmbeddingAgent
        assert EmbeddingAgent is not None
    
    def test_import_embedding_config(self):
        """EmbeddingConfig should be importable."""
        from shadowbotagents import EmbeddingConfig
...
class TestEmbeddingConfig:
    ...
    def test_default_config(self):
        ...
        from shadowbotagents.agent.embedding_agent import EmbeddingConfig
