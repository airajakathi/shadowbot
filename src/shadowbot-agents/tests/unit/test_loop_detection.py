"""
TDD tests for ShadowBot tool loop detection.
...
class TestLoopDetectionImport:
    ...
    def test_module_importable(self):
        from shadowbotagents.agent.loop_detection import (
            LoopDetectionConfig,
            LoopDetectionResult,
            detect_tool_loop,
            record_tool_call,
    ...
    def test_no_side_effects_on_import(self):
        ...
        import shadowbotagents.agent.loop_detection  # noqa


class TestLoopDetectionConfig:
    def setup_method(self):
        from shadowbotagents.agent.loop_detection import LoopDetectionConfig
...
class TestHashToolCall:
    def test_hash_is_deterministic(self):
        from shadowbotagents.agent.loop_detection import hash_tool_call
...
class TestLoopDetectionPlugin:
    ...
    def test_plugin_importable(self):
        from shadowbotagents.plugins import loop_detection_plugin  # noqa
    ...
    def test_plugin_registers_hook(self):
        ...
        from shadowbotagents.hooks.registry import get_default_registry
        from shadowbotagents.hooks.types import HookEvent
        import shadowbotagents.plugins.loop_detection_plugin  # noqa ensure imported
