...
class TestCostModule:
    """Tests for shadowbotagents.llm._cost module."""
    
    def setup_method(self):
        """Reset module state before each test."""
        # Clear any cached litellm module
        import shadowbotagents.llm._cost as cost_module
    ...
    def test_is_cost_tracking_disabled_by_default(self):
        ...
        from shadowbotagents.llm._cost import is_cost_tracking_enabled
    ...
    def test_calculate_cost_returns_none_when_disabled(self):
        ...
        from shadowbotagents.llm._cost import calculate_cost
    ...
    def test_calculate_cost_with_force_flag(self):
        ...
        # Mock litellm
        with patch('shadowbotagents.llm._cost._get_litellm') as mock_get_litellm:
    ...
    def test_enable_cost_tracking(self):
        ...
        from shadowbotagents.llm._cost import enable_cost_tracking, is_cost_tracking_enabled
    ...
    def test_disable_cost_tracking(self):
        ...
        from shadowbotagents.llm._cost import disable_cost_tracking, is_cost_tracking_enabled
