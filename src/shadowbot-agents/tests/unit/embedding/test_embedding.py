"""
Unit tests for shadowbotagents.embedding module.
...
class TestAsyncEmbedding:
    ...
    async def test_aembedding_single_text(self, mock_aembedding):
        ...
        from shadowbotagents.embedding import aembedding
...
class TestGetDimensions:
    ...
    def test_get_dimensions_known_models(self):
        ...
        from shadowbotagents.embedding import get_dimensions
...
class TestAliases:
    ...
    def test_embed_alias(self):
        ...
        from shadowbotagents.embedding.embed import embedding, embed
        
        assert embed is embedding
    
    def test_aembed_alias(self):
        """Test that aembed is an alias for aembedding."""
        from shadowbotagents.embedding.embed import aembedding, aembed
...
class TestBackwardsCompatibility:
    ...
    def test_import_embedding_function_from_embedding_module(self):
        """Test importing embedding function from shadowbotagents.embedding."""
        from shadowbotagents.embedding import embedding
    ...
    def test_import_embedding_result(self):
        """Test importing EmbeddingResult from shadowbotagents.embedding."""
        from shadowbotagents.embedding import EmbeddingResult
...
class TestSimplifiedImports:
    ...
    def test_from_shadowbotagents_import_embedding_returns_function(self):
        """Test that 'from shadowbotagents import embedding' returns a callable, not a plain module."""
        import importlib
        import shadowbotagents
        # Force reload to clear any test pollution
        embedding = getattr(shadowbotagents, 'embedding')
    ...
    def test_from_shadowbotagents_import_embeddings_returns_function(self):
        """Test that 'from shadowbotagents import embeddings' (plural) works as alias."""
        from shadowbotagents import embeddings
    ...
    def test_embedding_and_embeddings_are_same_function(self):
        ...
        import shadowbotagents
        embedding = getattr(shadowbotagents, 'embedding')
        embeddings = getattr(shadowbotagents, 'embeddings')
        
        assert embedding is embeddings, "embedding and embeddings should be the same object"
    
    def test_from_shadowbotagents_import_aembedding(self):
        """Test that 'from shadowbotagents import aembedding' works."""
        from shadowbotagents import aembedding
        
        assert callable(aembedding)
    
    def test_from_shadowbotagents_import_aembeddings(self):
        """Test that 'from shadowbotagents import aembeddings' (plural) works as alias."""
        from shadowbotagents import aembeddings
        
        assert callable(aembeddings)
    
    def test_from_shadowbotagents_import_EmbeddingResult(self):
        """Test that 'from shadowbotagents import EmbeddingResult' works."""
        from shadowbotagents import EmbeddingResult
        
        # Should be a class
        assert isinstance(EmbeddingResult, type) or hasattr(EmbeddingResult, '__dataclass_fields__')
    
    def test_from_shadowbotagents_import_get_dimensions(self):
        """Test that 'from shadowbotagents import get_dimensions' works."""
        from shadowbotagents import get_dimensions
    ...
    def test_all_embedding_imports_together(self):
        ...
        embedding = getattr(shadowbotagents, 'embedding')
        embeddings = getattr(shadowbotagents, 'embeddings')
        aembedding = getattr(shadowbotagents, 'aembedding')
        aembeddings = getattr(shadowbotagents, 'aembeddings')
        EmbeddingResult = getattr(shadowbotagents, 'EmbeddingResult')
        get_dimensions = getattr(shadowbotagents, 'get_dimensions')
...
class TestLazyLoadingPreserved:
    ...
    def test_litellm_not_loaded_on_embedding_import(self):
        ...
        from shadowbotagents import embedding
