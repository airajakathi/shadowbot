...
class TestLoggingPlugin:
    ...
    def test_logging_plugin_info(self):
        ...
        from shadowbotagents.plugins.builtin import LoggingPlugin
...
class TestMetricsPlugin:
    ...
    def test_metrics_plugin_info(self):
        ...
        from shadowbotagents.plugins.builtin import MetricsPlugin
...
class TestPluginSDK:
    ...
    def test_sdk_exports(self):
        ...
        from shadowbotagents.plugins.sdk import Plugin, PluginHook, PluginInfo, FunctionPlugin
    ...
    def test_function_plugin(self):
        ...
        from shadowbotagents.plugins.sdk import FunctionPlugin, PluginHook
...
class TestPluginManagerIntegration:
    ...
    def test_execute_hook_with_builtin_plugins(self):
        ...
        from shadowbotagents.plugins import PluginManager, PluginHook
        from shadowbotagents.plugins.builtin import MetricsPlugin
