...
class TestPluginsEnableAPI:
    ...
    def test_enable_all_plugins(self):
        ...
        from shadowbotagents import plugins
...
class TestPluginsEnvVar:
    ...
    def test_env_var_true_enables_plugins(self):
        ...
        from shadowbotagents._config import _get_plugins_enabled
    ...
    def test_env_var_list_enables_specific(self):
        ...
        from shadowbotagents._config import _get_plugins_enabled, _get_plugins_list
...
class TestConfigLoader:
    ...
    def test_get_config_returns_praison_config(self):
        ...
        from shadowbotagents.config.loader import get_config, PraisonConfig, clear_config_cache
    ...
    def test_get_plugins_config(self):
        ...
        from shadowbotagents.config.loader import get_plugins_config, PluginsConfig, clear_config_cache
    ...
    def test_get_defaults_config(self):
        ...
        from shadowbotagents.config.loader import get_defaults_config, DefaultsConfig, clear_config_cache
    ...
    def test_get_default_with_fallback(self):
        ...
        from shadowbotagents.config.loader import get_default, clear_config_cache
    ...
    def test_is_plugins_enabled_from_config(self):
        ...
        from shadowbotagents.config.loader import is_plugins_enabled, clear_config_cache
    ...
    def test_config_file_parsing(self):
        ...
        from shadowbotagents.config.loader import _parse_toml, clear_config_cache
...
class TestConfigDrivenDefaults:
    ...
    def test_apply_config_defaults_with_true(self):
        ...
        from shadowbotagents.config.loader import apply_config_defaults, clear_config_cache
        from shadowbotagents.config.feature_configs import MemoryConfig
...
class TestPluginManagerIntegration:
    ...
    def test_get_plugin_manager_singleton(self):
        ...
        from shadowbotagents.plugins import get_plugin_manager
