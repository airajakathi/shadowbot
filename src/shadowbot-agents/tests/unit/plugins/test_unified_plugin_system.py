...
class TestPathCentralization:
    ...
    def test_plugins_discovery_uses_paths_module(self):
        ...
        from shadowbotagents.paths import get_plugins_dir, get_project_data_dir
    ...
    def test_skills_discovery_uses_paths_module(self):
        ...
        from shadowbotagents.skills.discovery import get_default_skill_dirs
    ...
    def test_paths_module_returns_shadowbot_dir(self):
        """paths.py should return ~/.shadowbot/ as default."""
        from shadowbotagents.paths import get_data_dir, DEFAULT_DIR_NAME
        
        assert DEFAULT_DIR_NAME == ".shadowbot"
        
        # Without env override, should use .shadowbot
        data_dir = get_data_dir()
        assert data_dir.name in [".shadowbot", ".praison"]  # .praison for legacy
...
class TestHookUnification:
    ...
    def test_plugin_hook_is_hook_event_alias(self):
        ...
        from shadowbotagents.plugins import PluginHook
...
class TestPluginType:
    ...
    def test_plugin_type_enum_exists(self):
        ...
        from shadowbotagents.plugins import PluginType
...
class TestAsyncHookExecution:
    ...
    async def test_async_execute_hook_exists(self):
        ...
        from shadowbotagents.plugins import PluginManager
    ...
    async def test_async_execute_hook_works(self):
        ...
        from shadowbotagents.plugins import PluginManager, Plugin, PluginInfo
        from shadowbotagents.hooks import HookEvent
...
class TestBackwardCompatibility:
    ...
    def test_legacy_paths_fallback(self):
        ...
        from shadowbotagents.paths import get_data_dir, LEGACY_DIR_NAME
        
        assert LEGACY_DIR_NAME == ".praison"
    
    def test_plugin_info_still_works(self):
        """PluginInfo should still work with PluginHook."""
        from shadowbotagents.plugins import PluginInfo, PluginHook
