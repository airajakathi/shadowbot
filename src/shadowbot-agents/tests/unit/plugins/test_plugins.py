...
from shadowbotagents.plugins.plugin import (
    Plugin,
    PluginHook,
    PluginInfo,
    FunctionPlugin,
)
from shadowbotagents.plugins.manager import (
    PluginManager,
    get_plugin_manager,
)
...
class TestLoadFromDirectory:
    ...
    def test_load_plugin_file(self):
        ...
        from shadowbotagents.plugins.manager import PluginManager
        
        # Create a plugin file
        plugin_code = '''
from shadowbotagents.plugins.plugin import Plugin, PluginInfo
...
class TestEntryPointsDiscovery:
    ...
    def test_discover_entry_points_no_plugins(self, monkeypatch):
        ...
        def mock_entry_points(*args, **kwargs):
            if kwargs.get("group") == "shadowbot.plugins":
                return []
            return {"shadowbot.plugins": []}
    ...
    def test_discover_entry_points_success(self, monkeypatch):
        ...
        def mock_entry_points(*args, **kwargs):
            if kwargs.get("group") == "shadowbot.plugins":
                return [mock_ep]
            return {"shadowbot.plugins": [mock_ep]}
