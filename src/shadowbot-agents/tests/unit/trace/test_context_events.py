...
class TestContextEventType:
    ...
    def test_context_event_types_exist(self):
        ...
        from shadowbotagents.trace.context_events import ContextEventType
...
class TestContextEvent:
    ...
    def test_context_event_creation_minimal(self):
        ...
        from shadowbotagents.trace.context_events import ContextEvent, ContextEventType
...
class TestContextTraceSink:
    ...
    def test_context_noop_sink(self):
        ...
        from shadowbotagents.trace.context_events import ContextNoOpSink, ContextEvent, ContextEventType
    ...
    def test_context_list_sink(self):
        ...
        from shadowbotagents.trace.context_events import ContextListSink, ContextEvent, ContextEventType
...
"""
        subprocess.run(
            ...
            capture_output=True,
            text=True,
            cwd="/Users/praison/shadowbot-package/src/shadowbot-agents",
        )
        
        # Now measure context_events import (should add minimal overhead)
        code = """
import time
import shadowbotagents  # Pre-import base
start = time.perf_counter()
from shadowbotagents.trace.context_events import ContextEvent, ContextEventType
elapsed = (time.perf_counter() - start) * 1000
print(f"{elapsed:.1f}")
