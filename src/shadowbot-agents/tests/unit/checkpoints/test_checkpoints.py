...
from shadowbotagents.checkpoints.types import (
    CheckpointConfig, Checkpoint, CheckpointDiff, FileDiff,
    CheckpointResult, CheckpointEvent
)
from shadowbotagents.checkpoints.service import CheckpointService
...
class TestCheckpointConfig:
    ...
    def test_config_default_storage(self):
        ...
        config = CheckpointConfig(workspace_dir="/tmp/test")
        # Uses centralized paths module - .shadowbot/checkpoints
        assert ".shadowbot/checkpoints" in config.storage_dir or "checkpoints" in config.storage_dir
