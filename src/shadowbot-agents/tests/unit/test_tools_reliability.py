...
class TestListProcessesReliability:
    ...
    def _inject_psutil(self):
        ...
        import psutil
        import shadowbotagents.tools.shell_tools as st_mod
    ...
    def test_list_processes_handles_none_memory_percent(self):
        ...
        with patch('shadowbotagents.tools.shell_tools.psutil.process_iter', return_value=[mock_proc]):
            shell = ShellTools()
...
class TestInternetSearchReliability:
    ...
    def test_internet_search_has_retry_parameter(self):
        ...
        from shadowbotagents.tools.duckduckgo_tools import internet_search
        import inspect
    ...
    def test_internet_search_handles_missing_package(self):
        ...
        with patch('shadowbotagents.tools.duckduckgo_tools.util.find_spec', return_value=None):
...
class TestSearchWebReliability:
    ...
    def test_search_web_has_retry_in_duckduckgo(self):
        ...
        from shadowbotagents.tools.web_search import _search_duckduckgo
        import inspect
...
class TestToolErrorConsistency:
    ...
    def test_search_web_error_format(self):
        ...
        from shadowbotagents.tools.web_search import search_web
        
        # Force all providers to fail by patching SEARCH_PROVIDERS to empty
        with patch('shadowbotagents.tools.web_search.SEARCH_PROVIDERS', []):
