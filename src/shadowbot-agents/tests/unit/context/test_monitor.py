...
class TestContextMonitor:
    ...
    def test_monitor_disabled_by_default(self):
        ...
        from shadowbotagents.context.monitor import ContextMonitor
    ...
    def test_snapshot_writes_file(self):
        ...
        from shadowbotagents.context.monitor import ContextMonitor
        from shadowbotagents.context.models import ContextLedger, BudgetAllocation
...
class TestRedaction:
    ...
    def test_redact_api_key(self):
        ...
        from shadowbotagents.context.monitor import redact_sensitive
...
class TestFormatting:
    ...
    def test_format_human_snapshot(self):
        ...
        from shadowbotagents.context.monitor import format_human_snapshot
        from shadowbotagents.context.models import ContextSnapshot, ContextLedger, BudgetAllocation
    ...
    def test_format_json_snapshot(self):
        """Test JSON format."""
        from shadowbotagents.context.monitor import format_json_snapshot
        from shadowbotagents.context.models import ContextSnapshot, ContextLedger, BudgetAllocation
        import json
...
class TestMultiAgentMonitor:
    ...
    def test_get_agent_monitor(self):
        ...
        from shadowbotagents.context.monitor import MultiAgentMonitor
