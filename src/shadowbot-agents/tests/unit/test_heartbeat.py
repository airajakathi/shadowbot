...
class TestHeartbeatImports:
    ...
    def test_import_from_agent_module(self):
        from shadowbotagents.agent import Heartbeat
        assert Heartbeat is not None

    def test_import_from_package(self):
        from shadowbotagents import Heartbeat
        assert Heartbeat is not None

    def test_import_config(self):
        from shadowbotagents import HeartbeatConfig
        assert HeartbeatConfig is not None

    def test_import_config_from_agent(self):
        from shadowbotagents.agent import HeartbeatConfig
        assert HeartbeatConfig is not None
...
class TestHeartbeatConfig:
    ...
    def test_defaults(self):
        from shadowbotagents.agent.heartbeat import HeartbeatConfig
        cfg = HeartbeatConfig()
...
class TestHeartbeatInit:
    ...
    def test_creates_with_agent(self):
        from shadowbotagents.agent.heartbeat import Heartbeat
