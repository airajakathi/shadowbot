#!/usr/bin/env python3
"""
Comprehensive test suite for all ShadowBot optimizations (Agent, LLM, and OpenAIClient).
...
from shadowbotagents.llm.openai_client import OpenAIClient, get_openai_client
