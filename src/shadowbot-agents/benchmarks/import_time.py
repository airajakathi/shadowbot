#!/usr/bin/env python3
"""
Import time benchmark for shadowbotagents.

This benchmark measures the import time of the shadowbotagents package
...
def clear_modules():
    """Clear all shadowbot and litellm related modules from cache."""
...
def measure_import_time(runs: int = 5) -> dict:
    ...
    for _ in range(runs):
        ...
        if 'shadowbotagents' in sys.modules:
            del sys.modules['shadowbotagents']
...
def check_lazy_imports() -> dict:
    """
    Check that heavy dependencies are NOT loaded after importing shadowbotagents.
...
def main():
    ...
    print("=" * 60)
    print("ShadowBot Agents Import Time Benchmark")
    print("=" * 60)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='ShadowBot Agents Import Time Benchmark')
