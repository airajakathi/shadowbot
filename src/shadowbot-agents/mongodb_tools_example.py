#!/usr/bin/env python3
"""
MongoDB Tools Example for ShadowBot Agents

This example demonstrates how to use MongoDB tools with ShadowBot agents.
Agents can perform MongoDB operations like inserting, querying, and vector search.

Prerequisites:
- Install MongoDB dependencies: pip install 'shadowbotagents[mongodb]'
...
from shadowbotagents.tools import mongodb_tools
    ...
    try:
        ...
        result = mongo_client.insert_document(
            "demo_collection",
            {
                ...
                "description": "Demonstration of MongoDB tools with ShadowBot",
                "category": "database",
                "tags": ["mongodb", "shadowbot", "tools", "demo"]
            },
...
if __name__ == "__main__":
    print("MongoDB Tools Example for ShadowBot Agents")
    print("=" * 50)
    ...
    print("3. MongoDB dependencies installed: pip install 'shadowbotagents[mongodb]'")
    print("=" * 50)
