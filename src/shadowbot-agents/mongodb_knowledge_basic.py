#!/usr/bin/env python3
"""
MongoDB Knowledge Example for ShadowBot Agents

This example demonstrates how to use MongoDB as a knowledge store for ShadowBot agents.
...
if __name__ == "__main__":
    print("MongoDB Knowledge Example for ShadowBot Agents")
    print("=" * 50)
