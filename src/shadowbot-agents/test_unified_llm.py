...
def test_unified_protocol_imports():
    ...
    from shadowbotagents.llm import UnifiedLLMProtocol
    from shadowbotagents.llm import LiteLLMAdapter, OpenAIAdapter, UnifiedLLMDispatcher
    from shadowbotagents.llm import create_llm_dispatcher
...
def test_litellm_adapter_sync_async_parity():
    ...
    from shadowbotagents.llm import LiteLLMAdapter
...
def test_openai_adapter_sync_async_parity():
    ...
    from shadowbotagents.llm import OpenAIAdapter
...
def test_streaming_protocol_compliance():
    ...
    from shadowbotagents.llm import LiteLLMAdapter, OpenAIAdapter
...
async def test_real_agent_functionality():
    ...
    with patch.dict(os.environ, {'OPENAI_API_KEY': 'test-key'}):
        ...
        with patch('shadowbotagents.llm.openai_client.openai.OpenAI') as mock_openai:
...
def test_performance_no_regressions():
    ...
    from shadowbotagents.llm import UnifiedLLMProtocol, LiteLLMAdapter, OpenAIAdapter
