"""MCP Server wrapper for exposing ShadowBot tools as MCP servers.
...
def launch_tools_mcp_server(
    ...
    Args:
        ...
        tool_names: List of tool names to load from shadowbotagents.tools
        name: Name of the MCP server
        transport: Transport type - "stdio" or "sse"
    ...
    if tool_names:
        from shadowbotagents import tools as praison_tools
        ...
        for tool_name in tool_names:
            if hasattr(praison_tools, tool_name):
                ...
                logger.warning(f"Tool '{tool_name}' not found in shadowbotagents.tools")
