...
Output MUST be JSON with 'reflection' and 'satisfactory'.
    ...
    def can_use_tools(self) -> bool:
        ...
        try:
            ...
            raise ImportError(
                "LiteLLM is required but not installed. "
                "Please install it with: pip install 'shadowbotagents[llm]'"
            )
        except Exception as e:
    ...
    def _build_completion_params(self, **override_params) -> Dict[str, Any]:
        ...
        # Always remove internal ShadowBot parameters that are not native litellm parameters
        # These are used internally by ShadowBot but should not be passed to the LLM API
        internal_params = [
    ...
    def _build_responses_params(
        ...
        **kwargs,
        ...
        style message list that ShadowBot already constructs.
        ...
        # Filter out internal ShadowBot params that are not Responses API params
        _internal = {
