"""
Centralized Path Utilities for ShadowBot Agents.

All persistent data uses ~/.shadowbot/ by default.
...
Usage:
    from shadowbotagents.paths import get_data_dir, get_sessions_dir
    
    # Get user data directory
    data_dir = get_data_dir()  # ~/.shadowbot/
    
    # Get specific subdirectories
    sessions_dir = get_sessions_dir()  # ~/.shadowbot/sessions/
...
Backward Compatibility:
    If ~/.shadowbot/ doesn't exist but ~/.praison/ does, the legacy
    path will be used with a deprecation warning. Run 'shadowbot migrate-data'
...
def get_data_dir() -> Path:
    ...
    if legacy_path.exists():
        ...
        warn_deprecated_param(
            ...
            since="1.0.0",
            removal="2.0.0",
            alternative=f"run 'shadowbot migrate-data' to migrate to {new_path}",
...
def get_mcp_auth_path() -> Path:
    ...
    Returns:
        Path to ~/.shadowbot/mcp-auth.json
    """
...
def get_project_sessions_dir(project_path: Optional[Union[str, Path]] = None) -> Path:
    ...
    Returns:
        Path to .shadowbot/sessions/ in project
    """
...
def get_project_knowledge_dir(project_path: Optional[Union[str, Path]] = None) -> Path:
    ...
    Returns:
        Path to .shadowbot/knowledge/ in project
    """
...
def get_project_summaries_dir(project_path: Optional[Union[str, Path]] = None) -> Path:
    ...
    Returns:
        Path to .shadowbot/summaries/ in project
    """
...
def get_project_prp_dir(project_path: Optional[Union[str, Path]] = None) -> Path:
    ...
    Returns:
        Path to .shadowbot/prp/ in project
    """
...
def ensure_dir(path: Union[str, Path]) -> Path:
    ...
    Example:
        >>> from shadowbotagents.paths import ensure_dir, get_sessions_dir
