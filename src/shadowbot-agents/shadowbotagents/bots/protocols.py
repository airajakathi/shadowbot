"""
Bot Protocols for ShadowBot Agents.
...
All implementations should live in the shadowbot wrapper package.
"""
...
class BotProtocol(Protocol):
    ...
    Example usage (implementation in shadowbot wrapper):
...
class BotOSProtocol(Protocol):
    ...
    Implementations live in the ``shadowbot`` wrapper package.
    """
