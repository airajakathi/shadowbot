...
Usage:
    from shadowbotagents.tools import crawl4ai, crawl4ai_extract
    ...
    from shadowbotagents.tools import Crawl4AITools
    tools = Crawl4AITools()
...
def _check_crawl4ai_available() -> tuple[bool, Optional[str]]:
    ...
    if util.find_spec("crawl4ai") is None:
        return False, (
            ...
            "Install it with: pip install 'shadowbotagents[crawl]'"
        )
