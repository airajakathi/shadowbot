...
Usage:
    from shadowbotagents.tools import ydc_search, ydc_news, ydc_contents
    ...
    from shadowbotagents.tools import YouTools
    you = YouTools()
...
# Alias for simple usage: from shadowbotagents.tools import ydc
ydc = ydc_search
