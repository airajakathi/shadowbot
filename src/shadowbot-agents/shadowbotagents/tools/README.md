# ShadowBot Tools Guide

Welcome to the ShadowBot Tools directory! This guide will help you understand how our tools work and how to create new ones, whether you're a beginner or an experienced programmer.
...
ShadowBot now supports a plugin system for creating and distributing tools. External developers can create pip-installable tool packages!

### Quick Start

```python
from shadowbotagents import BaseTool, tool, Agent
...
```toml
[project]
name = "shadowbot-weather"
version = "1.0.0"

[project.entry-points."shadowbotagents.tools"]
weather = "shadowbot_weather.tools:WeatherTool"
```

**4. Users install and use:**
```bash
pip install shadowbot-weather
```
...
**Usage:**
```python
from shadowbotagents.tools import get_stock_price, get_stock_info
...
2. **Create Your Tool File**:
   ...
   - Place it in the `shadowbotagents/tools` directory
