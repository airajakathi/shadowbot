"""
Workflows System for ShadowBot Agents.
...
- Auto-discovery from .shadowbot/workflows/
...
class AgentFlow:
    ...
    Usage:
        from shadowbotagents import AgentFlow, Agent
        ...
        from shadowbotagents.workflows import WorkflowOutputConfig, WorkflowPlanningConfig
    ...
    def from_template(
        ...
        **kwargs
        ...
        try:
            ...
            from shadowbot.templates.loader import create_workflow_from_template
    ...
    def run(
        ...
        ```python
        from shadowbotagents import Workflow, Agent
...
CONCISE SUMMARY:"""
    ...
    def _evaluate_condition(
        ...
        from shadowbotagents.conditions for DRY condition handling.
        ...
        """
        from shadowbotagents.conditions.evaluator import evaluate_condition
...
class WorkflowManager:
    ...
    Example workflow file (.shadowbot/workflows/deploy.md):
        ```markdown
        ---
    ...
    def _substitute_variables(
        ...
        """
        from shadowbotagents.utils.variables import substitute_variables
