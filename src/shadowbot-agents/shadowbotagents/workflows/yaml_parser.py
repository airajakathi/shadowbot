"""
YAML Workflow Parser for ShadowBot Agents.
...
class YAMLWorkflowParser:
    ...
    def _parse_workflow_data(self, data: Dict[str, Any], extra_vars: Optional[Dict[str, Any]] = None) -> Workflow:
        ...
        framework = data.get('framework', 'shadowbot')
    ...
    def _resolve_tools(self, tools_config: List[str]) -> List[Callable]:
        ...
        for tool_name in tools_config:
            if tool_name in self.tool_registry:
                ...
                # Fallback: try to import from shadowbotagents.tools
                try:
                    from shadowbotagents import tools as builtin_tools
