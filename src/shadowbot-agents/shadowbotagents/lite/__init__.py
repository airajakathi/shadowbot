"""
ShadowBot Agents Lite - Minimal agent framework without heavy dependencies.

This subpackage provides a lightweight version of ShadowBot Agents that:
...
Usage:
    from shadowbotagents.lite import LiteAgent, LiteTask, Tools
