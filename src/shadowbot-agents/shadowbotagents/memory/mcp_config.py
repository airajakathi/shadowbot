"""
MCP Config Manager for ShadowBot Agents.
...
Features:
- Auto-discovery of MCP configs from .shadowbot/mcp/
...
class MCPConfig:
    ...
    def to_mcp_instance(self):
        ...
        """
        try:
            from shadowbotagents.tools.mcp import MCP
...
class MCPConfigManager:
    ...
    Provides:
    - Auto-discovery of MCP configs from .shadowbot/mcp/
    - Global configs from ~/.shadowbot/mcp/
    - Easy server management
    """
    ...
    def __init__(
        ...
        Args:
            ...
            global_mcp_path: Path to global MCP configs (default: ~/.shadowbot/mcp)
