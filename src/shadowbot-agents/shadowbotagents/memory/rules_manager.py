"""
Rules Manager for ShadowBot Agents.
...
class RulesManager:
    ...
    - Global rules (~/.shadowbot/rules/)
    - Workspace rules (.shadowbot/rules/)
    - Subdirectory rules (subdir/.shadowbot/rules/)
    ...
    ROOT_INSTRUCTION_FILES = [
        ...
        "PRAISON.md",       # ShadowBot native instructions
        "PRAISON.local.md", # ShadowBot local overrides (gitignored)
    ]
    ...
    def __init__(
        ...
        Args:
            ...
            global_rules_path: Path to global rules (default: ~/.shadowbot/rules)
    ...
    def _load_root_instruction_file(self, file_path: Path) -> Optional[Rule]:
        ...
        try:
            ...
            descriptions = {
                ...
                "praison": "ShadowBot native instructions",
                "praison_local": "ShadowBot local overrides",
            }
    ...
    def _load_all_rules(self):
        ...
        # 4. Load workspace rules from .shadowbot/rules/
