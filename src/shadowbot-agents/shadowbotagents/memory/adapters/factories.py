...
def create_mem0_memory_adapter(**kwargs) -> MemoryProtocol:
    ...
    try:
        ...
        raise ImportError(
            ...
            "Run: pip install 'shadowbotagents[memory]'"
        )
...
class Mem0MemoryAdapter:
    ...
    This adapter handles the integration between ShadowBot's memory interface
...
class MongoDBMemoryAdapter:
    ...
    def __init__(self, pymongo, mongo_client, **kwargs):
        ...
        database_name = config.get("database", "shadowbot")
