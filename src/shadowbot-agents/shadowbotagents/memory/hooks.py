"""
Cascade Hooks System for ShadowBot Agents.
...
- JSON configuration (.shadowbot/hooks.json)
- Script execution with timeout
- Exit code handling
- Lazy loading for performance

Configuration (.shadowbot/hooks.json):
    {
        "hooks": {
...
class HooksManager:
    ...
    Hooks are configured in .shadowbot/hooks.json and can execute
