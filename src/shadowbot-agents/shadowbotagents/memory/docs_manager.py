"""
Docs Manager for ShadowBot Agents.
...
Features:
- Auto-discovery of docs from .shadowbot/docs/
...
class DocsManager:
    ...
    Provides:
    - Auto-discovery of docs from .shadowbot/docs/
    - Global docs from ~/.shadowbot/docs/
    - @doc mentions for including specific docs
    ...
    def __init__(
        ...
        Args:
            ...
            global_docs_path: Path to global docs (default: ~/.shadowbot/docs)
