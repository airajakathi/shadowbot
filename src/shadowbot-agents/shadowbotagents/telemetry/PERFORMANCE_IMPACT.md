...
This document provides detailed analysis of the performance impact when PostHog telemetry is enabled by default in ShadowBot Agents.
...
from shadowbotagents import get_telemetry
...
from shadowbotagents import cleanup_telemetry_resources
...
**Version**: ShadowBot Agents v1.0.0+