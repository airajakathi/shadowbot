# ShadowBot Agents Telemetry

This module provides minimal, privacy-focused telemetry for ShadowBot Agents.
...
```python
from shadowbotagents.telemetry import enable_telemetry
enable_telemetry()
```
...
```python
from shadowbotagents.telemetry import get_telemetry
...
```python
from shadowbotagents.telemetry import disable_telemetry
disable_telemetry()
```

## Usage

The telemetry module integrates automatically with ShadowBot Agents:
...
workflow = ShadowBotAgents(agents=[agent], tasks=[task])
...
```python
from shadowbotagents.telemetry import TelemetryCollector
