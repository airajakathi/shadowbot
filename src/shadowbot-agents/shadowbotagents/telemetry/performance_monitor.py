"""
User-Friendly Performance Monitoring for ShadowBot
...
class PerformanceMonitor:
    ...
    def export_metrics_for_external_apm(self, service_name: str = "shadowbot-agents") -> Dict[str, Any]:
        """
...
def export_external_apm_metrics(service_name: str = "shadowbot-agents") -> Dict[str, Any]:
