"""
Performance Monitoring CLI for ShadowBot
...
Usage:
    python -m shadowbotagents.telemetry.performance_cli [command] [options]
    
Or import and use programmatically:
    from shadowbotagents.telemetry.performance_cli import PerformanceCLI
    cli = PerformanceCLI()
...
class PerformanceCLI:
    ...
    def show_performance_report(self, detailed: bool = False) -> None:
        ...
        print("📊 ShadowBot Performance Monitoring Report")
        print("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="ShadowBot Performance Monitoring CLI",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python -m shadowbotagents.telemetry.performance_cli report
  python -m shadowbotagents.telemetry.performance_cli functions
  python -m shadowbotagents.telemetry.performance_cli apis
  python -m shadowbotagents.telemetry.performance_cli slowest-functions 5
  python -m shadowbotagents.telemetry.performance_cli flow
  python -m shadowbotagents.telemetry.performance_cli analyze-flow
  python -m shadowbotagents.telemetry.performance_cli trends
        """
    )
