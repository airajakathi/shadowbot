"""
File Snapshot implementation for ShadowBot Agents.
...
class FileSnapshot:
    ...
    def __init__(
        ...
        Args:
            ...
            user_name: Git user.name for commits (default: from env PRAISONAI_GIT_USER_NAME or "ShadowBot Snapshot")
            user_email: Git user.email for commits (default: from env PRAISONAI_GIT_USER_EMAIL or "praison@snapshot.local")
        """
        self.project_path = os.path.abspath(project_path)
        self.session_id = session_id
        self.user_name = user_name or os.getenv("PRAISONAI_GIT_USER_NAME", "ShadowBot Snapshot")
