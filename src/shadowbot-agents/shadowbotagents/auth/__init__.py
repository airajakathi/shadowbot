"""
Authentication & Authorization Protocols for ShadowBot Agents.
...
Quick start::
    ...
    from shadowbotagents.auth import AuthIdentity, AuthBackendProtocol
...
Subscription auth (lazy-loaded)::
    ...
    from shadowbotagents.auth import resolve_subscription_credentials
