"""Workspace management for ShadowBot agents.
...
class Workspace:
    ...
    def from_config(cls, config: Optional[object], *, session_key: str) -> "Workspace":
        ...
        if not workspace_dir:
            # Default: ~/.shadowbot/workspaces/<scope>/<session_key>
            home = Path.home()
            workspace_dir = home / ".shadowbot" / "workspaces" / workspace_scope / session_key
        else:
