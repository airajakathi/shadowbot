"""
Policy Configuration for ShadowBot Agents.
...
class PolicyConfig:
    ...
    Follows ShadowBot's ``False/True/Config`` progressive-disclosure pattern:
    ...
    rules_file: Optional[str] = None  # Defaults to ~/.shadowbot/rules/default.rules
