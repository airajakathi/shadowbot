"""
Embedding module for ShadowBot Agents.

This module provides a unified embedding API that can be used throughout
the shadowbotagents package. It consolidates embedding functionality that
...
Usage:
    ...
    >>> from shadowbotagents.embedding import embedding, EmbeddingResult
    >>> result = embedding(["Hello", "World"])
    >>> print(len(result))
    2
