    ...
    def launch(self, path: str = '/agents', port: int = 8000, host: str = '0.0.0.0', debug: bool = False, protocol: str = "http"):
        ...
        if protocol == "http":
            ...
            if is_new:
                ...
                async def root():
                    return {
                        "message": f"Welcome to ShadowBot Agents API on port {port}. See /docs for usage.",
            ...
            mcp_instance = FastMCP("shadowbot_workflow_mcp_server")
...
# AgentManager, Agents, ShadowBotAgents are silent aliases
AgentManager = AgentTeam
Agents = AgentTeam
ShadowBotAgents = AgentTeam
