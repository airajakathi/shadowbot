"""
Structured exception hierarchy for ShadowBot SDK.
...
class ShadowBotError(Exception):
    """
    Base error class with structured context for ShadowBot SDK.
    
    All ShadowBot errors inherit from this to ensure uniform error handling,
...
class ToolExecutionError(ShadowBotError):
    """
...
class BudgetExceededError(ShadowBotError):
    """
...
class ValidationError(ShadowBotError):
    """
...
class NetworkError(ShadowBotError):
    """
...
class HandoffError(ShadowBotError):
    """
...
class ShadowBotConfigError(ShadowBotError):
    """
