...
""" + error_context
    ...
    def workflow(self):
        ...
        ```python
        from shadowbotagents import Workflow, StepResult
        from shadowbotagents.workflows import route, parallel, loop, repeat
        ...
        warn_deprecated_param(
            ...
            since="1.0.0",
            removal="2.0.0", 
            alternative="use the Workflow class instead: from shadowbotagents import Workflow; workflow = Workflow(steps=[...]); workflow.start()",
            stacklevel=3
        )
        current_iter = 0  # Track how many times we've looped
        workflow_start = time.monotonic()  # For timeout enforcement
