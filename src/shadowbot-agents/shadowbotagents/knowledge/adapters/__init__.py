"""
Knowledge Store Adapters for ShadowBot Agents.
...
_LAZY_IMPORTS = {
    "Mem0Adapter": ("shadowbotagents.knowledge.adapters.mem0_adapter", "Mem0Adapter"),
    "MongoDBKnowledgeAdapter": ("shadowbotagents.knowledge.adapters.mongodb_adapter", "MongoDBKnowledgeAdapter"),
}
