...
Provides A2UIAgent wrapper for generating A2UI responses from ShadowBot agents.
"""
...
class A2UIAgent:
    """
    A2UI wrapper for ShadowBot agents.
    
    Provides methods to generate A2UI responses from agent interactions.
    
    Example:
        >>> from shadowbotagents import Agent
        >>> from shadowbotagents.ui.a2ui import A2UIAgent
        >>> 
    ...
    def __init__(
        ...
        Args:
            agent: The ShadowBot Agent to wrap
