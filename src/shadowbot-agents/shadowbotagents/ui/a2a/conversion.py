...
Convert between A2A protocol messages and ShadowBot internal format.
"""
...
def a2a_to_shadowbot_messages(messages: List[Message]) -> List[Dict[str, Any]]:
    """
    Convert A2A messages to ShadowBot/OpenAI chat format.
...
def shadowbot_to_a2a_message(
    ...
    """
    Convert ShadowBot response to A2A Message.
