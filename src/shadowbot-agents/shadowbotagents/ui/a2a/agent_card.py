...
Generate Agent Cards from ShadowBot Agents for A2A discovery.
"""
...
def generate_agent_card(
    ...
    """
    Generate an A2A Agent Card from a ShadowBot Agent.
    ...
    """
    # Get agent name
    name = getattr(agent, 'name', None) or "ShadowBot Agent"
    ...
    description = ". ".join(description_parts) if description_parts else "ShadowBot Agent"
