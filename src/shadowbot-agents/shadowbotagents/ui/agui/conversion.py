...
Converts between AG-UI message format and ShadowBot message format.
"""
...
def agui_messages_to_shadowbot(messages: List[Message]) -> List[Dict[str, Any]]:
    """
    Convert AG-UI messages to ShadowBot format.
    
    Args:
        messages: List of AG-UI Message objects
        
    Returns:
        List of message dictionaries in ShadowBot format
    """
    if not messages:
        return []
...
def shadowbot_messages_to_agui(messages: List[Dict[str, Any]]) -> List[Message]:
    """
    Convert ShadowBot messages to AG-UI format.
    
    Args:
        messages: List of message dictionaries in ShadowBot format
