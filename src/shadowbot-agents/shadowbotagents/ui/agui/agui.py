...
Exposes ShadowBot Agents via the AG-UI protocol.
"""
...
from shadowbotagents.ui.agui.types import (
    BaseEvent,
    RunAgentInput,
)
from shadowbotagents.ui.agui.conversion import (
    agui_messages_to_shadowbot,
    validate_state,
    extract_user_input,
)
from shadowbotagents.ui.agui.streaming import (
...
class AGUI:
    """
    AG-UI Interface for ShadowBot Agents.
    
    Exposes a ShadowBot Agent or Agents workflow via the AG-UI protocol,
    ...
    def __init__(
        ...
        if description:
            ...
            self.description = "ShadowBot Agent via AG-UI"
        ...
        try:
            ...
            if self.agent:
                async for event in async_stream_agent_response(
                    ...
                    messages=agui_messages_to_shadowbot(messages),
                ):
                    yield event
