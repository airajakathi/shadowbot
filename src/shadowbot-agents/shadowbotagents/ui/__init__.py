"""
UI Integrations for ShadowBot Agents

This module provides UI protocol integrations for exposing ShadowBot Agents
...
def __getattr__(name):
    ...
    if name == "AGUI":
        ...
        from shadowbotagents.ui.a2ui import A2UI
