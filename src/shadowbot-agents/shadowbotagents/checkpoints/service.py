"""
Checkpoint Service for ShadowBot Agents.
...
class CheckpointService:
    ...
    Example:
        service = CheckpointService(
            ...
            storage_dir="~/.shadowbot/checkpoints"
        )
    ...
    def __init__(
        ...
        user_name: str = "ShadowBot Checkpoints",
        ...
        Args:
            ...
            user_name: Git user.name for commits (default: "ShadowBot Checkpoints")
