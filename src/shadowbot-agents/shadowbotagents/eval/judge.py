...
Follows ShadowBot naming conventions and engineering principles.
...
class RecipeJudge(Judge):
    ...
    in the shadowbot wrapper package for full trace analysis.
    ...
    Example:
        >>> from shadowbotagents.eval import RecipeJudge
...
# Registry functions following ShadowBot naming conventions
