...
This module provides DRY utilities for lazy loading across the shadowbotagents package.
...
Usage:
    ...
    HookEvent = lazy_import('shadowbotagents.hooks.types', 'HookEvent')
...
def lazy_import(
    ...
    Args:
        module_path: Full module path (e.g., 'shadowbotagents.hooks.types')
...
class LazyModule:
    ...
    Example:
        _hooks_types = LazyModule('shadowbotagents.hooks.types')
