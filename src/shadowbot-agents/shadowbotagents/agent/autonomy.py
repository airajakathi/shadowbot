...
class AutonomyConfig:
    ...
    Attributes:
        ...
        snapshot_dir: Directory for snapshot storage. Defaults to ~/.shadowbot/snapshots.
    ...
    snapshot_dir: Optional[str] = None  # Defaults to ~/.shadowbot/snapshots
...
class AutonomySignal(str, Enum):
    ...
    .. deprecated::
        ...
        shadowbotagents.escalation.types instead. AutonomyTrigger
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        warn_deprecated_param(
            ...
            since="1.0.0",
            removal="2.0.0", 
            alternative="use EscalationSignal from shadowbotagents.escalation.types instead",
            stacklevel=3
        )
