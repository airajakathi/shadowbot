"""
Unified Configuration Resolver for ShadowBot.
...
Usage:
    from shadowbotagents.config.resolver import get_config, ConfigRegistry
...
class ConfigRegistry:
    ...
    def get_unknown_env_vars(cls) -> Set[str]:
        ...
        # Filter ShadowBot-related vars only (to reduce noise)
...
# Register core ShadowBot configuration entries
