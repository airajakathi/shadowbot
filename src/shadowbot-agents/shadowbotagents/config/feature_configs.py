"""
Feature Configuration Classes for ShadowBot Agents.
...
Usage:
    from shadowbotagents import Agent, MemoryConfig, KnowledgeConfig
...
class ExecutionConfig:
    ...
    # Opt-in only (safe default: False). Uses existing shadowbotagents.compaction module.
