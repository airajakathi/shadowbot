"""Agent Skills module for ShadowBot Agents.
...
Usage:
    from shadowbotagents.skills import SkillManager, SkillProperties
...
def __getattr__(name: str):
    ...
    if name == "load_skill":
        # Fixes G12: shadowbot.capabilities.skills.skill_load import target.
