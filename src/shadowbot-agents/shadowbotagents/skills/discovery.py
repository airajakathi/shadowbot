...
def get_default_skill_dirs() -> List[Path]:
    ...
    1. Project: ./.shadowbot/skills/ or ./.claude/skills/
    2. User: ~/.shadowbot/skills/
    ...
    # `.shadowbot/skills` so monorepo packages pick up workspace skills.
    for parent in cwd.parents:
        for sub in (".shadowbot/skills", ".claude/skills"):
            p = parent / sub
