...
context management. Implementations live in the wrapper (shadowbot).
...
Usage:
    from shadowbotagents.context.artifacts import ArtifactRef, ArtifactStoreProtocol
...
class ArtifactStoreProtocol(Protocol):
    ...
    Example implementation in wrapper:
        class FileSystemArtifactStore:
            def store(self, content, metadata):
                # Write to ~/.shadowbot/runs/{run_id}/artifacts/
                ...
    """
