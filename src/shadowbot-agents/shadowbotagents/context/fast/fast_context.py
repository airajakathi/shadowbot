...
Example usage:
    # Standalone usage
    from shadowbotagents.context.fast import FastContext
...
from shadowbotagents.context.fast.result import FastContextResult, FileMatch, LineRange
...
class FastContext:
    ...
    def search_files(
        ...
        """
        from shadowbotagents.context.fast.search_tools import glob_search
    ...
    def read_context(
        ...
        """
        from shadowbotagents.context.fast.search_tools import read_file
