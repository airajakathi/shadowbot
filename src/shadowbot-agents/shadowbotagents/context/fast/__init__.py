...
def __getattr__(name):
    ...
    if name == "FastContext":
        from shadowbotagents.context.fast.fast_context import FastContext
        return FastContext
    elif name == "FastContextResult":
        from shadowbotagents.context.fast.result import FastContextResult
        return FastContextResult
    elif name == "FileMatch":
        from shadowbotagents.context.fast.result import FileMatch
        return FileMatch
    elif name == "LineRange":
        from shadowbotagents.context.fast.result import LineRange
        return LineRange
    elif name == "FastContextAgent":
        from shadowbotagents.context.fast.fast_context_agent import FastContextAgent
        return FastContextAgent
    # New optimization exports
    elif name == "get_search_backend":
        from shadowbotagents.context.fast.search_backends import get_search_backend
        return get_search_backend
    elif name == "PythonSearchBackend":
        from shadowbotagents.context.fast.search_backends import PythonSearchBackend
        return PythonSearchBackend
    elif name == "RipgrepBackend":
        from shadowbotagents.context.fast.search_backends import RipgrepBackend
        return RipgrepBackend
    elif name == "FileIndex":
        from shadowbotagents.context.fast.index_manager import FileIndex
        return FileIndex
    elif name == "get_compressor":
        from shadowbotagents.context.fast.compressor import get_compressor
        return get_compressor
    elif name == "TruncateCompressor":
        from shadowbotagents.context.fast.compressor import TruncateCompressor
        return TruncateCompressor
    elif name == "SmartCompressor":
        from shadowbotagents.context.fast.compressor import SmartCompressor
