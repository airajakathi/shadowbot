"""
Tool Loop Detection Plugin for ShadowBot Agents.
...
Usage:
    ...
    import shadowbotagents.plugins.loop_detection_plugin
...
from shadowbotagents.hooks.registry import add_hook
from shadowbotagents.hooks.types import HookEvent, HookInput, HookResult
