"""
Plugin Module for ShadowBot Agents.
...
Usage:
    from shadowbotagents.plugins import PluginManager, Plugin, PluginHook
    ...
    from shadowbotagents.plugins.builtin import LoggingPlugin, MetricsPlugin
    manager.register(LoggingPlugin())
    
    # Use plugin SDK
    from shadowbotagents.plugins.sdk import plugin
...
def enable(plugins: list = None) -> None:
    ...
    Note:
        ...
        - Can also be enabled via .shadowbot/config.toml
    """
