...
from shadowbot.cli.features.n8n import N8nHandler, _default_api_url


def test_default_api_url_uses_host_docker_internal_on_macos_localhost():
    with patch("shadowbot.cli.features.n8n.platform.system", return_value="Darwin"):
...
def test_default_api_url_keeps_loopback_on_linux_localhost():
    with patch("shadowbot.cli.features.n8n.platform.system", return_value="Linux"):
