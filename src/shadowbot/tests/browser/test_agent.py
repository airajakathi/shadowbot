...
from shadowbot.browser.agent import BrowserAgent, BROWSER_AGENT_SYSTEM_PROMPT
...
class TestBrowserAgentWithMock:
    """Tests for BrowserAgent with mocked ShadowBot agent."""
    
    @patch("shadowbot.browser.agent.BrowserAgent._ensure_agent")
