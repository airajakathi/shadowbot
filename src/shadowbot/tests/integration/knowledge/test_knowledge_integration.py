...
class TestVectorStoreIntegration:
    ...
    def test_chroma_vector_store(self):
        ...
        try:
            from shadowbot.adapters.vector_stores import ChromaVectorStore
        except ImportError:
    ...
    def test_pinecone_vector_store(self):
        ...
        try:
            from shadowbot.adapters.vector_stores import PineconeVectorStore
        except ImportError:
...
class TestRerankerIntegration:
    ...
    def test_llm_reranker(self):
        ...
        try:
            from shadowbot.adapters.rerankers import LLMReranker
        except ImportError:
    ...
    def test_cohere_reranker(self):
        ...
        try:
            from shadowbot.adapters.rerankers import CohereReranker
        except ImportError:
...
class TestRetrieverIntegration:
    ...
    def test_basic_retriever(self):
        ...
        from shadowbotagents.knowledge.vector_store import InMemoryVectorStore
        try:
            from shadowbot.adapters.retrievers import BasicRetriever
        except ImportError:
    ...
    def test_fusion_retriever(self):
        ...
        from shadowbotagents.knowledge.vector_store import InMemoryVectorStore
        try:
            from shadowbot.adapters.retrievers import FusionRetriever
        except ImportError:
            pytest.skip("Retriever not available")
