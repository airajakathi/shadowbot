...
Tests the delegation and proxy branches of ShadowBot.main() directly (no subprocess),
...
def _build_args(extra: dict):
    """Build a minimal argparse.Namespace that mimics `shadowbot <prompt> --external-agent ...`."""
