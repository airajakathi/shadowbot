...
from shadowbotagents.bots import BotMessage, BotUser, BotChannel, MessageType
from shadowbotagents.bots.config import BotConfig
from shadowbotagents.bots.pairing_types import PairingApprovalResult
from shadowbot.bots._unknown_user import UnknownUserHandler, BotContext
from shadowbot.bots._pairing_ui import PairingCallbackHandler, PairingUIBuilder
from shadowbot.gateway.pairing import PairingStore
...
class TestPairingOwnerDM:
    ...
    async def test_no_owner_id_falls_back_to_cli(self):
        ...
        assert "shadowbot pairing approve" in sent_msg["text"]
