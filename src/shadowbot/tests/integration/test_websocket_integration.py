"""
WebSocket integration tests for the ShadowBot Gateway.
...
class TestWebSocketIntegration:
    ...
    async def test_gateway_health_endpoint(self):
        ...
        try:
            from shadowbot.gateway.server import WebSocketGateway, GatewayConfig
        except ImportError:
            pytest.skip("shadowbot.gateway not available")
    ...
    async def test_websocket_connect_and_message(self):
        ...
        try:
            ...
            pytest.skip("websockets or shadowbot.gateway not available")
...
class TestChannelCommandFiltering:
    ...
    def test_register_command_with_channels(self):
        ...
        try:
            from shadowbot.bots._protocol_mixin import ChatCommandMixin
        except ImportError:
            pytest.skip("shadowbot.bots not available")
