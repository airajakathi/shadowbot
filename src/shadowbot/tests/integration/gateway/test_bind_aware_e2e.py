...
sys.path.insert(0, os.path.join(base_dir, 'shadowbot-agents'))
sys.path.insert(0, os.path.join(base_dir, 'shadowbot'))
...
def test_bind_aware_auth_with_real_agent():
    ...
    from shadowbotagents.gateway.protocols import is_loopback, resolve_auth_mode
