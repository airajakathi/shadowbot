...
from shadowbot.gateway.magic_link import MagicLinkStore
from shadowbot.gateway.cookie_auth import CookieAuthManager
...
class TestMagicLinkFlow:
    ...
    def test_cookie_auth_flow(self, auth_manager):
        ...
        assert "shadowbot_session=" in cookie_header
    ...
    def test_real_agentic_simulation(self, magic_store, auth_manager):
        ...
        # Step 1: Generate magic link (like shadowbot onboard would do)
        nonce = magic_store.mint(ttl=600)
