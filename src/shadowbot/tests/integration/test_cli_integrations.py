...
class TestIntegrationAvailability:
    ...
    def test_get_available_integrations(self):
        ...
        from shadowbot.integrations import get_available_integrations
...
class TestClaudeCodeIntegrationReal:
    ...
    def test_claude_integration_creation(self):
        ...
        from shadowbot.integrations import ClaudeCodeIntegration
...
class TestGeminiCLIIntegrationReal:
    ...
    def test_gemini_integration_creation(self):
        ...
        from shadowbot.integrations import GeminiCLIIntegration
...
class TestCursorCLIIntegrationReal:
    ...
    def test_cursor_integration_creation(self):
        ...
        from shadowbot.integrations import CursorCLIIntegration
...
class TestExternalAgentsHandler:
    ...
    def test_handler_creation(self):
        ...
        from shadowbot.cli.features import ExternalAgentsHandler
...
class TestPerformanceImpact:
    ...
    def test_lazy_loading_integrations(self):
        ...
        # Measure import time
        start = time.time()
        from shadowbot.integrations import BaseCLIIntegration
