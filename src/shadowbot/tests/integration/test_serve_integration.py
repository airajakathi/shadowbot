...
# Dynamic path to src/shadowbot — works on any CI runner or local machine
...
"""
    ...
    def test_serve_agents_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "shadowbot.cli.commands.serve", "agents", "--help"],
            capture_output=True,
            text=True,
            cwd=PRAISONAI_SRC
        )
...
class TestServeA2AIntegration:
    ...
    def test_serve_a2a_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "shadowbot.cli.commands.serve", "a2a", "--help"],
            capture_output=True,
            text=True,
            cwd=PRAISONAI_SRC
        )
...
class TestServeUnifiedIntegration:
    ...
    def test_serve_unified_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "shadowbot.cli.commands.serve", "unified", "--help"],
            capture_output=True,
            text=True,
            cwd=PRAISONAI_SRC
        )
...
class TestServeGatewayIntegration:
    ...
    def test_serve_gateway_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "shadowbot.cli.commands.serve", "gateway", "--help"],
            capture_output=True,
            text=True,
            cwd=PRAISONAI_SRC
        )
...
class TestServeMCPIntegration:
    ...
    def test_serve_mcp_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "shadowbot.cli.commands.serve", "mcp", "--help"],
            capture_output=True,
            text=True,
            cwd=PRAISONAI_SRC
        )
...
class TestServeRecipeIntegration:
    ...
    def test_serve_recipe_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "shadowbot.cli.commands.serve", "recipe", "--help"],
            capture_output=True,
            text=True,
            cwd=PRAISONAI_SRC
        )
...
class TestAllServeCommandsHelp:
    ...
    def test_serve_command_help(self, command):
        ...
        from shadowbot.cli.commands.serve import app
