...
Tests that install.sh with a seeded .env token triggers shadowbot onboard.
"""
...
def test_install_sh_mentions_bot_onboarding():
    ...
    assert "shadowbot onboard" in content
...
def test_daemon_windows_platform_detection():
    ...
    from shadowbot.daemon.windows import get_status
