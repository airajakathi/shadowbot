"""
Real API Key Smoke Tests for ShadowBot.
...
'''
    ...
    def test_cli_shadowbot_class(self):
        """Test ShadowBot class instantiation."""
        code = '''
import os
os.environ['LOGLEVEL'] = 'WARNING'
from shadowbot.cli.main import ShadowBot
pai = ShadowBot(agent_file="agents.yaml", framework="shadowbot")
print("CLASS_OK")
'''
        result = run_python_code(code, timeout=30)
...
os.environ['LOGLEVEL'] = 'WARNING'
from shadowbot.cli.main import ShadowBot
heavy = ['litellm', 'instructor', 'shadowbot.auto']
