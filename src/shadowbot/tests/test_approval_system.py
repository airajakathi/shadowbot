...
class TestApprovalFlags:
    ...
    def test_trust_flag_in_shadowbot_parser(self):
        """Test that --trust flag is in ShadowBot's actual parser."""
        ...
        assert hasattr(args, 'trust'), "ShadowBot.args should have 'trust' attribute"
        # Cleanup
        del praison
    
    def test_approve_level_flag_in_shadowbot_parser(self):
        """Test that --approve-level flag is in ShadowBot's actual parser."""
        from shadowbot.cli.main import ShadowBot
        ...
        assert hasattr(args, 'approve_level'), "ShadowBot.args should have 'approve_level' attribute"
...
class TestApprovalCallback:
    ...
    def test_set_approval_callback(self):
        ...
        from shadowbotagents.approval import approval_callback
...
class TestApprovalRequirements:
    ...
    def test_default_dangerous_tools(self):
        ...
        from shadowbotagents.approval import APPROVAL_REQUIRED_TOOLS, TOOL_RISK_LEVELS
