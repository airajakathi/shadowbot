...
Tests the new n8n package for bidirectional conversion between ShadowBot YAML
...
class TestN8nConverter:
    ...
    def test_tool_conversion(self):
        ...
        try:
            from shadowbot.n8n.converter import YAMLToN8nConverter
        except ImportError:
            pytest.skip("n8n dependencies not available")
...
class TestN8nCLIIntegration:
    ...
    def test_cli_command_structure(self):
        ...
        try:
            from shadowbot.cli.commands.n8n import app
        except ImportError:
    ...
    def test_execute_method_exists(self):
        ...
        try:
            from shadowbot.cli.commands.n8n import export, preview
        except ImportError:
            pytest.skip("CLI commands not available")
...
class TestN8nRoundTrip:
    ...
    def test_converter_roundtrip_preserves_all_fields(self):
        ...
        try:
            from shadowbot.n8n import YAMLToN8nConverter, N8nToYAMLConverter
        except ImportError:
            pytest.skip("n8n dependencies not available")
