#!/usr/bin/env python3
"""
Simple test runner for ShadowBot Agents
...
def run_tests_with_subprocess():
    ...
    print("🧪 ShadowBot Agents - Simple Test Runner")
    print("=" * 50)
...
def run_fast_tests():
    ...
    try:
        result = subprocess.run([
            sys.executable, "-c", 
            "import sys; sys.path.insert(0, 'src'); import shadowbotagents; print('✅ Import successful')"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Simple ShadowBot Test Runner")
