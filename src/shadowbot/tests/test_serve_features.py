...
class TestRateLimiting:
    ...
    def test_rate_limit_middleware_returns_429(self):
        ...
        from shadowbot.recipe.serve import create_app
...
class TestRequestSizeLimits:
    ...
    def test_default_size_limit_is_10mb(self):
        ...
        from shadowbot.recipe.serve import DEFAULT_MAX_REQUEST_SIZE
...
class TestMetricsEndpoint:
    ...
    def test_metrics_prometheus_format(self):
        ...
        assert "shadowbot_http_requests_total" in content
        assert "shadowbot_http_request_duration_seconds" in content
