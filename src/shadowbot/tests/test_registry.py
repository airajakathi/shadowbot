...
class TestLocalRegistry:
    ...
    def temp_registry(self, tmp_path):
        ...
        from shadowbot.recipe.registry import LocalRegistry
    ...
    def test_publish_duplicate_fails(self, temp_registry, sample_bundle):
        ...
        from shadowbot.recipe.registry import RecipeExistsError
...
class TestRunHistory:
    ...
    def temp_history(self, tmp_path):
        ...
        from shadowbot.recipe.history import RunHistory
...
class TestLockfileValidation:
    ...
    def test_validate_with_lockfile(self, tmp_path):
        ...
        from shadowbot.recipe.security import validate_lockfile
...
class TestPIIRedaction:
    ...
    def test_redact_email(self):
        ...
        from shadowbot.recipe.security import redact_pii
    ...
    def test_detect_pii(self):
        ...
        from shadowbot.recipe.security import detect_pii
...
class TestPolicyPack:
    ...
    def test_default_policy(self):
        """Test default policy."""
        from shadowbot.recipe.policy import get_default_policy
    ...
    def test_check_tool_allowed(self):
        ...
        from shadowbot.recipe.policy import PolicyPack
    ...
    def test_check_tool_denied(self):
        ...
        from shadowbot.recipe.policy import PolicyPack, PolicyDeniedError
