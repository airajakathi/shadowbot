...
from shadowbot.persistence.conversation.base import validate_identifier
...
def test_async_sqlite_store_rejects_malicious_prefix(tmp_path):
    ...
    from shadowbot.persistence.conversation.async_sqlite import (
...
def test_other_backends_reject_malicious_prefix(module_name, class_name):
    ...
    mod = importlib.import_module(
        f"shadowbot.persistence.conversation.{module_name}"
    )
...
def test_postgres_store_rejects_malicious_schema():
    ...
    from shadowbot.persistence.conversation.postgres import (
