"""
Unit tests for ShadowBot Advanced Profiler features.
...
class TestAPICallProfiler:
    ...
    def test_api_call_record(self):
        ...
        from shadowbot.profiler import Profiler, APICallRecord
    ...
    def test_api_call_decorator(self):
        ...
        from shadowbot.profiler import Profiler, profile_api
...
class TestStreamingProfiler:
    ...
    def test_streaming_record(self):
        ...
        from shadowbot.profiler import Profiler, StreamingRecord
    ...
    def test_streaming_tracker(self):
        ...
        """
        from shadowbot.profiler import Profiler, StreamingTracker
...
class TestMemoryProfiler:
    ...
    def test_memory_record(self):
        ...
        from shadowbot.profiler import Profiler, MemoryRecord
...
class TestCProfileIntegration:
    ...
    def test_cprofile_decorator(self):
        ...
        from shadowbot.profiler import profile_detailed
...
class TestLineProfiler:
    ...
    def test_line_profile_decorator(self):
        ...
        from shadowbot.profiler import profile_lines, Profiler
...
class TestZeroPerformanceImpact:
    ...
    def test_disabled_no_overhead(self):
        ...
        from shadowbot.profiler import Profiler, profile
...
class TestAsyncProfiling:
    ...
    async def test_async_api_call(self):
        ...
        from shadowbot.profiler import Profiler, profile_api_async
