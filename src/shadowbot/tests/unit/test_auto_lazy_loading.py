...
1. Framework imports (crewai, autogen, shadowbotagents) are lazy-loaded
...
class TestAutoLazyLoading:
    ...
    def test_auto_module_import_does_not_import_crewai(self):
        ...
        if 'shadowbot.auto' in sys.modules:
            del sys.modules['shadowbot.auto']
        
        # Import auto module
        from shadowbot import auto
    ...
    def test_litellm_lazy_check_available(self):
        ...
        from shadowbot.auto import _check_litellm_available
    ...
    def test_openai_lazy_check_available(self):
        ...
        from shadowbot.auto import _check_openai_available
    ...
    def test_framework_availability_functions_exist(self):
        ...
        assert hasattr(auto, '_check_shadowbot_available')
        assert hasattr(auto, '_get_crewai')
        assert hasattr(auto, '_get_autogen')
        assert hasattr(auto, '_get_shadowbot')
...
class TestSafeStringSubstitution:
    ...
    def test_safe_substitute_with_curly_braces(self):
        ...
        from shadowbot.agents_generator import safe_format
...
class TestThreadSafety:
    ...
    def test_get_openai_client_no_root_logger_mutation(self):
        ...
        for key in list(sys.modules.keys()):
            if key in ("shadowbot.auto", "shadowbot.shadowbot.auto"):
                del sys.modules[key]

        import shadowbot.auto  # noqa: F401
    ...
    def test_typer_commands_concurrent_calls_all_return_set(self):
        ...
        import threading
        import shadowbot.__main__ as main_mod
    ...
    def test_typer_commands_failure_does_not_poison_cache(self):
        ...
        with mock.patch("shadowbot.cli.app.register_commands", side_effect=RuntimeError("boom")):
            result = main_mod._get_typer_commands()
