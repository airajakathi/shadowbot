...
# Add the shadowbot-agents path
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'shadowbot-agents'))

from shadowbotagents.escalation.types import (
    EscalationStage,
    EscalationConfig,
    EscalationResult,
    EscalationSignal,
...
from shadowbotagents.escalation.triggers import EscalationTrigger
from shadowbotagents.escalation.doom_loop import (
    DoomLoopDetector,
    DoomLoopConfig,
    DoomLoopType,
    RecoveryAction,
)
from shadowbotagents.escalation.pipeline import EscalationPipeline
