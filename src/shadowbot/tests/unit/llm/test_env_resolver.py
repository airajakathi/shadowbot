"""
Unit tests for shadowbot.llm.env.resolve_llm_endpoint().
...
try:
    from shadowbot.llm.env import resolve_llm_endpoint, LLMEndpoint, _DEFAULT_MODEL, _DEFAULT_BASE
except ImportError as e:
    pytest.skip(f"Could not import shadowbot.llm.env: {e}", allow_module_level=True)
