...
class TestTursoConversationStoreInit(unittest.TestCase):
    ...
    @patch("shadowbot.persistence.conversation.turso.libsql", create=True)
    def test_init_from_env_vars(self, mock_libsql):
        ...
        from shadowbot.persistence.conversation.turso import TursoConversationStore
    ...
    def test_import_error_without_libsql(self):
        ...
        try:
            # Force reimport
            if 'shadowbot.persistence.conversation.turso' in sys.modules:
                del sys.modules['shadowbot.persistence.conversation.turso']
...
class TestTursoConversationStoreCRUD(unittest.TestCase):
    ...
    def test_create_session(self):
        ...
        from shadowbot.persistence.conversation.base import ConversationSession
    ...
    def test_add_message(self):
        ...
        from shadowbot.persistence.conversation.base import ConversationMessage
