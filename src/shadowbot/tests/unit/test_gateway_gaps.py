...
Tests the fixes for ShadowBotUI gateway integration gaps.
"""
...
class TestGapS4AgentLevelQueries:
    ...
    def test_list_sessions_by_agent(self):
        ...
        from shadowbotagents.session import DefaultSessionStore
...
class TestGapS3GatewayAwareMemory:
    ...
    def test_session_data_has_gateway_fields(self):
        ...
        from shadowbotagents.session import SessionData
...
class TestGapS2ReExportWebSocketGateway:
    """Test Gap S2: Re-export WebSocketGateway from shadowbotagents.gateway."""

    def test_import_websocketgateway_from_core(self):
        """WebSocketGateway should be importable from shadowbotagents.gateway."""
        from shadowbotagents.gateway import WebSocketGateway
        
        # Should not raise ImportError
        assert WebSocketGateway is not None

    def test_import_gatewaysession_from_core(self):
        """GatewaySession should be importable from shadowbotagents.gateway."""
        from shadowbotagents.gateway import GatewaySession
        
        # Should not raise ImportError
        assert GatewaySession is not None

    def test_protocols_always_available(self):
        """Protocols should always be available without shadowbot wrapper."""
