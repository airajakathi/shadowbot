...
:func:`shadowbot.persistence.knowledge.base.validate_identifier` (an
...
from shadowbot.persistence.knowledge.base import validate_identifier
...
def test_pgvector_rejects_malicious_collection(monkeypatch):
    ...
    from shadowbot.persistence.knowledge.pgvector import PGVectorKnowledgeStore
...
def test_singlestore_rejects_malicious_collection(monkeypatch):
    ...
    from shadowbot.persistence.knowledge.singlestore_vector import (
...
def test_cassandra_rejects_malicious_collection(monkeypatch):
    ...
    from shadowbot.persistence.knowledge.cassandra import CassandraKnowledgeStore
