...
from shadowbotagents.sandbox import ResourceLimits, SandboxConfig, SandboxStatus
...
def _make_sandbox(mock_sandlock):
    ...
    sys.modules.pop("shadowbot.sandbox.sandlock", None)
    with patch.dict("sys.modules", {"sandlock": mock_sandlock}):
        from shadowbot.sandbox.sandlock import SandlockSandbox
...
class TestSandlockSandbox:
    ...
    def test_import_without_sandlock(self):
        ...
        with patch.dict("sys.modules", {"sandlock": None}):
            ...
            if "shadowbot.sandbox.sandlock" in sys.modules:
                del sys.modules["shadowbot.sandbox.sandlock"]
            from shadowbot.sandbox.sandlock import SandlockSandbox
    ...
    async def test_fallback_execution(self):
        ...
        with patch("shadowbot.sandbox.subprocess.SubprocessSandbox") as mock_subprocess:
