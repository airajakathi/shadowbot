...
from shadowbot.sandbox.daytona import DaytonaSandbox
from shadowbotagents.sandbox import SandboxStatus, ResourceLimits
...
class TestDaytonaSandbox:
    ...
    async def test_start_failure(self):
        ...
        with patch.object(DaytonaSandbox, 'is_available', True):
            ...
            with patch('shadowbot.sandbox.daytona.logger.info', side_effect=Exception("API Error")):
                sandbox = DaytonaSandbox()
    ...
    async def test_write_file(self):
        ...
        with patch('shadowbot.sandbox.daytona.logger.info') as mock_info:
    ...
    def test_init_with_defaults(self):
        ...
        assert sandbox.workspace_name.startswith("shadowbot-")
