...
from shadowbot.sandbox.modal import ModalSandbox
...
class TestModalSandbox:
    ...
    async def test_write_file_warning(self):
        ...
        with patch('shadowbot.sandbox.modal.logger.warning') as mock_warning:
    ...
    async def test_cleanup(self):
        ...
        with patch('shadowbot.sandbox.modal.logger.info') as mock_info:
    ...
    def test_init_with_defaults(self):
        ...
        assert sandbox.image == "python:3.11"
        assert sandbox.timeout == 300
        assert sandbox.app_name.startswith("shadowbot-sandbox-")
