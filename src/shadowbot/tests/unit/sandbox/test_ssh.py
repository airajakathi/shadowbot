...
from shadowbot.sandbox.ssh import SSHSandbox
...
class TestSSHSandbox:
    ...
    async def test_start_with_mocked_connection(self):
        ...
        with patch.dict(sys.modules, {"asyncssh": mock_asyncssh}):
            ...
            mock_connection.run.assert_called_once_with("mkdir -p /tmp/shadowbot")
    ...
    async def test_cleanup(self):
        ...
        mock_connection.run.assert_called_once_with("rm -rf /tmp/shadowbot/*")
