...
def test_agent_tool_execution_with_approval():
    ...
    try:
        ...
        from shadowbotagents.approval import set_approval_callback, console_approval_callback, ApprovalDecision
...
@patch('shadowbotagents.approval.console_approval_callback')
def test_agent_with_auto_approval(mock_console_callback, mock_confirm):
    ...
    try:
        ...
        try:
            from shadowbotagents.approval import set_approval_callback, ApprovalDecision, clear_approval_context, mark_approved
        except ImportError:
            assert False, "shadowbotagents.approval module not available - check import path"
...
def test_agent_python_code_execution(mock_console_callback, mock_confirm):
    ...
    try:
        ...
        from shadowbotagents import Agent
        from shadowbotagents.tools import execute_code
...
def main():
    ...
    print("🧪 ShadowBot Human Approval System - Agent Integration Tests")
    print("=" * 65)
