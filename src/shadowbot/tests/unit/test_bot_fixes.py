...
class TestRateLimiter:
    ...
    def test_rate_limiter_import(self):
        ...
        from shadowbot.bots._rate_limit import RateLimiter, RateLimitConfig
    ...
    def test_rate_limiter_for_platform(self):
        ...
        from shadowbot.bots._rate_limit import RateLimiter, PLATFORM_LIMITS
...
class TestAsyncioGetRunningLoop:
    ...
    def test_session_manager_uses_get_running_loop(self):
        ...
        import inspect
        from shadowbot.bots._session import BotSessionManager
...
class TestWhatsAppSessionManagerAttribute:
    ...
    def test_whatsapp_health_uses_session_mgr(self):
        ...
        import inspect
        from shadowbot.bots.whatsapp import WhatsAppBot
...
class TestLegacyApprovalDeprecation:
    ...
    def test_legacy_approval_emits_deprecation_warning(self):
        ...
        if 'shadowbot.bots._approval' in sys.modules:
            del sys.modules['shadowbot.bots._approval']
        
        with warnings.catch_warnings(record=True) as w:
            warnings.simplefilter("always")
            # Use importlib to avoid lint warning about unused import
            importlib.import_module('shadowbot.bots._approval')
...
class TestAckReactorIntegration:
    ...
    def test_discord_has_ack_reactor(self):
        ...
        import inspect
        from shadowbot.bots.discord import DiscordBot
    ...
    def test_slack_has_ack_reactor(self):
        ...
        import inspect
        from shadowbot.bots.slack import SlackBot
...
class TestPlatformLimits:
    ...
    def test_telegram_limits(self):
        ...
        from shadowbot.bots._rate_limit import PLATFORM_LIMITS
