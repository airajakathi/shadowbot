...
class TestGuardrailHandler:
    ...
    def test_guardrail_check_dependencies_available(self):
        """Test dependency check when shadowbotagents is available."""
        from shadowbot.cli.features.guardrail import GuardrailHandler
        handler = GuardrailHandler()
        available, msg = handler.check_dependencies()
        # Should be available if shadowbotagents is installed
    ...
    @patch('shadowbot.cli.features.guardrail.PRAISONAI_AVAILABLE', True)
    def test_guardrail_execute_with_string(self):
        ...
        with patch('shadowbot.cli.features.guardrail.LLMGuardrail') as mock_guardrail:
            mock_instance = Mock()
...
class TestTelemetryHandler:
    ...
    def test_telemetry_enable(self):
        ...
        with patch('shadowbot.cli.features.telemetry.enable_telemetry'):
            handler.enable()
...
class TestFastContextHandler:
    ...
    def test_fast_context_handler_import(self):
        ...
        from shadowbot.cli.features import FastContextHandler
    ...
    def test_fast_context_handler_initialization(self):
        ...
        from shadowbot.cli.features.fast_context import FastContextHandler
...
class TestAutoMemoryHandler:
    ...
    def test_auto_memory_handler_import(self):
        ...
        from shadowbot.cli.features import AutoMemoryHandler
    ...
    def test_auto_memory_handler_initialization(self):
        ...
        from shadowbot.cli.features.auto_memory import AutoMemoryHandler
...
class TestFlowDisplayHandler:
    ...
    def test_flow_display_handler_import(self):
        ...
        from shadowbot.cli.features import FlowDisplayHandler
    ...
    def test_flow_display_handler_initialization(self):
        ...
        from shadowbot.cli.features.flow_display import FlowDisplayHandler
...
class TestCLIArgumentParsing:
    ...
    def test_guardrail_argument_parsed(self):
        ...
        with patch.object(sys, 'argv', ['shadowbot', '--guardrail', 'Check output']):
            ShadowBot()  # Just verify no exception is raised
    
    def test_metrics_argument_parsed(self):
        """Test that --metrics argument is parsed correctly."""
        from shadowbot.cli import ShadowBot
        
        with patch.object(sys, 'argv', ['shadowbot', '--metrics']):
            ShadowBot()  # Just verify no exception is raised
    ...
    def test_image_argument_parsed(self):
        ...
        with patch.object(sys, 'argv', ['shadowbot', '--image', '/path/to/image.png']):
            ShadowBot()  # Just verify no exception is raised
