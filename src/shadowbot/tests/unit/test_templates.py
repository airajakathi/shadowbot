...
class TestTemplateResolver:
    ...
    def test_resolve_local_path(self):
        ...
        from shadowbot.templates.resolver import TemplateResolver, TemplateSource
    ...
    def test_cache_key_generation(self):
        ...
        from shadowbot.templates.resolver import TemplateResolver
...
class TestTemplateCache:
    ...
    def test_cache_put_and_get(self, temp_cache_dir):
        ...
        from shadowbot.templates.cache import TemplateCache
        from shadowbot.templates.resolver import TemplateResolver
    ...
    def test_cache_expiration(self, temp_cache_dir):
        ...
        from shadowbot.templates.cache import TemplateCache, CacheMetadata
        import time
...
class TestTemplateSecurity:
    ...
    def test_source_allowlist(self):
        ...
        from shadowbot.templates.security import TemplateSecurity, SecurityConfig
    ...
    def test_local_paths_allowed_by_default(self):
        ...
        from shadowbot.templates.security import TemplateSecurity
...
class TestCLIIntegration:
    ...
    def test_templates_handler_init(self):
        ...
        from shadowbot.cli.features.templates import TemplatesHandler
...
class TestFromTemplateClassmethods:
    ...
    def test_agent_from_template_import_error(self):
        """Test Agent.from_template raises ImportError when shadowbot not available."""
        # This test verifies the error handling path
        # In actual use, shadowbot would be available
        pass  # Skip for now as shadowbot is available in test environment
    
    def test_workflow_from_template_import_error(self):
        """Test Workflow.from_template raises ImportError when shadowbot not available."""
        # This test verifies the error handling path
        pass  # Skip for now
...
""")
    ...
    def test_convenience_functions(self, discovery_setup):
        ...
        from shadowbot.templates.discovery import discover_templates, find_template_path
...
# =============================================================================
# TODO 6: Tests for 'shadowbot tools doctor'
# =============================================================================
...
class TestToolsDoctor:
    ...
    def test_doctor_returns_structured_output(self):
        ...
        assert isinstance(result, dict)
        assert "shadowbot_tools_installed" in result
        assert "builtin_tools" in result
        assert "custom_tools_dirs" in result
        assert "issues" in result
    
    def test_doctor_detects_shadowbot_tools(self):
        """Test that doctor detects shadowbot-tools installation."""
        from shadowbot.templates.tools_doctor import ToolsDoctor
        ...
        # Should be a boolean
        assert isinstance(result["shadowbot_tools_installed"], bool)
    ...
    def test_doctor_json_output(self):
        ...
        assert "shadowbot_tools_installed" in parsed
...
''')
    ...
    def test_load_tools_from_file(self, custom_tools_file):
        ...
        from shadowbot.templates.tool_override import ToolOverrideLoader
    ...
    def test_reject_remote_urls(self):
        ...
        from shadowbot.templates.tool_override import ToolOverrideLoader, SecurityError
...
""")
    ...
    def test_tools_py_loaded(self, temp_simplified_recipe, monkeypatch):
        ...
        setting the env var.
        """
        from shadowbot.templates.tool_override import create_tool_registry_with_overrides
