"""
Unit tests for ShadowBot Capabilities Module.
...
class TestAudioCapabilities:
    ...
    def test_transcription_result_dataclass(self):
        ...
        from shadowbot.capabilities.audio import TranscriptionResult
    ...
    def test_speech_result_dataclass(self):
        ...
        from shadowbot.capabilities.audio import SpeechResult
...
class TestImagesCapabilities:
    ...
    def test_image_result_dataclass(self):
        ...
        from shadowbot.capabilities.images import ImageResult
...
class TestFilesCapabilities:
    ...
    def test_file_result_dataclass(self):
        ...
        from shadowbot.capabilities.files import FileResult
...
class TestEmbeddingsCapabilities:
    ...
    def test_embedding_result_dataclass(self):
        ...
        from shadowbot.capabilities.embeddings import EmbeddingResult
    ...
    def test_embed_function(self, mock_embedding):
        """Test embed function."""
        from shadowbot.capabilities.embeddings import embed
...
class TestRerankCapabilities:
    ...
    def test_rerank_result_dataclass(self):
        ...
        from shadowbot.capabilities.rerank import RerankResult
...
class TestModerationsCapabilities:
    ...
    def test_moderation_result_dataclass(self):
        ...
        from shadowbot.capabilities.moderations import ModerationResult
...
class TestOCRCapabilities:
    ...
    def test_ocr_result_dataclass(self):
        ...
        from shadowbot.capabilities.ocr import OCRResult
...
class TestBatchesCapabilities:
    ...
    def test_batch_result_dataclass(self):
        ...
        from shadowbot.capabilities.batches import BatchResult
...
class TestVectorStoresCapabilities:
    ...
    def test_vector_store_result_dataclass(self):
        ...
        from shadowbot.capabilities.vector_stores import VectorStoreResult
...
class TestAssistantsCapabilities:
    ...
    def test_assistant_result_dataclass(self):
        ...
        from shadowbot.capabilities.assistants import AssistantResult
...
class TestFineTuningCapabilities:
    ...
    def test_fine_tuning_result_dataclass(self):
        ...
        from shadowbot.capabilities.fine_tuning import FineTuningResult
...
class TestPassthroughCapabilities:
    ...
    def test_passthrough_result_dataclass(self):
        ...
        from shadowbot.capabilities.passthrough import PassthroughResult
...
class TestResponsesCapabilities:
    ...
    def test_response_result_dataclass(self):
        ...
        from shadowbot.capabilities.responses import ResponseResult
...
class TestContainersCapabilities:
    ...
    def test_container_result_dataclass(self):
        ...
        from shadowbot.capabilities.containers import ContainerResult
...
class TestSearchCapabilities:
    ...
    def test_search_result_dataclass(self):
        ...
        from shadowbot.capabilities.search import SearchResult
...
class TestA2ACapabilities:
    ...
    def test_a2a_result_dataclass(self):
        ...
        from shadowbot.capabilities.a2a import A2AResult
...
class TestCapabilitiesModuleImports:
    ...
    def test_lazy_import_moderate(self):
        ...
        from shadowbot.capabilities import moderate
...
class TestCLICapabilitiesHandler:
    ...
    def test_handler_exists(self):
        ...
        from shadowbot.cli.features import CapabilitiesHandler
...
class TestNewCapabilities:
    ...
    def test_completion_result_dataclass(self):
        ...
        from shadowbot.capabilities.completions import CompletionResult
    ...
    def test_message_result_dataclass(self):
        ...
        from shadowbot.capabilities.messages import MessageResult
    ...
    def test_guardrail_result_dataclass(self):
        ...
        from shadowbot.capabilities.guardrails import GuardrailResult
    ...
    def test_rag_result_dataclass(self):
        ...
        from shadowbot.capabilities.rag import RAGResult
    ...
    def test_realtime_session_dataclass(self):
        ...
        from shadowbot.capabilities.realtime import RealtimeSession
    ...
    def test_mcp_result_dataclass(self):
        ...
        from shadowbot.capabilities.mcp import MCPResult
    ...
    def test_vector_store_file_result_dataclass(self):
        ...
        from shadowbot.capabilities.vector_store_files import VectorStoreFileResult
    ...
    def test_container_file_result_dataclass(self):
        ...
        from shadowbot.capabilities.container_files import ContainerFileResult
...
class TestEmbeddingAliases:
    ...
    def test_import_embed_from_shadowbot(self):
        """Test that embed can be imported from top-level shadowbot."""
        from shadowbot import embed
        assert callable(embed)
    
    def test_import_embedding_from_shadowbot(self):
        """Test that embedding can be imported from top-level shadowbot."""
        from shadowbot import embedding
    ...
    def test_embed_and_embedding_are_same_function(self):
        ...
        from shadowbot.capabilities import embed, embedding
    ...
    def test_aembed_and_aembedding_are_same_function(self):
        ...
        from shadowbot.capabilities import aembed, aembedding
        # They should be the same function
    ...
    def test_llm_embedding_shows_deprecation_warning(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            from shadowbot.llm import embedding
