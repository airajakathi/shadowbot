...
class TestExternalAgentsHandler:
    ...
    def test_import_external_agents_handler(self):
        ...
        from shadowbot.cli.features.external_agents import ExternalAgentsHandler
    ...
    def test_get_integration_claude(self):
        ...
        from shadowbot.cli.features.external_agents import ExternalAgentsHandler
        from shadowbot.integrations.claude_code import ClaudeCodeIntegration
    ...
    def test_get_integration_gemini(self):
        ...
        from shadowbot.cli.features.external_agents import ExternalAgentsHandler
        from shadowbot.integrations.gemini_cli import GeminiCLIIntegration
    ...
    def test_get_integration_codex(self):
        ...
        from shadowbot.cli.features.external_agents import ExternalAgentsHandler
        from shadowbot.integrations.codex_cli import CodexCLIIntegration
    ...
    def test_get_integration_cursor(self):
        ...
        from shadowbot.cli.features.external_agents import ExternalAgentsHandler
        from shadowbot.integrations.cursor_cli import CursorCLIIntegration
