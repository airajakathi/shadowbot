...
def test_managed_config_dataclass():
    ...
    assert config.env_name == "shadowbot-env"
...
def test_tool_mapping():
    ...
    from shadowbot.integrations.managed_agents import map_managed_tools
...
def test_managed_agent_factory_explicit_providers():
    ...
    from shadowbot.integrations.managed_agents import ManagedAgent, ManagedConfig
...
def test_anthropic_managed_agent_creation():
    ...
    from shadowbot.integrations.managed_agents import AnthropicManagedAgent, ManagedConfig
...
def test_backward_compatible_aliases():
    ...
    from shadowbot.integrations.managed_agents import ManagedAgentIntegration, ManagedBackendConfig, ManagedAgent, ManagedConfig
...
@patch('shadowbot.integrations.managed_agents.logger')
