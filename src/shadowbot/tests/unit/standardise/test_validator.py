...
from shadowbot.standardise.config import StandardiseConfig
from shadowbot.standardise.discovery import FeatureDiscovery
from shadowbot.standardise.validator import ArtifactValidator
...
class TestArtifactValidator:
    ...
    def test_validate_feature_all_present(self, tmp_path):
        ...
        sdk_docs = docs_root / "sdk" / "shadowbotagents" / "guardrails"
