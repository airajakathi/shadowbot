...
class TestRunItem:
    ...
    def test_create_run_item(self):
        ...
        from shadowbot.suite_runner import RunItem
...
class TestRunResult:
    ...
    def test_create_run_result(self):
        ...
        from shadowbot.suite_runner import RunResult
...
class TestRunReport:
    ...
    def test_create_run_report(self):
        ...
        from shadowbot.suite_runner import RunReport, RunResult
...
class TestFileDiscovery:
    ...
    def test_discover_python_files(self):
        ...
        from shadowbot.suite_runner import FileDiscovery
...
class TestScriptRunner:
    ...
    def test_run_passing_script(self):
        ...
        from shadowbot.suite_runner import ScriptRunner, RunItem
    ...
    def test_check_required_env(self):
        ...
        from shadowbot.suite_runner import ScriptRunner
...
class TestSuiteReporter:
    ...
    def test_generate_json(self):
        ...
        from shadowbot.suite_runner import SuiteReporter, RunReport, RunResult
    ...
    def test_save_logs(self):
        """Test saving logs."""
        from shadowbot.suite_runner import SuiteReporter, RunResult
...
<!-- shadowbot: skip=true timeout=120 -->
```python
print("hello")
```
""")
