...
from shadowbot.mcp_server.cli import MCPServerCLI
...
class TestMCPToolsCLI:
    ...
    @patch("shadowbot.mcp_server.cli.MCPServerCLI.cmd_tools_search")
    ...
    @patch("shadowbot.mcp_server.cli.MCPServerCLI.cmd_tools_info")
    ...
    @patch("shadowbot.mcp_server.cli.MCPServerCLI.cmd_tools_schema")
...
class TestToolsSearchCLI:
    ...
    @patch("shadowbot.mcp_server.adapters.register_all_tools")
