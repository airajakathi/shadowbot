...
class TestUIIntegration:
    ...
    def test_gradio_app_config(self):
        ...
        assert gradio_config["title"] == "ShadowBot Agent Chat"
        assert gradio_config["server_port"] == 7860
    
    def test_streamlit_app_config(self):
        """Test Streamlit app configuration."""
        streamlit_config = {
            "page_title": "ShadowBot Agents",
            "page_icon": "🤖",
            "layout": "wide",
            "initial_sidebar_state": "expanded",
            "menu_items": {
                'Get Help': 'https://docs.shadowbot.com',
                'Report a bug': 'https://github.com/MervinPraison/ShadowBot/issues',
                'About': "ShadowBot Agents Framework"
            }
        }
        
        assert streamlit_config["page_title"] == "ShadowBot Agents"
