...
try:
    from shadowbot.auto import AutoGenerator, WorkflowAutoGenerator, LITELLM_AVAILABLE
...
class TestAutoGeneratorLazyLoading:
    ...
    def test_client_is_created_on_first_access(self):
        ...
        with patch.dict(os.environ, {'OPENAI_API_KEY': 'test-key'}):
            ...
            with patch('shadowbot.auto.instructor') as mock_instructor:
...
class TestAutoGeneratorLiteLLMFallback:
    ...
    def test_uses_litellm_when_available(self):
        ...
        with patch.dict(os.environ, {'OPENAI_API_KEY': 'test-key'}):
            with patch('shadowbot.auto.LITELLM_AVAILABLE', True):
                with patch('shadowbot.auto.instructor') as mock_instructor:
    ...
    def test_falls_back_to_openai_when_litellm_unavailable(self):
        ...
        with patch.dict(os.environ, {'OPENAI_API_KEY': 'test-key'}):
            with patch('shadowbot.auto.LITELLM_AVAILABLE', False):
                with patch('shadowbot.auto.instructor') as mock_instructor:
                    with patch('shadowbot.auto.OpenAI') as mock_openai:
                        mock_instructor.patch.return_value = Mock()
...
class TestBaseAutoGenerator:
    ...
    def test_analyze_complexity_simple(self):
        ...
        from shadowbot.auto import BaseAutoGenerator
    ...
    def test_get_available_tools(self):
        ...
        from shadowbot.auto import BaseAutoGenerator, AVAILABLE_TOOLS
...
class TestSingleAgentOption:
    ...
    def test_single_agent_structure_exists(self):
        ...
        from shadowbot.auto import SingleAgentStructure
...
class TestLLMPatternRecommendation:
    ...
    def test_pattern_recommendation_pydantic_model_exists(self):
        ...
        from shadowbot.auto import PatternRecommendation
...
class TestValidationGates:
    ...
    def test_validation_gate_model_exists(self):
        ...
        from shadowbot.auto import ValidationGate
    ...
    def test_workflow_structure_supports_gates(self):
        ...
        from shadowbot.auto import WorkflowStructure
...
class TestAutoGeneratorPatternSupport:
    ...
    def test_auto_generator_has_recommend_pattern(self):
        ...
        with patch.dict(os.environ, {'OPENAI_API_KEY': 'test-key'}):
            generator = AutoGenerator(topic="Test", framework="shadowbot")
...
class TestWorkflowFrameworkSupport:
    ...
    def test_workflow_generator_default_framework_is_shadowbot(self):
        """Test that default framework is shadowbot."""
        with patch.dict(os.environ, {'OPENAI_API_KEY': 'test-key'}):
            generator = WorkflowAutoGenerator(topic="Test task")
            assert generator.framework == "shadowbot"
