...
from shadowbot.flow.components.ShadowBot.shadowbot_agent import ShadowBotAgentComponent
from shadowbot.flow.components.ShadowBot.shadowbot_task import ShadowBotTaskComponent
from shadowbot.flow.components.ShadowBot.shadowbot_agents import ShadowBotAgentsComponent

def test_shadowbot_agent_component():
    """Verify ShadowBotAgentComponent compiles the Agent correctly and returns a Message response."""
    agent_comp = ShadowBotAgentComponent()
...
def test_shadowbot_task_component():
    """Verify ShadowBotTaskComponent binds accurately to the instantiated agent."""
    agent_comp = ShadowBotAgentComponent()
    agent_comp.agent_name = "RealTestAgent"
    ...
    task_comp = ShadowBotTaskComponent()
...
def test_shadowbot_agents_component():
    """Verify ShadowBotAgentsComponent builds the AgentTeam successfully."""
    agent_comp = ShadowBotAgentComponent()
    ...
    agents_comp = ShadowBotAgentsComponent()
