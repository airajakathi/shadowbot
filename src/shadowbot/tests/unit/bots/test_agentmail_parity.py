...
class TestYamlParityAgentMail:
    ...
    def test_yaml_file_loads_agentmail_config(self):
        ...
        from shadowbot.bots._config_schema import load_and_validate_bot_yaml
...
class TestPythonCodeParity:
    ...
    def test_bot_wrapper_resolves_to_agentmail(self):
        ...
        from shadowbot.bots.agentmail import AgentMailBot
    ...
    def test_email_protocol_structural_match(self):
        ...
        from shadowbot.bots import AgentMailBot
        from shadowbotagents.bots import EmailProtocol
...
class TestAIUIChannelParity:
    ...
    def test_supported_platforms_includes_email(self):
        ...
        try:
            from shadowbotui.features.channels import SUPPORTED_PLATFORMS
            assert "email" in SUPPORTED_PLATFORMS
        except ImportError:
            pytest.skip("shadowbotui not installed")
    ...
    def test_create_bot_direct_has_agentmail_mapping(self):
        ...
        import inspect
        try:
            from shadowbotui.features.channels import ChannelsFeature
            src = inspect.getsource(ChannelsFeature._create_bot_direct)
            assert "shadowbot.bots.agentmail.AgentMailBot" in src
        except ImportError:
            pytest.skip("shadowbotui not installed")
    ...
    def test_create_bot_direct_has_email_mapping(self):
        ...
        try:
            from shadowbotui.features.channels import ChannelsFeature
            src = inspect.getsource(ChannelsFeature._create_bot_direct)
            assert "shadowbot.bots.email.EmailBot" in src
        except ImportError:
            pytest.skip("shadowbotui not installed")
