...
from shadowbotagents.bots import BotConfig, BotMessage, BotUser, BotChannel
from shadowbot.gateway.pairing import PairingStore, PairedChannel
from shadowbot.bots._auth import UnknownUserHandler
...
async def test_pairing_flow_not_paired():
    ...
    assert "shadowbot pairing approve telegram ABCD1234" in sent_message
