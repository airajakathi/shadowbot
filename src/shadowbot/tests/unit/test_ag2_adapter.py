"""
Unit tests for the AG2 framework integration in ShadowBot.
...
class TestAgentsGeneratorAG2Validation:
    ...
    def _make_generator(self, framework, ag2_available=True):
        ...
        with patch("shadowbot.agents_generator.AG2_AVAILABLE", ag2_available), \
    ...
    def test_autogen_framework_unaffected(self):
        ...
        with patch("shadowbot.agents_generator.AG2_AVAILABLE", False), \
             patch("shadowbot.agents_generator.AUTOGEN_AVAILABLE", True), \
             patch("shadowbot.agents_generator.CREWAI_AVAILABLE", False), \
             patch("shadowbot.agents_generator.PRAISONAI_AVAILABLE", True):
            from shadowbot.agents_generator import AgentsGenerator
            gen = AgentsGenerator(
...
class TestRunAG2LLMConfig:
    ...
    @patch("shadowbot.agents_generator.AG2_AVAILABLE", True)
