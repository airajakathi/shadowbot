...
from shadowbot.capabilities.skills import tool_from_skill
...
def test_tool_from_skill_no_instructions(monkeypatch):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        import shadowbotagents.skills as skills_mod
...
def test_tool_from_skill_import_fallback(monkeypatch):
    """If shadowbotagents.skills is unavailable, a safe dummy tool is returned."""
    import builtins

    real_import = builtins.__import__

    def _blocking_import(name, *args, **kwargs):
        if name == "shadowbotagents.skills":
