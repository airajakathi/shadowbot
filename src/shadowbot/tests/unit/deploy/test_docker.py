...
def test_generate_dockerfile_basic():
    ...
    from shadowbot.deploy.docker import generate_dockerfile
    ...
    assert "pip install" in dockerfile and "shadowbot" in dockerfile
...
def test_build_docker_image_success(mock_run):
    ...
    from shadowbot.deploy.docker import build_docker_image
    from shadowbot.deploy.models import DockerConfig
...
def test_run_docker_container_success(mock_run):
    ...
    from shadowbot.deploy.docker import run_docker_container
    from shadowbot.deploy.models import DockerConfig
...
def test_push_docker_image_success(mock_run):
    ...
    from shadowbot.deploy.docker import push_docker_image
    from shadowbot.deploy.models import DockerConfig
...
def test_stop_docker_container(mock_run):
    ...
    from shadowbot.deploy.docker import stop_docker_container
...
def test_check_docker_installed_success(mock_run):
    ...
    from shadowbot.deploy.docker import check_docker_installed
