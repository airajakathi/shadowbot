...
def test_deploy_command_cloud_aws(mock_deploy_class):
    ...
    args.service_name = "shadowbot-service"
    args.resource_group = ""
...
@patch('shadowbot.deploy.doctor.run_all_checks')
...
@patch('shadowbot.deploy.schema.validate_agents_yaml')
