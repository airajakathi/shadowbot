...
def test_base_provider_interface():
    ...
    from shadowbot.deploy.providers.base import BaseProvider
...
def test_aws_provider_doctor_success(mock_run):
    ...
    from shadowbot.deploy.providers.aws import AWSProvider
    from shadowbot.deploy.models import CloudConfig, CloudProvider
...
def test_azure_provider_doctor_success(mock_run):
    ...
    from shadowbot.deploy.providers.azure import AzureProvider
    from shadowbot.deploy.models import CloudConfig, CloudProvider
...
def test_gcp_provider_doctor_success(mock_run):
    ...
    from shadowbot.deploy.providers.gcp import GCPProvider
    from shadowbot.deploy.models import CloudConfig, CloudProvider
...
def test_get_provider_aws():
    ...
    from shadowbot.deploy.providers import get_provider
    from shadowbot.deploy.providers.aws import AWSProvider
    from shadowbot.deploy.models import CloudConfig, CloudProvider
