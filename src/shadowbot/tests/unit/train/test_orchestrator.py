...
class TestAgentTrainer:
    ...
    def test_create_trainer_with_agent(self):
        ...
        from shadowbot.train.agents.orchestrator import AgentTrainer
    ...
    @patch("shadowbot.train.agents.orchestrator.TrainingGrader")
    def test_run_llm_mode_single_iteration(self, mock_grader_class):
        """Test running single iteration in LLM mode."""
        from shadowbot.train.agents.orchestrator import AgentTrainer
        from shadowbot.train.agents.models import TrainingScenario
        from shadowbot.train.agents.grader import GradeResult
