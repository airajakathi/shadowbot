...
class TestTaskState:
    ...
    def test_task_states(self):
        ...
        from shadowbot.mcp_server.tasks import TaskState
...
class TestTaskProgress:
    ...
    def test_progress_basic(self):
        ...
        from shadowbot.mcp_server.tasks import TaskProgress
...
class TestTask:
    ...
    def test_task_creation(self):
        """Test task creation."""
        from shadowbot.mcp_server.tasks import Task, TaskState
...
class TestTaskStore:
    ...
    def test_create_task(self):
        """Test task creation."""
        from shadowbot.mcp_server.tasks import TaskStore, TaskState
    ...
    def test_get_task(self):
        """Test getting a task."""
        from shadowbot.mcp_server.tasks import TaskStore
    ...
    def test_update_task(self):
        ...
        from shadowbot.mcp_server.tasks import TaskStore, TaskState, TaskProgress
...
class TestTaskManager:
    ...
    def test_create_task(self):
        ...
        from shadowbot.mcp_server.tasks import TaskManager
    ...
    def test_cancel_task(self):
        ...
        from shadowbot.mcp_server.tasks import TaskManager, TaskState
...
class TestGlobalTaskManager:
    ...
    def test_get_task_manager(self):
        ...
        from shadowbot.mcp_server.tasks import get_task_manager, TaskManager
    ...
    def test_set_task_manager(self):
        ...
        from shadowbot.mcp_server.tasks import get_task_manager, set_task_manager, TaskManager
