...
class TestRecipeMCPConfig:
    ...
    def test_default_config(self):
        ...
        from shadowbot.mcp_server.recipe_adapter import RecipeMCPConfig
...
class TestRecipeMCPAdapter:
    ...
    def test_init(self):
        ...
        from shadowbot.mcp_server.recipe_adapter import RecipeMCPAdapter
    ...
    def test_init_with_config(self):
        ...
        from shadowbot.mcp_server.recipe_adapter import RecipeMCPAdapter, RecipeMCPConfig
    ...
    def test_get_registries(self):
        ...
        from shadowbot.mcp_server.recipe_adapter import RecipeMCPAdapter
        from shadowbot.mcp_server.registry import MCPToolRegistry, MCPResourceRegistry, MCPPromptRegistry
...
class TestRecipeToolWrapper:
    ...
    def test_tool_wrapper(self):
        ...
        from shadowbot.mcp_server.recipe_adapter import RecipeToolWrapper
...
class TestCreateRecipeMCPServer:
    ...
    @patch('shadowbot.mcp_server.recipe_adapter.RecipeMCPAdapter')
    def test_create_server(self, mock_adapter_class):
        """Test creating MCP server from recipe."""
        from shadowbot.mcp_server.recipe_adapter import create_recipe_mcp_server
