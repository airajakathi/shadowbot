...
from shadowbot.daemon import _detect_platform, install_daemon, uninstall_daemon, get_daemon_status
...
@patch('shadowbot.daemon._detect_platform', return_value='systemd')
@patch('shadowbot.daemon.systemd.install')
...
@patch('shadowbot.daemon._detect_platform', return_value='launchd')
@patch('shadowbot.daemon.launchd.install')
...
@patch('shadowbot.daemon._detect_platform', return_value='windows')
@patch('shadowbot.daemon.windows.install')
...
@patch('shadowbot.daemon._detect_platform', return_value='unknown')
...
@patch('shadowbot.daemon._detect_platform', return_value='systemd')
@patch('shadowbot.daemon.systemd.get_status')
...
@patch('shadowbot.daemon.windows.subprocess.run')
def test_windows_scheduled_task_command_is_well_formed(mock_run):
    ...
    from shadowbot.daemon.windows import _create_scheduled_task
