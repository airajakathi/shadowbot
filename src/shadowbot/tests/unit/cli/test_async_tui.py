"""
Tests for ShadowBot Async TUI Application.
"""
...
class TestAsyncTUIConfig:
    ...
    def test_default_values(self):
        ...
        from shadowbot.cli.interactive.async_tui import AsyncTUIConfig
...
class TestChatMessage:
    ...
    def test_message_creation(self):
        ...
        from shadowbot.cli.interactive.async_tui import ChatMessage
...
class TestGetLogo:
    ...
    def test_logo_wide_terminal(self):
        ...
        from shadowbot.cli.branding import get_logo, LOGO_LARGE
    ...
    def test_logo_medium_terminal(self):
        ...
        from shadowbot.cli.branding import get_logo, LOGO_MEDIUM
    ...
    def test_logo_narrow_terminal(self):
        ...
        from shadowbot.cli.branding import get_logo, LOGO_SMALL
        
        logo = get_logo(30)
        assert logo == LOGO_SMALL
    
    def test_logo_contains_praison_ai(self):
        """Test that logo contains 'ShadowBot' branding."""
        from shadowbot.cli.branding import LOGO_SMALL
        
        assert "ShadowBot" in LOGO_SMALL
...
class TestAsyncTUI:
    ...
    def test_init_default(self):
        ...
        from shadowbot.cli.interactive.async_tui import AsyncTUI
    ...
    def test_format_output_with_messages(self):
        ...
        from shadowbot.cli.interactive.async_tui import AsyncTUI, ChatMessage
...
class TestStartAsyncTUI:
    ...
    def test_function_exists(self):
        ...
        from shadowbot.cli.interactive.async_tui import start_async_tui
...
class TestASCIILogos:
    ...
    def test_logo_exists(self):
        ...
        from shadowbot.cli.branding import LOGO_LARGE
    ...
    def test_logo_minimal_branding(self):
        ...
        from shadowbot.cli.branding import LOGO_MINIMAL
        assert "ShadowBot" in LOGO_MINIMAL
...
class TestLogoDisplay:
    ...
    def test_logo_always_shows_when_enabled(self):
        ...
        from shadowbot.cli.interactive.async_tui import AsyncTUI, AsyncTUIConfig, ChatMessage
