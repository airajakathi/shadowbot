...
6. Commands respect configuration from ~/.shadowbot/langfuse.env
"""
...
from shadowbot.cli.commands.langfuse import app
...
class TestLangfuseAPIClient:
    ...
    @patch("shadowbot.cli.langfuse_client.requests.get")
    def test_fetch_traces_success(self, mock_get, sample_traces):
        ...
        from shadowbot.cli.langfuse_client import LangfuseClient
    ...
    def test_api_error_handling(self, mock_get):
        ...
        from shadowbot.cli.langfuse_client import LangfuseClient, LangfuseAPIError
    ...
    def test_load_config_from_file(self, tmp_path, mock_langfuse_env):
        """Test loading configuration from shadowbot langfuse.env file."""
        from shadowbot.cli.langfuse_client import LangfuseClient
        
        # Copy the mock config file to the tmp_path location
        import shutil
        config_dir = tmp_path / ".shadowbot"
...
class TestTracesCommand:
    """Tests for 'shadowbot langfuse traces' command."""
    
    @patch("shadowbot.cli.langfuse_client.LangfuseClient")
...
class TestSessionsCommand:
    """Tests for 'shadowbot langfuse sessions' command."""
...
class TestShowCommand:
    """Tests for 'shadowbot langfuse show' command."""
...
# -----------------------------------------------------------------------------
# Integration with shadowbotagents.obs
# -----------------------------------------------------------------------------

class TestObservabilityConfigLoading:
    """Tests for auto-loading shadowbot config in Agent observability."""
    
    def test_auto_load_from_shadowbot_config(self, tmp_path, mock_langfuse_env):
        """Test that obs.auto() loads from shadowbot config file."""
        from shadowbotagents.obs import _LazyObsModule
        
        # Create module instance
        obs_module = _LazyObsModule()
        
        # Mock the config file location and shadowbot-tools import
        with patch("pathlib.Path.home", return_value=tmp_path):
            with patch.dict("os.environ", {}, clear=True):  # Clear env vars
                ...
                with patch.dict("os.environ", {
                    ...
                    # Mock the provider import to avoid needing shadowbot-tools
    ...
    def test_provider_factory_with_config(self, mock_import, mock_langfuse_env):
        ...
        # Mock the shadowbot-tools module
