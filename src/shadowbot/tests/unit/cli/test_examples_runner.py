...
class TestExampleMetadata:
    ...
    def test_parse_skip_directive(self, tmp_path):
        """Test parsing # shadowbot: skip=true directive."""
        from shadowbot.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_skip.py"
        example.write_text("# shadowbot: skip=true\nprint('hello')")
    ...
    def test_parse_timeout_directive(self, tmp_path):
        """Test parsing # shadowbot: timeout=120 directive."""
        from shadowbot.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_timeout.py"
        example.write_text("# shadowbot: timeout=120\nprint('hello')")
        
        meta = ExampleMetadata.from_file(example)
        assert meta.timeout == 120
    
    def test_parse_require_env_directive(self, tmp_path):
        """Test parsing # shadowbot: require_env=KEY1,KEY2 directive."""
        from shadowbot.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_env.py"
        example.write_text("# shadowbot: require_env=OPENAI_API_KEY,ANTHROPIC_API_KEY\nprint('hello')")
        
        meta = ExampleMetadata.from_file(example)
        assert meta.require_env == ["OPENAI_API_KEY", "ANTHROPIC_API_KEY"]
    
    def test_parse_xfail_directive(self, tmp_path):
        """Test parsing # shadowbot: xfail=reason directive."""
        from shadowbot.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_xfail.py"
        example.write_text("# shadowbot: xfail=known_flaky\nprint('hello')")
    ...
    def test_parse_multiple_directives(self, tmp_path):
        ...
        example.write_text(
            "#!/usr/bin/env python3\n"
            "# shadowbot: timeout=300\n"
            "# shadowbot: require_env=OPENAI_API_KEY\n"
            "# shadowbot: xfail=slow_network\n"
            "print('hello')"
        )
...
class TestExampleDiscovery:
    ...
    def test_discover_python_files(self, tmp_path):
        ...
        from shadowbot.cli.features.examples import ExampleDiscovery
...
class TestExampleRunner:
    ...
    def test_run_passing_example(self, tmp_path):
        ...
        from shadowbot.cli.features.examples import ExampleRunner, ExampleResult
    ...
    def test_run_failing_example(self, tmp_path):
        ...
        from shadowbot.cli.features.examples import ExampleRunner
    ...
    def test_skip_missing_env(self, tmp_path):
        ...
        from shadowbot.cli.features.examples import ExampleRunner, ExampleMetadata
        
        example = tmp_path / "needs_key.py"
        example.write_text("# shadowbot: require_env=NONEXISTENT_KEY_12345\nprint('hello')")
    ...
    def test_xfail_expected_failure(self, tmp_path):
        ...
        example.write_text("# shadowbot: xfail=expected\nraise Exception('expected')")
...
class TestReportGenerator:
    ...
    def test_generate_json_report(self, tmp_path):
        ...
        from shadowbot.cli.features.examples import ReportGenerator, ExampleResult, RunReport
...
class TestCLIIntegration:
    ...
    def test_examples_find_command(self, tmp_path):
        """Test 'shadowbot examples find' command returns relevant matches."""
        ...
        from shadowbot.cli.commands.examples import app
    ...
    def test_examples_find_command_no_matches(self, tmp_path):
        """Test 'shadowbot examples find' with no matches exits cleanly."""
        from typer.testing import CliRunner
    ...
    def test_examples_find_command_invalid_limit(self, tmp_path):
        """Test 'shadowbot examples find' validates --limit is >= 1."""
        import re
        from typer.testing import CliRunner
    ...
    def test_examples_list_command(self, tmp_path):
        """Test 'shadowbot examples list' command."""
        from typer.testing import CliRunner
    ...
    def test_examples_run_command_passing(self, tmp_path):
        """Test 'shadowbot examples run' with passing examples."""
        from typer.testing import CliRunner
    ...
    def test_examples_run_command_failing(self, tmp_path):
        """Test 'shadowbot examples run' with failing examples."""
        from typer.testing import CliRunner
