...
class TestApprovalRequest:
    ...
    def test_approval_request_creation(self):
        ...
        from shadowbot.cli.interactive.events import ApprovalRequest
...
class TestApprovalResponse:
    ...
    def test_approval_response_once(self):
        ...
        from shadowbot.cli.interactive.events import ApprovalResponse, ApprovalDecision
...
class TestApprovalDecision:
    ...
    def test_all_decisions_exist(self):
        ...
        from shadowbot.cli.interactive.events import ApprovalDecision
