...
TDD tests for shadowbot port command:
...
class TestPortCommand:
    ...
    def test_port_command_imports(self):
        ...
        from shadowbot.cli.commands.port import app
...
class TestPortUtils:
    ...
    def test_get_process_using_port_linux_darwin(self):
        ...
        import sys
        from shadowbot.cli.commands.port import _get_process_using_port
    ...
    def test_kill_process_by_pid_success(self):
        ...
        from shadowbot.cli.commands.port import _kill_process
...
class TestPortConflictDetection:
    ...
    def test_is_port_conflict_error_redis(self):
        ...
        from shadowbot.cli.commands.port import _is_port_conflict_error, _extract_port_from_error
    ...
    def test_is_port_conflict_error_generic(self):
        ...
        from shadowbot.cli.commands.port import _is_port_conflict_error
    ...
    def test_show_port_conflict_help(self):
        ...
        from shadowbot.cli.commands.port import _show_port_conflict_help
...
class TestPortIntegration:
    ...
    def test_port_list_shows_table(self):
        ...
        from shadowbot.cli.commands.port import _get_all_ports
    ...
    def test_port_kill_with_confirmation(self):
        ...
        from shadowbot.cli.commands.port import port_kill
        from rich.console import Console
        import typer

        console = Console()

        with patch('shadowbot.cli.commands.port._get_process_using_port') as mock_get:
