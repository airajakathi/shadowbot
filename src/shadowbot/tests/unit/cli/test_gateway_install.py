...
from shadowbot.cli.commands.gateway import app


@patch("shadowbot.daemon.install_daemon")
...
@patch("shadowbot.daemon.uninstall_daemon")
...
@patch("shadowbot.daemon.systemd.get_logs")
...
@patch("shadowbot.daemon.launchd.get_logs")
...
@patch("shadowbot.daemon.windows.get_logs")
...
@patch("shadowbot.daemon.get_daemon_status")
@patch("shadowbot.cli.features.gateway.GatewayHandler")
