...
class TestBackendSelection:
    ...
    def test_select_backend_returns_plain_for_non_tty(self):
        ...
        from shadowbot.cli.ui import select_backend, UIConfig
...
class TestUIConfig:
    ...
    def test_ui_config_defaults(self):
        ...
        from shadowbot.cli.ui import UIConfig
...
class TestBackendProtocol:
    ...
    def test_plain_backend_has_required_methods(self):
        ...
        from shadowbot.cli.ui.plain import PlainBackend
    ...
    def test_plain_backend_emit_writes_to_stdout(self, capsys):
        ...
        from shadowbot.cli.ui.plain import PlainBackend
        from shadowbot.cli.ui.events import UIEventType
