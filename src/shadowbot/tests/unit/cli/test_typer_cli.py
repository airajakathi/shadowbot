...
def reset_global_state():
    ...
    from shadowbot.cli.app import state, GlobalState
...
class TestTyperApp:
    ...
    def test_app_import(self):
        ...
        from shadowbot.cli.app import app
    ...
    def test_help_output(self):
        ...
        assert "ShadowBot" in result.output
    ...
    def test_version_flag(self):
        ...
        assert result.exit_code == 0
        assert "ShadowBot version" in result.output
...
class TestConfigCommand:
    ...
    def test_config_list(self):
        ...
        from shadowbot.cli.commands.config import app
...
class TestTracesCommand:
    ...
    def test_traces_status(self):
        ...
        from shadowbot.cli.commands.traces import app
...
class TestEnvCommand:
    ...
    def test_env_view(self):
        ...
        from shadowbot.cli.commands.environment import app
...
class TestSessionCommand:
    ...
    def test_session_list(self):
        ...
        from shadowbot.cli.commands.session import app
        result = runner.invoke(app, ["list"])
        assert result.exit_code == 0
...
class TestCompletionCommand:
    ...
    def test_completion_bash(self):
        ...
        from shadowbot.cli.commands.completion import app
    ...
    def test_completion_zsh(self):
        ...
        assert result.exit_code == 0
        assert "shadowbot" in result.output
        assert "compdef" in result.output or "_shadowbot" in result.output
...
class TestVersionCommand:
    ...
    def test_version_show(self):
        ...
        from shadowbot.cli.commands.version import app
        result = runner.invoke(app, ["show"])
        assert result.exit_code == 0
        assert "ShadowBot" in result.output or "shadowbot" in result.output.lower()
...
class TestMCPCommand:
    ...
    def test_mcp_list(self):
        ...
        from shadowbot.cli.commands.mcp import app
        result = runner.invoke(app, ["list"])
        assert result.exit_code == 0
...
class TestOutputController:
    ...
    def test_output_modes(self):
        ...
        from shadowbot.cli.output.console import OutputMode
    ...
    def test_output_controller_creation(self):
        ...
        from shadowbot.cli.output.console import OutputController, OutputMode
    ...
    def test_stream_event(self):
        ...
        from shadowbot.cli.output.console import StreamEvent
...
class TestConfigurationSystem:
    ...
    def test_config_schema(self):
        ...
        from shadowbot.cli.configuration.schema import ConfigSchema, DEFAULT_CONFIG
    ...
    def test_config_to_dict(self):
        ...
        from shadowbot.cli.configuration.schema import ConfigSchema
    ...
    def test_config_paths(self):
        """Test config paths."""
        from shadowbot.cli.configuration.paths import (
...
class TestStateManagement:
    ...
    def test_run_id_generation(self):
        ...
        from shadowbot.cli.state.identifiers import generate_run_id
    ...
    def test_trace_id_generation(self):
        ...
        from shadowbot.cli.state.identifiers import generate_trace_id
    ...
    def test_agent_id_generation(self):
        ...
        from shadowbot.cli.state.identifiers import generate_agent_id
    ...
    def test_run_context(self):
        ...
        from shadowbot.cli.state.identifiers import RunContext
...
class TestSessionManager:
    ...
    def test_session_metadata(self):
        ...
        from shadowbot.cli.state.sessions import SessionMetadata
