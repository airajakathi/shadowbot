...
from shadowbotagents.gateway.config import DeliveryConfig, PresenceConfig
from shadowbotagents.gateway.protocols import EventType, GatewayEvent
...
class TestChannelManager:
    ...
    def mgr(self, gateway):
        from shadowbot.gateway.push_channels import ChannelManager
...
class TestPresenceManager:
    ...
    @pytest.fixture
    def mgr(self, gateway):
        from shadowbot.gateway.push_presence import PresenceManager
...
class TestDeliveryGuaranteeManager:
    ...
    @pytest.fixture
    def mgr(self, gateway):
        from shadowbot.gateway.push_delivery import DeliveryGuaranteeManager
