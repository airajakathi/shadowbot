...
from shadowbot.gateway.auth import assert_external_bind_safe, GatewayStartupError
...
class TestGatewayAuthEnforcement:
    ...
    def test_external_without_token_blocks_start(self):
        ...
        assert "shadowbot onboard" in str(exc_info.value)
...
class TestAuthTokenFingerprinting:
    ...
    def test_token_fingerprint(self):
        ...
        from shadowbot.gateway.auth import get_auth_token_fingerprint
