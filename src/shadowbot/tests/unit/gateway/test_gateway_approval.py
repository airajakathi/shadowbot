...
import asyncio
import time
from shadowbot.gateway.rate_limiter import AuthRateLimiter
from shadowbot.gateway.pairing import PairingStore
from shadowbot.gateway.exec_approval import ExecApprovalManager, Resolution
from shadowbot.gateway.gateway_approval import GatewayApprovalBackend
from shadowbotagents.approval import ApprovalRequest
...
async def test_cli_approve_e2e():
    ...
    from shadowbot.cli.commands.pairing import app as pairing_app
