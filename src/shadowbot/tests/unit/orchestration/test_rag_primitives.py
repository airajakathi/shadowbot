...
class TestContextPack:
    ...
    def test_context_pack_from_dict(self):
        ...
        from shadowbotagents.rag.models import ContextPack
...
class TestKnowledgeAddAlias:
    ...
    def test_add_command_exists(self):
        ...
        from shadowbot.cli.commands.knowledge import app
    ...
    def test_add_delegates_to_index(self):
        ...
        from shadowbot.cli.commands.knowledge import knowledge_add, knowledge_index
