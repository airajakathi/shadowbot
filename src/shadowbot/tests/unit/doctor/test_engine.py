...
from shadowbot.cli.features.doctor.registry import CheckRegistry, register_check
from shadowbot.cli.features.doctor.engine import DoctorEngine, run_doctor
