...
from shadowbot.agents_generator import _resolve_yaml_cli_backend
...
"""
    ...
    with patch('shadowbot.cli_backends.resolve_cli_backend') as mock_resolve:
...
def test_yaml_cli_backend_import_error():
    ...
    logger = MagicMock()
    with patch(
        'shadowbot.cli_backends.resolve_cli_backend',
