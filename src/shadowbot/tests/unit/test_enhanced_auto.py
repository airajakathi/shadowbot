...
# Add the shadowbot package to the path
...
class TestToolDiscovery:
    ...
    def test_get_all_available_tools_returns_dict(self):
        ...
        from shadowbot.auto import get_all_available_tools
    ...
    def test_get_tools_for_task_returns_list(self):
        ...
        from shadowbot.auto import get_tools_for_task
...
class TestEnhancedAutoGenerator:
    ...
    def test_enhanced_generator_has_tool_discovery(self):
        ...
        generator = AutoGenerator(topic="Test task", framework="shadowbot")
    ...
    def test_recommend_agent_count(self):
        ...
        from shadowbot.auto import recommend_agent_count
...
class TestToolCategoryMapping:
    ...
    def test_tool_categories_defined(self):
        ...
        from shadowbot.auto import TOOL_CATEGORIES
    ...
    def test_task_keywords_mapping(self):
        ...
        from shadowbot.auto import TASK_KEYWORD_TO_TOOLS
...
class TestIntegrationWithAgentsTools:
    """Tests for integration with shadowbotagents.tools."""
    
    def test_can_import_shadowbotagents_tools(self):
        """Test that we can import tools from shadowbotagents."""
        try:
            from shadowbotagents.tools import TOOL_MAPPINGS
            assert isinstance(TOOL_MAPPINGS, dict)
            assert len(TOOL_MAPPINGS) > 0
        except ImportError:
            pytest.skip("shadowbotagents not installed")
