"""
Example of AG2 tool registration for use with ShadowBot's --framework ag2.
...
Usage with ShadowBot:
    pip install "shadowbot[ag2]"
    shadowbot --framework ag2 agents.yaml
