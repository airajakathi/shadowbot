...
class TestAgentInvokeAPI:
    ...
    def test_import_agent_invoke(self):
        ...
        try:
            from shadowbot.api.agent_invoke import (
                register_agent, 
                get_agent, 
                unregister_agent,
    ...
    async def test_invoke_agent_standalone_not_found(self):
        ...
        from shadowbot.api.agent_invoke import invoke_agent_standalone
...
class TestAgentInvokeFastAPI:
    ...
    def client(self):
        ...
        try:
            ...
            from shadowbot.api.agent_invoke import router
    ...
    def test_list_agents_endpoint(self, client):
        ...
        from shadowbot.api.agent_invoke import register_agent, unregister_agent
    ...
    def test_unregister_agent_endpoint(self, client):
        ...
        from shadowbot.api.agent_invoke import register_agent
