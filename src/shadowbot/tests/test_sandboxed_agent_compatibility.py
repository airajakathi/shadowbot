...
def test_backward_compatibility_imports():
    ...
    try:
        ...
        from shadowbot import LocalManagedAgent as TopLevelLocal, LocalManagedConfig as TopLevelLocalConfig
    ...
    try:
        from shadowbot.integrations.sandboxed_agent import SandboxedAgent, SandboxedAgentConfig
        from shadowbot import SandboxedAgent as TopLevelSandboxed, SandboxedAgentConfig as TopLevelSandboxedConfig
...
def test_top_level_imports():
    ...
    from shadowbot import LocalManagedAgent, LocalManagedConfig, SandboxedAgent, SandboxedAgentConfig
...
def test_instantiation_compatibility():
    ...
    from shadowbot import LocalManagedAgent, SandboxedAgent, LocalManagedConfig, SandboxedAgentConfig
...
def test_method_interface_identical():
    ...
    from shadowbot import LocalManagedAgent, SandboxedAgent
