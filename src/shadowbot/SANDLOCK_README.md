...
```python
import asyncio
from shadowbot.sandbox import SandlockSandbox
...
```python
from shadowbotagents.sandbox import SandboxConfig
from shadowbot.sandbox import SandlockSandbox
...
```python
from shadowbot.sandbox import SubprocessSandbox, SandlockSandbox
...
SandlockSandbox follows ShadowBot's protocol-driven design:

- **Core SDK** (`shadowbotagents`): Contains only `SandboxProtocol`
- **Wrapper** (`shadowbot`): Contains `SandlockSandbox` implementation
...
- Implementation: `src/shadowbot/shadowbot/sandbox/sandlock.py`
- Tests: `src/shadowbot/tests/unit/sandbox/test_sandlock_sandbox.py`  
- Protocol: `src/shadowbot-agents/shadowbotagents/sandbox/protocols.py`
