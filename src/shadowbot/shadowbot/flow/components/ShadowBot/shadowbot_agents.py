"""ShadowBot Agents (Multi-Agent) Component for Langflow.

Creates and executes a ShadowBot Agents orchestrator for multi-agent workflows
...
class ShadowBotAgentsComponent(Component):
    """ShadowBot Agents component for multi-agent orchestration in Langflow.

    Orchestrates multiple ShadowBot agents with sequential, hierarchical,
    or workflow process types.
    """

    display_name: str = "Agent Team"
    description: str = "Orchestrate multiple ShadowBot agents for complex workflows."
    documentation: str = "https://docs.praison.ai"
    icon: str = "bot"
    name: str = "ShadowBotAgents"
    ...
    inputs = [
        ...
        HandleInput(
            name="agents",
            display_name="Agents",
            info="List of ShadowBot agents to orchestrate.",
            input_types=["Agent"],
            is_list=True,
        ),
        # ============================================================
    ...
    def build_agents(self) -> Any:
        """Build and return the ShadowBot Agents instance."""
        ...
        if observe == "langfuse":
            try:
                ...
                metadata = {
                    ...
                    "langflow_component": "ShadowBotAgents",
