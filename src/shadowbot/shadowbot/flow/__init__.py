...
This module provides Langflow integration with ShadowBot custom components
pre-loaded. Install with: pip install shadowbot[flow]
"""
...
# The ShadowBot/ subdirectory name becomes the sidebar category
...
def start_flow(
    *,
    ...
    """Start Langflow with ShadowBot components pre-loaded.
    ...
    env = os.environ.copy()
    # Inject ShadowBot components path
