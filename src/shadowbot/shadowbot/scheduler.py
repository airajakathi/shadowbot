"""
DEPRECATED: This module is deprecated. Use shadowbot.scheduler instead.

This file is kept for backward compatibility only.
All new code should import from shadowbot.scheduler.
"""
...
warnings.warn(
    "shadowbot.scheduler module (root level) is deprecated. "
    "Use 'from shadowbot.scheduler import ...' instead.",
    DeprecationWarning,
    stacklevel=2
)
