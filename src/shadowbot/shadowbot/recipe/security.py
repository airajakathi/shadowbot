...
def generate_sbom(
    ...
    # Add shadowbot as component
    try:
        import shadowbot
        shadowbot_version = getattr(shadowbot, "__version__", "unknown")
    except ImportError:
    ...
    components.append({
        "type": "library",
        "name": "shadowbot",
        "version": shadowbot_version,
        "purl": f"pkg:pypi/shadowbot@{shadowbot_version}",
    })
...
def _generate_cyclonedx(
    ...
    return {
        ...
        "metadata": {
            ...
            "tools": [{"name": "shadowbot-sbom", "version": "1.0.0"}],
            "component": {
                "type": "application",
                "name": name,
                "version": version,
...
def _generate_spdx(
    ...
    return {
        ...
        "creationInfo": {
            ...
            "creators": ["Tool: shadowbot-sbom-1.0.0"],
        },
        "packages": [
            {
