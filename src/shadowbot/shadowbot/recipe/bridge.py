...
keeping all glue code in the wrapper (shadowbot) without modifying core SDK.
"""
...
def resolve(
    ...
    try:
        ...
        try:
            from shadowbot.recipe.core import list_recipes
...
def execute_resolved_recipe(
    ...
    """
    from shadowbot.recipe.core import run
...
def execute_resolved_recipe_stream(
    ...
    """
    from shadowbot.recipe.core import run_stream
