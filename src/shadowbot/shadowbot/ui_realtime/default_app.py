"""ShadowBot Realtime UI — Voice realtime interface.

Loaded by ``shadowbot ui realtime`` → ``aiui run app.py``.
...
from shadowbotui.features.realtime import OpenAIRealtimeManager
...
aiui.set_branding(title="ShadowBot Realtime Voice", logo="🎤")
...
async def on_welcome():
    ...
    await aiui.say("""🎤 **ShadowBot Realtime Voice Interface**

Welcome to ShadowBot's voice-powered realtime chat! Use the microphone button to start voice conversations with AI agents.
