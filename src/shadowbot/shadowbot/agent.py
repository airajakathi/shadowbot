...
This module provides a wrapper around shadowbotagents.Agent that handles
CLI backend string resolution in the wrapper layer, maintaining proper
dependency direction per AGENTS.md.
"""

from typing import Union, Optional, Any
from shadowbotagents import Agent as CoreAgent
...
# Export the wrapper Agent as the default for import from shadowbot
__all__ = ["Agent"]