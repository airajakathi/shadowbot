...
def skill_load(
    ...
    **kwargs
    ...
    """
    try:
        from shadowbotagents.skills import load_skill
...
def tool_from_skill(path: str):
    ...
    try:
        from shadowbotagents.skills import load_skill, render_skill_body
        ...
        def _dummy_tool(arguments: str = "") -> str:
            return "Skills not available (shadowbotagents not installed)"
        return _dummy_tool
