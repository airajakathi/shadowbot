...
_INSTALL_HINTS = {
    "crewai": "pip install 'shadowbot[crewai]'   # or: pip install crewai",
    "autogen": "pip install 'shadowbot[autogen]'  # or: pip install pyautogen",
    "shadowbot": "pip install shadowbotagents",
}
