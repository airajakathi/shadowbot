"""
Framework Adapter Registry for ShadowBot.
...
def _shadowbot_loader():
    from .shadowbot_adapter import ShadowBotAdapter
...
class FrameworkAdapterRegistry(PluginRegistry[FrameworkAdapter]):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(
            entry_point_group="shadowbot.framework_adapters",
