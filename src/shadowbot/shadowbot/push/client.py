"""
Push Client for ShadowBot Agents.
...
from shadowbotagents.gateway.protocols import PresenceInfo
from shadowbotagents.push.models import ChannelMessage
from shadowbotagents.push.protocols import PushTransportProtocol
...
class PushClient:
    """Client SDK for receiving push notifications from a ShadowBot gateway.
