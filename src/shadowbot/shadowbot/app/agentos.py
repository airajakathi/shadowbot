...
from shadowbotagents import AgentOSConfig, AgentOSProtocol
...
class AgentOS:
    ...
    Example:
        ...
        from shadowbotagents import Agent, AgentTeam, AgentFlow
    ...
    def _create_app(self) -> Any:
        ...
        app = FastAPI(
            title=self.name,
            description="ShadowBot Agent Application",
            version="1.0.0",
