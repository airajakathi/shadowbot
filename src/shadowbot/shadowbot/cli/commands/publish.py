"""
Publish command group for ShadowBot CLI.
...
def publish_main(ctx: typer.Context):
    ...
    Examples:
        ...
        shadowbot publish pypi --minor
        shadowbot publish pypi --dry-run
    """
    if ctx.invoked_subcommand is None:
        rprint("[yellow]Usage: shadowbot publish pypi [OPTIONS][/yellow]")
        rprint("Run [bold]shadowbot publish pypi --help[/bold] for options.")
        raise typer.Exit(0)
...
def publish_pypi(
    ...
    Examples:
        shadowbot publish pypi                  # bump patch: 1.5.21 -> 1.5.22
        shadowbot publish pypi --minor          # bump minor: 1.5.21 -> 1.6.0
        shadowbot publish pypi --major          # bump major: 1.5.21 -> 2.0.0
        shadowbot publish pypi --no-bump        # publish without version change
        shadowbot publish pypi --dry-run        # preview without executing
        shadowbot publish pypi --token-var UV_PUBLISH_TOKEN
    """
