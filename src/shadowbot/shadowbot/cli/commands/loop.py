...
def loop_main(
    ...
    Examples:
        ...
        shadowbot loop "Build a REST API" -n 5
        
        shadowbot loop "Refactor auth module" -p DONE
        
        shadowbot loop "Implement feature X" -p COMPLETE -c
    """
...
def _run_loop(
    ...
    try:
        ...
        typer.echo("Error: shadowbotagents not installed. Run: pip install shadowbotagents", err=True)
        raise typer.Exit(1)
...
USAGE:
  shadowbot loop "Your task here" [OPTIONS]
...
EXAMPLES:
  # Basic loop
  shadowbot loop "Build a calculator" -n 5

  # With completion promise
  shadowbot loop "Refactor the auth module" -p DONE -v

  # With context clearing (forces file-based state)
  shadowbot loop "Implement feature X" -p COMPLETE -c -n 20

  # With timeout
  shadowbot loop "Debug the issue" -t 300 -v
""")
