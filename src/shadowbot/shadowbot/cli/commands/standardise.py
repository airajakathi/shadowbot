...
Commands:
- shadowbot standardise check      - Check for standardisation issues
- shadowbot standardise report     - Generate detailed report
- shadowbot standardise fix        - Fix issues (with --apply)
- shadowbot standardise init       - Initialise a new feature
- shadowbot standardise ai         - AI-powered generation
- shadowbot standardise checkpoint - Create undo checkpoint
- shadowbot standardise undo       - Undo to previous checkpoint
- shadowbot standardise redo       - Redo after undo
"""
...
def _lazy_import_engine():
    ...
    from shadowbot.standardise import StandardiseEngine, StandardiseConfig
...
def _run_ai(parsed) -> int:
    ...
    import asyncio
    from shadowbot.standardise.ai_generator import AIGenerator
    from shadowbot.standardise.models import ArtifactType, FeatureSlug
...
def _run_checkpoint(parsed) -> int:
    ...
    from shadowbot.standardise.undo_redo import UndoRedoManager
