...
def _get_tools(tool_names: List[str]) -> List:
    ...
    try:
        ...
        console.print("[red]Error: shadowbotagents not installed[/red]")
...
def tracker_main(ctx: typer.Context):
    ...
    Commands:
        ...
        shadowbot tracker run "Search for Python best practices"
        
        shadowbot tracker judge "What is 2+2?" --expected "4"
        
        shadowbot tracker tools
        
        shadowbot tracker batch tasks.json
    """
    pass
...
def tracker_run(
    ...
    Examples:
        ...
        shadowbot tracker run "Search for Python best practices and summarize"
        
        shadowbot tracker run "Read config.yaml and explain its structure" -v
        
        shadowbot tracker run "Find trending AI news" --tools search_web,web_crawl
    """
...
def tracker_batch(
    ...
    Example:
        ...
        shadowbot tracker batch tasks.json -o results.json
    """
    import json
...
def tracker_tools():
    ...
    console.print("[dim]  shadowbot tracker 'task' --tools search_web,read_file[/dim]")
...
def tracker_judge(
    ...
    Examples:
        ...
        shadowbot tracker judge "Calculate fibonacci(10) using execute_code"
        
        shadowbot tracker judge "Search for AI news" --criteria "Must use search_web"
        
        shadowbot tracker judge "What is 2+2?" --expected "4" --threshold 8.0
    """
    # Resolve tools
    tool_names = AUTONOMY_DEFAULT_TOOLS.copy()
    if extended:
    ...
    try:
        ...
        console.print("[red]Error: shadowbotagents.eval not available[/red]")
        console.print("[dim]Install with: pip install shadowbotagents[/dim]")
    except Exception as e:
