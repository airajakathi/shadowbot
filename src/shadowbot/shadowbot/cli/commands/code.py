"""
Code command group for ShadowBot CLI.
...
def code_main(
    ...
    For browser-based code UI, use: shadowbot ui code
    
    Examples:
        shadowbot code
        shadowbot code "Refactor this function"
        shadowbot code --model gpt-4o --workspace ./src
        shadowbot code "Fix the bug" --file main.py
        shadowbot code "What is 2+2?" --profile
    """
    import os
    import argparse
    ...
    if (profile or profile_deep) and not prompt:
        ...
        typer.echo("   Use: shadowbot code \"your prompt\" --profile", err=True)
