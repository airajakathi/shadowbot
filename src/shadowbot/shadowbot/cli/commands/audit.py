...
Usage:
    shadowbot audit agent-centric --scan /path/to/examples
    shadowbot audit agent-centric --fix /path/to/examples
    shadowbot audit agent-centric --check /path/to/examples
"""
...
def agent_centric(scan_path, fix_path, check_path, output_json, line_limit, only_examples, only_docs, verbose):
    ...
    Examples:
        shadowbot audit agent-centric --scan ./examples
        shadowbot audit agent-centric --fix ./examples --verbose
        shadowbot audit agent-centric --check ./examples  # Fails if non-compliant
    """
    from shadowbot.audit.agent_centric import AgentCentricAuditor, ComplianceStatus
