"""
Knowledge command group for ShadowBot CLI.
...
For answering questions with citations, use `shadowbot rag query`.
"""
...
def knowledge_index(
    ...
    Use `shadowbot rag query` to answer questions using the indexed knowledge.
    
    Examples:
        shadowbot knowledge index ./docs --user-id myuser
        shadowbot knowledge index paper.pdf --collection research --agent-id research_agent
        shadowbot knowledge index ./data --backend chroma --profile
    """
    from rich.console import Console
...
def knowledge_search(
    ...
    For answers with citations, use `shadowbot rag query`.
    
    Examples:
        shadowbot knowledge search "capital of France" --user-id myuser
        shadowbot knowledge search "main findings" --collection research --top-k 10
        shadowbot knowledge search "Python tutorial" --hybrid --backend chroma
    """
    from rich.console import Console
...
def knowledge_add(
    ...
    This is a backward-compatible alias for `shadowbot knowledge index`.
    
    Examples:
        shadowbot knowledge add ./docs
        shadowbot knowledge add paper.pdf --collection research
    """
...
def knowledge_list(
    ...
    if not collections:
        ...
        console.print("Create one with: shadowbot knowledge index ./docs --collection myknowledge")
        return
