"""
Session command group for ShadowBot CLI.
...
def session_resume(
    ...
    if not session:
        output.print_error(
            ...
            remediation="Use 'shadowbot session list' to see available sessions"
        )
        raise typer.Exit(1)
...
def session_import(
    ...
    try:
        from shadowbot.cli.interactive import InteractiveCore
