"""
ACP command group for ShadowBot CLI.
...
def acp_main(
    ...
    DEPRECATED: Use `shadowbot serve acp` instead.
    """
    import sys
    
    # Print deprecation warning
    print("\n\033[93m⚠ DEPRECATION WARNING:\033[0m", file=sys.stderr)
    print("\033[93m'shadowbot acp' is deprecated and will be removed in a future version.\033[0m", file=sys.stderr)
    print("\033[93mPlease use 'shadowbot serve acp' instead.\033[0m\n", file=sys.stderr)
