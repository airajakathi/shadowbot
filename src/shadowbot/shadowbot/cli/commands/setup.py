"""
Setup command group for ShadowBot CLI.
...
def setup_config(
    ...
    if show:
        if ENV_FILE.exists():
            ...
            output.console.print("Run [cyan]shadowbot setup[/cyan] to create one.")
...
def setup_reset(
    ...
    try:
        ...
        output.console.print("Run [cyan]shadowbot setup[/cyan] to configure again.")
    except Exception as e:
