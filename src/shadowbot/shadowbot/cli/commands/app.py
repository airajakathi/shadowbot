...
Usage:
    shadowbot app                    # Start server with default config
    shadowbot app --port 9000        # Start on custom port
    shadowbot app --config app.yaml  # Load from config file
    shadowbot app --reload           # Enable auto-reload for development
"""
...
@click.option("--name", "-n", type=str, default="ShadowBot App", help="Application name")
def app_command(
    port: int,
    host: str,
    config: Optional[str],
    ...
    Examples:
        ...
        shadowbot app --port 9000
        
        # Enable auto-reload for development
        shadowbot app --reload
        
        # Load agents from config file
        shadowbot app --config agents.yaml
    """
