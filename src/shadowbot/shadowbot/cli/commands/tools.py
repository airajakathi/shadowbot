"""
Tools command group for ShadowBot CLI.
...
def tools_list(
    ...
    Shows tools from:
    - Built-in tools (shadowbotagents.tools)
    - Local tools.py (if present)
    - External tools (shadowbot-tools package)
    """
...
def tools_validate(
    ...
    - Local tools.py
    - Built-in tools (shadowbotagents.tools)
    - External tools (shadowbot-tools)
    """
    import yaml
    ...
    if not missing:
        ...
        console.print("\n[yellow]Hint: Run 'shadowbot tools list' to see available tools.[/yellow]")
        raise typer.Exit(1)
...
def tools_info(
    ...
    if tool is None:
        ...
        console.print("[yellow]Hint: Run 'shadowbot tools list' to see available tools.[/yellow]")
        raise typer.Exit(1)
    ...
    if name in available:
        ...
        if "Local tool" in desc:
            ...
            console.print("\n[blue]Source:[/blue] shadowbot-tools package")
        else:
            console.print("\n[blue]Source:[/blue] shadowbotagents.tools (built-in)")
