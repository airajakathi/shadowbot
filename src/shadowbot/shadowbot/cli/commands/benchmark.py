"""
Benchmark command group for ShadowBot CLI.
...
def benchmark_profile(
    ...
    Examples:
        shadowbot benchmark profile "What is 2+2?"
        shadowbot benchmark profile "Hi" --iterations 5
        shadowbot benchmark profile "Hi" --deep --limit 50
        shadowbot benchmark profile "Hi" --deep --format json --output results.json
    """
    try:
...
def benchmark_compare(
    ...
    Compares OpenAI SDK, ShadowBot Agent, ShadowBot CLI, and LiteLLM.
    
    Examples:
        shadowbot benchmark compare "Hi"
        shadowbot benchmark compare "What is 2+2?" --iterations 3
    """
    try:
        from ..features.benchmark import BenchmarkHandler
    except ImportError as e:
...
def benchmark_sdk(
    ...
    Examples:
        shadowbot benchmark sdk "Hi"
        shadowbot benchmark sdk "What is 2+2?" --iterations 5
    """
    try:
        from ..features.benchmark import BenchmarkHandler
    except ImportError as e:
...
def benchmark_agent(
    ...
    """
    Benchmark ShadowBot Agent vs SDK baseline.
    
    Examples:
        shadowbot benchmark agent "Hi"
        shadowbot benchmark agent "What is 2+2?" --iterations 5
    """
    try:
        from ..features.benchmark import BenchmarkHandler
    except ImportError as e:
    ...
    report = handler.run_full_benchmark(
        prompt=prompt, 
        iterations=iterations, 
        paths=["openai_sdk", "shadowbot_agent"],
        verbose=True
    )
...
def benchmark_cli(
    ...
    """
    Benchmark ShadowBot CLI vs SDK baseline.
    
    Examples:
        shadowbot benchmark cli "Hi"
        shadowbot benchmark cli "What is 2+2?" --iterations 5
    """
    try:
        from ..features.benchmark import BenchmarkHandler
    except ImportError as e:
    ...
    report = handler.run_full_benchmark(
        prompt=prompt, 
        iterations=iterations, 
        paths=["openai_sdk", "shadowbot_cli", "shadowbot_cli_profile"],
        verbose=True
    )
...
def benchmark_workflow(
    ...
    """
    Benchmark ShadowBot Workflow (single and multi-agent) vs SDK baseline.
    
    Examples:
        shadowbot benchmark workflow "Hi"
        shadowbot benchmark workflow "What is 2+2?" --iterations 5
    """
    try:
        from ..features.benchmark import BenchmarkHandler
    except ImportError as e:
    ...
    report = handler.run_full_benchmark(
        prompt=prompt, 
        iterations=iterations, 
        paths=["openai_sdk", "shadowbot_workflow_single", "shadowbot_workflow_multi"],
        verbose=True
    )
...
def benchmark_litellm(
    ...
    Examples:
        shadowbot benchmark litellm "Hi"
        shadowbot benchmark litellm "What is 2+2?" --iterations 5
    """
    try:
        from ..features.benchmark import BenchmarkHandler
    except ImportError as e:
    ...
    report = handler.run_full_benchmark(
        prompt=prompt, 
        iterations=iterations, 
        paths=["openai_sdk", "shadowbot_litellm", "litellm_standalone"],
        verbose=True
    )
