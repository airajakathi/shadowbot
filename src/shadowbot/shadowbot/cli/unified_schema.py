"""
Unified Configuration Schema for ShadowBot CLI/YAML/Python interfaces.
...
try:
    from shadowbotagents.config.protocols import (
    ...
    # Fallback when shadowbotagents not available
