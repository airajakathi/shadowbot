...
Usage: shadowbot "prompt" --mcp "npx -y @modelcontextprotocol/server-filesystem ."
"""
...
class MCPHandler(FlagHandler):
    ...
    Example:
        shadowbot "List files" --mcp "npx -y @modelcontextprotocol/server-filesystem ."
        shadowbot "Search web" --mcp "npx -y @modelcontextprotocol/server-brave-search" --mcp-env "BRAVE_API_KEY=xxx"
    """
    ...
    def check_dependencies(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if importlib.util.find_spec("shadowbotagents") is not None:
                ...
                if MCP is not None:
                    return True, ""
            return False, "MCP requires shadowbotagents with MCP support"
        except ImportError:
