"""
Examples Execution System for ShadowBot.
...
class RunReport:
    ...
    def __post_init__(self):
        ...
        try:
            ...
            self.shadowbot_version = __version__
        except ImportError:
            self.shadowbot_version = "unknown"
...
class ReportGenerator:
    ...
    def generate_json(self, report: RunReport) -> Path:
        ...
        data = {
            "metadata": {
                ...
                "shadowbot_version": report.shadowbot_version,
    ...
    def generate_markdown(self, report: RunReport) -> Path:
        ...
        lines = [
            ...
            f"**ShadowBot**: {report.shadowbot_version}",
        ]
...
class ExamplesExecutor:
    ...
    def _get_pythonpath(self) -> List[str]:
        ...
        for _ in range(5):  # Look up to 5 levels
            ...
            # Also check for shadowbot-agents and shadowbot directly
            for pkg in ["shadowbot-agents", "shadowbot"]:
