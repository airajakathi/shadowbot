...
- shadowbot "prompt"
- shadowbot chat
- shadowbot chat "prompt"
- shadowbot code
- shadowbot code "prompt"
- shadowbot run agents.yaml

NOT supported for:
- shadowbot ui ... (browser-based)
- shadowbot tui (Textual TUI)
- shadowbot call (long-running server)
"""
...
def reject_profiling_for_command(command_name: str):
    ...
    if command_name in PROFILING_INELIGIBLE_COMMANDS:
        raise typer.BadParameter(
            ...
            f"  shadowbot \"prompt\" --profile\n"
            f"  shadowbot chat \"prompt\" --profile\n"
            f"  shadowbot code \"prompt\" --profile\n"
            f"  shadowbot run agents.yaml --profile"
        )
...
def run_with_profiling(
    ...
    try:
        ...
        raise ImportError("shadowbotagents not installed. Install with: pip install shadowbotagents")
