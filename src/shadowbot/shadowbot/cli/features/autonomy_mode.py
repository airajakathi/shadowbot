"""
Autonomy Modes for ShadowBot CLI.
...
try:
    from shadowbotagents.config.feature_configs import AutonomyLevel as _AutonomyLevel
except ImportError:
...
class AutonomyMode(Enum):
    ...
    Values are identical to shadowbotagents.config.feature_configs.AutonomyLevel.
...
class AutonomyModeHandler:
    """
    Handler for integrating autonomy modes with ShadowBot CLI.
    """
