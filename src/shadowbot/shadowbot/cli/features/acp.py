"""
ACP CLI handler for ShadowBot.

Provides the `shadowbot acp` command for IDE/editor integration.
"""
...
def setup_acp_subparser(subparsers) -> None:
    ...
    acp_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "to connect to ShadowBot agents via JSON-RPC over stdio."
        ),
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  shadowbot acp                    # Start with defaults
  shadowbot acp --debug            # Enable debug logging
  shadowbot acp --resume --last    # Resume last session
  shadowbot acp --allow-write      # Enable file writes
  shadowbot acp -m gpt-4o          # Use specific model
