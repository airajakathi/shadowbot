...
All commands use the canonical `shadowbot registry` prefix.
"""
...
class RegistryHandler:
    ...
    def _print_help(self):
        """Print help message."""
        print("""
ShadowBot Registry Commands

Usage: shadowbot registry <command> [options]
...
Examples:
  shadowbot registry serve
  shadowbot registry serve --port 7777 --token mysecret
  shadowbot registry serve --read-only
...
""")
    ...
    def cmd_serve(self, args: List[str]) -> int:
        ...
        try:
            from shadowbot.recipe.server import run_server
            from shadowbot.recipe.registry import DEFAULT_REGISTRY_PATH
    ...
    def cmd_status(self, args: List[str]) -> int:
        ...
        try:
            from shadowbot.recipe.registry import HttpRegistry
