"""
Profile Suite Runner for ShadowBot CLI.
...
class ProfileSuiteRunner:
    ...
    def __init__(
        ...
        self.output_dir = Path(output_dir) if output_dir else Path("/tmp/shadowbot_profile_suite")
    ...
    def _collect_metadata(self) -> Dict[str, Any]:
        ...
        import platform
        try:
            from shadowbot.version import __version__ as shadowbot_version
        except ImportError:
            shadowbot_version = "unknown"
        
        return {
            "python_version": platform.python_version(),
            "platform": platform.platform(),
            "shadowbot_version": shadowbot_version,
    ...
    def _format_report(self, result: SuiteResult) -> str:
        ...
        lines = []
        lines.append("=" * 70)
        lines.append("ShadowBot Profile Suite Report")
        lines.append("=" * 70)
        lines.append("")
        ...
        lines.append(f"  ShadowBot:        {result.metadata.get('shadowbot_version', 'N/A')}")
        lines.append("")
