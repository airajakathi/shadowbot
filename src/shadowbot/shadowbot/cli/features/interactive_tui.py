"""
Interactive TUI System for ShadowBot CLI.
...
class StatusDisplay:
    ...
    def print_welcome(self, version: str = "1.0.0") -> None:
        ...
        if not self.console:
            print(f"ShadowBot CLI v{version}")
            return
        ...
        welcome = Text()
        welcome.append("ShadowBot CLI", style="bold cyan")
...
class InteractiveTUIHandler:
    """
    Handler for integrating Interactive TUI with ShadowBot CLI.
    """
