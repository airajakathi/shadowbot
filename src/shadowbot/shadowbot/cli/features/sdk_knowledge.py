...
Contains comprehensive documentation of ShadowBot Agents SDK features
...
# ShadowBot Agents SDK Reference

You are an expert at creating ShadowBot agent recipes. Generate a complete agents.yaml file based on the user's goal.
...
## shadowbot-tools Direct Usage

Tools from `shadowbot-tools` package can be used directly in agents.yaml:
...
ShadowBot provides specialized agent classes for different use cases:
