"""
JSONL Display Mode for ShadowBot CLI.
...
Usage:
    shadowbot "prompt" --display jsonl 2>/tmp/events.jsonl
...
Event Types:
    ...
    - autonomy_step: Autonomy iteration info (ShadowBot unique)
    - error: Error event
...
class JsonlDisplay:
    ...
    # P3/G2: Autonomy-specific events (ShadowBot unique!)
