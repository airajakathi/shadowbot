...
1. Image Description (Vision) - Analyze existing images using vision-capable LLMs
   Usage: shadowbot "Describe this image" --image path/to/image.png

2. Image Generation - Generate new images from text prompts
   Usage: shadowbot "A sunset over mountains" --image-generate
"""
...
class ImageHandler(FlagHandler):
    ...
    Example:
        shadowbot "Describe this image" --image photo.png
        shadowbot "What's in this image?" --image /path/to/image.jpg
        shadowbot "Count the objects" --image image1.png,image2.png
    """
...
class ImageGenerateHandler(FlagHandler):
    ...
    Example:
        shadowbot "A sunset over mountains" --image-generate
        shadowbot "A cat wearing a hat" --image-generate --llm dall-e-3
    """
