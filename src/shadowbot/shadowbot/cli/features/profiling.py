"""
ShadowBot CLI Profiling Commands

Provides CLI commands for profiling agent execution.

Usage:
    shadowbot profile run "task" --output report.html
    shadowbot profile report --format json
    shadowbot profile benchmark --iterations 10
"""
...
def handle_profile_command(args) -> int:
    ...
    if subcommand == 'run':
        ...
        print("Usage: shadowbot profile <run|report|benchmark|flamegraph|summary>")
        return 1
