"""
Sandboxed Execution System for ShadowBot CLI.
...
class SubprocessSandbox:
    ...
    def _setup_temp_dir(self) -> Path:
        ...
        if self._temp_dir is None:
            self._temp_dir = Path(tempfile.mkdtemp(prefix="shadowbot_sandbox_"))
...
class SandboxExecutorHandler:
    """
    Handler for integrating Sandbox Execution with ShadowBot CLI.
