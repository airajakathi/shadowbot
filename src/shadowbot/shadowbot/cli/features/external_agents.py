...
Usage:
    shadowbot "Refactor the code" --external-agent claude
    shadowbot "Analyze codebase" --external-agent gemini
    shadowbot "Fix bugs" --external-agent codex
    shadowbot "Add tests" --external-agent cursor
"""
...
class ExternalAgentsHandler(FlagHandler):
    ...
    Example:
        shadowbot "Refactor the auth module" --external-agent claude
        shadowbot "Analyze this codebase" --external-agent gemini
    """
    ...
    def check_dependencies(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if importlib.util.find_spec("shadowbot.integrations") is not None:
                return True, ""
    ...
    def get_integration(self, name: str, **options):
        ...
        import importlib
        module = importlib.import_module(f"shadowbot.integrations.{module_name}")
