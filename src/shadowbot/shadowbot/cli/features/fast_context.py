...
Usage: shadowbot "Find authentication code" --fast-context ./src
...
class FastContextHandler(FlagHandler):
    ...
    Example:
        shadowbot "Find authentication code" --fast-context ./src
        shadowbot "Explain the database schema" --fast-context /path/to/project
    """
