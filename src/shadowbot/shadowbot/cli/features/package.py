...
All commands use the canonical `shadowbot` or `shadowbot package` prefix.
...
class PackageHandler:
    ...
    def _print_help(self):
        """Print help message."""
        print("""
ShadowBot Package Commands

Usage: shadowbot package <command> [options]
       shadowbot install <spec...>
       shadowbot uninstall <pkg...>

Commands:
  install     Install Python packages (shortcut: shadowbot install)
  uninstall   Uninstall Python packages (shortcut: shadowbot uninstall)
  list        List installed packages
...
Examples:
  ...
  shadowbot install "requests>=2.28" httpx
  shadowbot uninstall requests
  shadowbot package list
  shadowbot package search langchain
  shadowbot package index show
  shadowbot package index set https://my-index.example.com/simple
...
""")
    ...
    def _index_add(self, args: List[str]) -> int:
        ...
        print(f"  shadowbot install <pkg> --extra-index-url {args[0]} --allow-extra-index")
    ...
    def _index_remove(self, args: List[str]) -> int:
        ...
        print(f"  shadowbot package index set {DEFAULT_INDEX_URL}")
