...
from shadowbot.auto import TOOL_CATEGORIES, TASK_KEYWORD_TO_TOOLS
...
'''
    ...
    def generate_tools_py(self, tools: List[str]) -> str:
        ...
        Notes:
            ...
            - search_web: Works with standard import from shadowbotagents.tools
            - tavily_*: Imported from shadowbotagents.tools (not shadowbot_tools)
        """
...
Auto-generated by shadowbot recipe create.
"""
...
cli:
  command: shadowbot recipe run {name}
  examples:
    - shadowbot recipe run {name}
    - shadowbot recipe run {name} --input "custom input"
