"""
Output Styles CLI Feature for ShadowBot.

Provides CLI commands for managing output styles.

Commands:
- shadowbot output status        # Show current style
- shadowbot output set <style>   # Set output style
"""
...
def handle_output_command(args: list) -> int:
    ...
    if command == "status":
        ...
        if len(args) < 2:
            handler._print_error("Usage: shadowbot output set <style>")
...
[cyan]shadowbot output status[/cyan]
    Show current output style settings

[cyan]shadowbot output set <style>[/cyan]
    Set output style
...
[cyan]shadowbot output help[/cyan]
...
"""
        ...
        print("  shadowbot output status       - Show current settings")
        print("  shadowbot output set <style>  - Set output style")
        print("  shadowbot output help         - Show this help")
        print("")
        print("Styles: concise, detailed, technical, conversational, structured, minimal")
