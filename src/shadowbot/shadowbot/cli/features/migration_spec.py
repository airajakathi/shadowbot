...
to convert code from various agent framework patterns to ShadowBot format.
...
class PatternSpec:
    ...
    target_equivalent: str  # ShadowBot equivalent
    parameter_mapping: Dict[str, str]  # source_param -> shadowbot_param
    notes: str = ""
...
class MigrationSpec:
    ...
    def to_prompt(self) -> str:
        ...
        lines = [
            ...
            "",
            "Use this specification to convert agent code to ShadowBot format.",
            "",
            "## Agent Patterns",
            ""
        ]
    ...
    return MigrationSpec(
        agent_patterns=[
            PatternSpec(
                ...
                target_equivalent="from shadowbotagents import Agent",
                parameter_mapping={
                    "role": "role",
                    "goal": "goal",
                    "backstory": "backstory",
        ...
        task_patterns=[
            PatternSpec(
                ...
                target_equivalent="from shadowbotagents import Task",
                parameter_mapping={
        ...
        team_patterns=[
            PatternSpec(
                ...
                target_equivalent="from shadowbotagents import AgentTeam",
                parameter_mapping={
                    "agents": "agents",
            ...
            PatternSpec(
                ...
                target_equivalent="from shadowbotagents import AgentFlow",
                parameter_mapping={
                    "name": "name",
                    "steps": "steps",
                    "description": "description",
        ...
        import_patterns={
            ...
            "from X.agent import Agent": "from shadowbotagents import Agent",
            "from X import Agent": "from shadowbotagents import Agent",
            "from X import Task": "from shadowbotagents import Task",
            "from X.team import Team": "from shadowbotagents import AgentTeam",
            "from X import Crew": "from shadowbotagents import AgentTeam",
            "from X.workflow import Workflow": "from shadowbotagents import AgentFlow",
...
# ShadowBot reference code for the LLM to understand target format
PRAISONAI_REFERENCE = '''
# ShadowBot Agent Framework Reference
