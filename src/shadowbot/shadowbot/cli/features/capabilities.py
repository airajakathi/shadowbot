...
class CapabilitiesHandler:
    ...
    def handle_audio(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot audio <transcribe|speech> [options]")
            print("\nSubcommands:")
    ...
    def _handle_audio_transcribe(args, remaining_args):
        """Handle: shadowbot audio transcribe <file> [options]"""
        parser = argparse.ArgumentParser(prog="shadowbot audio transcribe")
        ...
        from shadowbot.capabilities.audio import transcribe
    ...
    def _handle_audio_speech(args, remaining_args):
        """Handle: shadowbot audio speech <text> [options]"""
        parser = argparse.ArgumentParser(prog="shadowbot audio speech")
        ...
        from shadowbot.capabilities.audio import speech
    ...
    def handle_images(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot images <generate|edit> [options]")
            print("\nSubcommands:")
    ...
    def _handle_images_generate(args, remaining_args):
        """Handle: shadowbot images generate <prompt> [options]"""
        parser = argparse.ArgumentParser(prog="shadowbot images generate")
        ...
        from shadowbot.capabilities.images import image_generate
    ...
    def _handle_images_edit(args, remaining_args):
        """Handle: shadowbot images edit <image> <prompt> [options]"""
        parser = argparse.ArgumentParser(prog="shadowbot images edit")
        ...
        from shadowbot.capabilities.images import image_edit
    ...
    def handle_files(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot files <upload|list|get|delete> [options]")
            print("\nSubcommands:")
    ...
    def _handle_files_upload(args, remaining_args):
        """Handle: shadowbot files upload <file> [options]"""
        parser = argparse.ArgumentParser(prog="shadowbot files upload")
        ...
        from shadowbot.capabilities.files import file_create
    ...
    def _handle_files_list(args, remaining_args):
        """Handle: shadowbot files list [options]"""
        parser = argparse.ArgumentParser(prog="shadowbot files list")
        ...
        from shadowbot.capabilities.files import file_list
    ...
    def _handle_files_get(args, remaining_args):
        """Handle: shadowbot files get <file_id>"""
        parser = argparse.ArgumentParser(prog="shadowbot files get")
        ...
        from shadowbot.capabilities.files import file_retrieve
    ...
    def _handle_files_delete(args, remaining_args):
        """Handle: shadowbot files delete <file_id>"""
        parser = argparse.ArgumentParser(prog="shadowbot files delete")
        parser.add_argument("file_id", help="File ID")
        ...
        from shadowbot.capabilities.files import file_delete
    ...
    def handle_embed(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot embed")
        ...
        from shadowbotagents.embedding import embedding
    ...
    def handle_rerank(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot rerank")
        ...
        from shadowbot.capabilities.rerank import rerank
    ...
    def handle_moderate(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot moderate")
        ...
        from shadowbot.capabilities.moderations import moderate
    ...
    def handle_ocr(args, unknown_args):
        """Handle ocr command."""
        parser = argparse.ArgumentParser(prog="shadowbot ocr")
        ...
        from shadowbot.capabilities.ocr import ocr
    ...
    def handle_batches(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot batches <create|list|get|cancel> [options]")
            print("\nSubcommands:")
    ...
    def _handle_batches_create(args, remaining_args):
        """Handle: shadowbot batches create <file_id>"""
        parser = argparse.ArgumentParser(prog="shadowbot batches create")
        ...
        from shadowbot.capabilities.batches import batch_create
    ...
    def _handle_batches_list(args, remaining_args):
        """Handle: shadowbot batches list"""
        from shadowbot.capabilities.batches import batch_list
    ...
    def _handle_batches_get(args, remaining_args):
        """Handle: shadowbot batches get <batch_id>"""
        parser = argparse.ArgumentParser(prog="shadowbot batches get")
        ...
        from shadowbot.capabilities.batches import batch_retrieve
    ...
    def _handle_batches_cancel(args, remaining_args):
        """Handle: shadowbot batches cancel <batch_id>"""
        parser = argparse.ArgumentParser(prog="shadowbot batches cancel")
        parser.add_argument("batch_id", help="Batch ID")
        ...
        from shadowbot.capabilities.batches import batch_cancel
    ...
    def handle_vector_stores(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot vector-stores <create|search> [options]")
            print("\nSubcommands:")
    ...
    def _handle_vector_stores_create(args, remaining_args):
        """Handle: shadowbot vector-stores create <name>"""
        parser = argparse.ArgumentParser(prog="shadowbot vector-stores create")
        ...
        from shadowbot.capabilities.vector_stores import vector_store_create
    ...
    def _handle_vector_stores_search(args, remaining_args):
        """Handle: shadowbot vector-stores search <store_id> <query>"""
        parser = argparse.ArgumentParser(prog="shadowbot vector-stores search")
        ...
        from shadowbot.capabilities.vector_stores import vector_store_search
    ...
    def handle_assistants(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot assistants <create|list> [options]")
            print("\nSubcommands:")
    ...
    def _handle_assistants_create(args, remaining_args):
        """Handle: shadowbot assistants create [options]"""
        parser = argparse.ArgumentParser(prog="shadowbot assistants create")
        ...
        from shadowbot.capabilities.assistants import assistant_create
    ...
    def _handle_assistants_list(args, remaining_args):
        """Handle: shadowbot assistants list"""
        from shadowbot.capabilities.assistants import assistant_list
    ...
    def handle_fine_tuning(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot fine-tuning <create|list> [options]")
            print("\nSubcommands:")
    ...
    def _handle_fine_tuning_create(args, remaining_args):
        """Handle: shadowbot fine-tuning create <file_id>"""
        parser = argparse.ArgumentParser(prog="shadowbot fine-tuning create")
        ...
        from shadowbot.capabilities.fine_tuning import fine_tuning_create
    ...
    def _handle_fine_tuning_list(args, remaining_args):
        """Handle: shadowbot fine-tuning list"""
        from shadowbot.capabilities.fine_tuning import fine_tuning_list
    ...
    def handle_completions(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot completions")
        ...
        if not parsed.prompt:
            print("Usage: shadowbot completions <prompt> [options]")
            return 1
        
        from shadowbot.capabilities.completions import chat_completion
    ...
    def handle_messages(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot messages <create|count-tokens> [options]")
            return 1
    ...
    def _handle_messages_create(args, remaining_args):
        """Handle: shadowbot messages create <prompt>"""
        parser = argparse.ArgumentParser(prog="shadowbot messages create")
        ...
        from shadowbot.capabilities.messages import messages_create
    ...
    def _handle_count_tokens(args, remaining_args):
        """Handle: shadowbot messages count-tokens <text>"""
        parser = argparse.ArgumentParser(prog="shadowbot messages count-tokens")
        ...
        from shadowbot.capabilities.messages import count_tokens
    ...
    def handle_guardrails(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot guardrails")
        ...
        from shadowbot.capabilities.guardrails import apply_guardrail
    ...
    def handle_rag(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot rag")
        ...
        from shadowbot.capabilities.rag import rag_query
    ...
    def handle_realtime(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot realtime")
        ...
        from shadowbot.capabilities.realtime import realtime_connect
    ...
    def handle_videos(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot videos")
        ...
        from shadowbot.capabilities.videos import video_generate
    ...
    def handle_a2a(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot a2a")
        ...
        from shadowbot.capabilities.a2a import a2a_send
    ...
    def handle_containers(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: shadowbot containers <create|files> [options]")
            return 1
    ...
    def _handle_container_create(args, remaining_args):
        """Handle: shadowbot containers create"""
        parser = argparse.ArgumentParser(prog="shadowbot containers create")
        ...
        from shadowbot.capabilities.containers import container_create
    ...
    def _handle_container_files(args, remaining_args):
        """Handle: shadowbot containers files <action>"""
        if not remaining_args:
            print("Usage: shadowbot containers files <read|write|list> [options]")
            return 1
        ...
        if action == "read":
            parser = argparse.ArgumentParser(prog="shadowbot containers files read")
            ...
            from shadowbot.capabilities.container_files import container_file_read
            ...
            parser = argparse.ArgumentParser(prog="shadowbot containers files list")
            parser.add_argument("container_id", help="Container ID")
            ...
            from shadowbot.capabilities.container_files import container_file_list
    ...
    def handle_passthrough(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot passthrough")
        ...
        from shadowbot.capabilities.passthrough import passthrough
        import json
    ...
    def handle_responses(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot responses")
        ...
        from shadowbot.capabilities.responses import responses_create
    ...
    def handle_search(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="shadowbot search")
        parser.add_argument("query", help="Search query")
        ...
        from shadowbot.capabilities.search import search
