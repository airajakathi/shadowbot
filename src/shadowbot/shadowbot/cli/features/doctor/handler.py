"""
Doctor CLI handler for ShadowBot.
...
class DoctorHandler(CommandHandler):
    """
    Handler for the 'shadowbot doctor' command.
    ...
    def _parse_args(self, args: List[str]) -> argparse.Namespace:
        ...
        parser = argparse.ArgumentParser(
            prog="shadowbot doctor",
            description="ShadowBot health checks and diagnostics",
        )
    ...
    def execute(self, action: str, action_args: List[str], **kwargs) -> int:
        ...
        if args.version:
            ...
            print(f"ShadowBot Doctor v{__version__}")
            return 0
