...
class DoctorEngine:
    ...
    def get_environment_summary(self) -> EnvironmentSummary:
        ...
        shadowbotagents_version = "unknown"
        
        try:
            from shadowbot.version import __version__ as pai_version
            shadowbot_version = pai_version
        except ImportError:
            pass
        
        try:
            import shadowbotagents
            shadowbotagents_version = getattr(shadowbotagents, "__version__", "unknown")
        except ImportError:
            pass
        ...
        return EnvironmentSummary(
            ...
            shadowbotagents_version=shadowbotagents_version,
