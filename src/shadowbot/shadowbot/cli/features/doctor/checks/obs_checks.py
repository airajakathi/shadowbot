...
@register_check(
    id="obs_shadowbot_telemetry",
    title="ShadowBot Telemetry",
    description="Check ShadowBot built-in telemetry",
    category=CheckCategory.OBSERVABILITY,
    severity=CheckSeverity.INFO,
)
def check_obs_shadowbot_telemetry(config: DoctorConfig) -> CheckResult:
    """Check ShadowBot built-in telemetry."""
    ...
    try:
        ...
        if telemetry_enabled:
            return CheckResult(
                ...
                category=CheckCategory.OBSERVABILITY,
                status=CheckStatus.PASS,
                message="ShadowBot telemetry enabled",
            )
        else:
            return CheckResult(
                id="obs_shadowbot_telemetry",
                ...
                category=CheckCategory.OBSERVABILITY,
                status=CheckStatus.SKIP,
                message="ShadowBot telemetry available but not enabled",
        ...
        return CheckResult(
            ...
            category=CheckCategory.OBSERVABILITY,
            status=CheckStatus.SKIP,
            message="ShadowBot telemetry module not available",
        )
