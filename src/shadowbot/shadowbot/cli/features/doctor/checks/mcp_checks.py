...
@register_check(
    id="mcp_shadowbot_integration",
    title="ShadowBot MCP Integration",
    description="Check ShadowBot MCP integration",
    category=CheckCategory.MCP,
    severity=CheckSeverity.LOW,
)
def check_mcp_shadowbot_integration(config: DoctorConfig) -> CheckResult:
    """Check ShadowBot MCP integration."""
    try:
        ...
        return CheckResult(
            ...
            category=CheckCategory.MCP,
            status=CheckStatus.PASS,
            message="ShadowBot MCP integration available",
        )
        ...
        return CheckResult(
            ...
            details=str(e),
            remediation="Install with: pip install shadowbotagents[mcp]",
        )
