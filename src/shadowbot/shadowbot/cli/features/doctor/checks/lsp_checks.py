"""
LSP health checks for ShadowBot Doctor.
"""
...
def check_lsp_module(config=None) -> CheckResult:
    ...
    try:
        ...
        spec = importlib.util.find_spec("shadowbotagents.lsp")
        ...
        if spec is not None:
            return CheckResult(
                ...
                metadata={"module": "shadowbotagents.lsp"}
            )
        else:
            return CheckResult(
                id="lsp_module",
                ...
                remediation="Install shadowbotagents with LSP support"
            )
...
def check_lsp_client(config=None) -> CheckResult:
    ...
    try:
        from shadowbotagents.lsp import LSPClient  # noqa: F401
