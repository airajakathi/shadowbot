...
@register_check(
    id="skills_shadowbot_integration",
    title="ShadowBot Skills Integration",
    description="Check ShadowBot skills module",
    category=CheckCategory.SKILLS,
    severity=CheckSeverity.LOW,
)
def check_skills_shadowbot_integration(config: DoctorConfig) -> CheckResult:
    """Check ShadowBot skills module."""
    try:
        from shadowbotagents.skills import SkillManager
        return CheckResult(
            id="skills_shadowbot_integration",
            title="ShadowBot Skills Integration",
            category=CheckCategory.SKILLS,
            status=CheckStatus.PASS,
            message="ShadowBot skills module available",
        )
