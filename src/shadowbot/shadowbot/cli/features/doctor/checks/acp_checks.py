"""
ACP health checks for ShadowBot Doctor.
"""
...
def check_acp_module(config=None) -> CheckResult:
    ...
    try:
        ...
        spec = importlib.util.find_spec("shadowbot.acp")
        ...
        if spec is not None:
            ...
            return CheckResult(
                ...
                remediation="ACP module should be part of shadowbot package"
            )
...
def check_acp_server(config=None) -> CheckResult:
    ...
    try:
        from shadowbot.acp import ACPServer  # noqa: F401
