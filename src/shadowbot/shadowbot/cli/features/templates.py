...
class TemplatesHandler:
    ...
    def loader(self):
        ...
        if self._loader is None:
            from shadowbot.templates import TemplateLoader
    ...
    def registry(self):
        ...
        if self._registry is None:
            from shadowbot.templates import TemplateRegistry
    ...
    def cache(self):
        ...
        if self._cache is None:
            from shadowbot.templates import TemplateCache
    ...
    def _print_help(self):
        """Print help message."""
        help_text = """
[bold cyan]ShadowBot Templates[/bold cyan]

[bold]Usage:[/bold]
  shadowbot templates <command> [options]
...
[bold]Examples:[/bold]
  shadowbot templates list
  shadowbot templates search video
  shadowbot templates info transcript-generator
  shadowbot templates install github:MervinPraison/agent-recipes/transcript-generator
  shadowbot templates run transcript-generator ./audio.mp3
  shadowbot templates add github:user/repo/my-template
  shadowbot templates add-sources github:MervinPraison/Agent-Recipes
  shadowbot init my-project --template transcript-generator
"""
        try:
    ...
    def cmd_list(self, args: List[str]) -> int:
        ...
        try:
            from shadowbot.templates.discovery import TemplateDiscovery
    ...
    def cmd_search(self, args: List[str]) -> int:
        ...
        if not args or args[0].startswith("--"):
            print("Usage: shadowbot templates search <query>")
            return 1
        ...
        try:
            from shadowbot.templates import search_templates
    ...
    def cmd_info(self, args: List[str]) -> int:
        ...
        if not args or args[0].startswith("--"):
            print("Usage: shadowbot templates info <template>")
            return 1
        ...
        try:
            ...
            if discovered:
                ...
                from shadowbot.templates import load_template
            ...
            from shadowbot.templates.dependency_checker import DependencyChecker
...
"""
    ...
    def cmd_install(self, args: List[str]) -> int:
        ...
        if not args or args[0].startswith("--"):
            print("Usage: shadowbot templates install <uri>")
            return 1
        
        uri = args[0]
        
        try:
            from shadowbot.templates import install_template
    ...
    def cmd_cache(self, args: List[str]) -> int:
        ...
        if not args:
            print("Usage: shadowbot templates cache <clear|list|size>")
            return 1
        ...
        if subcmd == "clear":
            ...
            try:
                from shadowbot.templates import clear_cache
    ...
    def cmd_run(self, args: List[str]) -> int:
        ...
        if not args or args[0].startswith("--"):
            print("Usage: shadowbot templates run <template> [args...] [--strict-tools] [--offline]")
            return 1
        ...
        try:
            from shadowbot.templates.loader import TemplateLoader
            from shadowbot.templates.discovery import TemplateDiscovery
            ...
            if strict_tools:
                from shadowbot.templates.dependency_checker import DependencyChecker, StrictModeError
                checker = DependencyChecker()
                try:
            ...
            tool_registry = None
            from shadowbot.templates.tool_override import create_tool_registry_with_overrides, resolve_tools
            ...
            if "agents" in workflow_config and "tasks" in workflow_config:
                ...
                from shadowbotagents import Workflow
    ...
    def cmd_init(self, args: List[str]) -> int:
        ...
        if not args or args[0].startswith("--"):
            print("Usage: shadowbot templates init <project-name> --template <template>")
            return 1
        ...
        try:
            ...
            print("  shadowbot run workflow.yaml")
    ...
    def cmd_add(self, args: List[str]) -> int:
        ...
        """
        if not args:
            print("[red]Usage: shadowbot templates add <source>[/red]")
    ...
    def cmd_add_sources(self, args: List[str]) -> int:
        ...
        """
        if not args:
            print("[red]Usage: shadowbot templates add-sources <source>[/red]")
            return 1
    ...
    def cmd_remove_sources(self, args: List[str]) -> int:
        ...
        """
        if not args:
            print("[red]Usage: shadowbot templates remove-sources <source>[/red]")
            return 1
    ...
    def cmd_browse(self, args: List[str]) -> int:
        ...
        # Default catalog URL
        catalog_url = "https://mervinpraison.github.io/shadowbot-template-catalog"
    ...
    def cmd_catalog(self, args: List[str]) -> int:
        ...
        """
        if not args:
            print("Usage: shadowbot templates catalog <build|sync> [options]")
            print("\nSubcommands:")
            print("  build     Build catalog locally")
            print("  sync      Sync catalog sources from GitHub")
            print("\nExamples:")
            print("  shadowbot templates catalog build --out ./dist")
            print("  shadowbot templates catalog sync --source agent-recipes")
            return 0
    ...
    def _catalog_build(self, args: List[str]) -> int:
        ...
        catalog_repo = Path.home() / "shadowbot-template-catalog"
        if not catalog_repo.exists():
            # Try to find it relative to this package
            possible_paths = [
                Path(__file__).parent.parent.parent.parent.parent.parent / "shadowbot-template-catalog",
                Path.cwd() / "shadowbot-template-catalog",
            ]
