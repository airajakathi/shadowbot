"""
Onboarding Wizard for ShadowBot.
...
class OnboardingWizard:
    """Interactive onboarding wizard for ShadowBot setup."""
    ...
    def run(self, output_dir: str = ".") -> bool:
        ...
        console.print(Panel.fit(
            "[bold blue]Welcome to ShadowBot![/bold blue]\n\n"
        ...
        console.print("  2. pip install shadowbotagents")
    ...
    def _create_agent_yaml(self, project_dir: str) -> None:
        ...
        yaml_content = f"""# ShadowBot Agent Configuration
# Generated by shadowbot init
...
"""
    ...
    def _create_main_py(self, project_dir: str) -> None:
        """Create main.py file."""
        main_content = f'''"""
{self.config['project_name']} - ShadowBot Agent
...
- [ShadowBot Documentation](https://docs.praison.ai)
...
def add_init_parser(subparsers) -> None:
    ...
    init_parser = subparsers.add_parser(
        "init",
        help="Initialize a new ShadowBot project",
    )
