...
Usage:
    shadowbot "Complex task" --handoff "researcher,writer,editor"
    shadowbot "Task" --handoff "a,b" --handoff-policy summary --handoff-timeout 60
"""
...
class HandoffHandler(FlagHandler):
    ...
    Example:
        shadowbot "Research and write article" --handoff "researcher,writer"
        shadowbot "Analyze data" --handoff "analyst,viz" --handoff-policy summary
        shadowbot "Task" --handoff "a,b" --handoff-timeout 60 --handoff-max-depth 5
    """
    ...
    def check_dependencies(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if importlib.util.find_spec("shadowbotagents") is not None:
                return True, ""
            return False, "shadowbotagents not installed"
        except ImportError:
            return False, "shadowbotagents not installed. Install with: pip install shadowbotagents"
    ...
    def create_agents_with_handoff(
        ...
        from shadowbotagents import Agent, handoff
