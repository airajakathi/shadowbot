"""
Interactive Default Tools Provider for ShadowBot.
...
Usage:
    from shadowbot.cli.features.interactive_tools import (
...
def _load_basic_tools() -> Dict[str, Callable]:
    """Lazy load basic tools from shadowbotagents."""
    tools = {}
    ...
    try:
        from shadowbotagents.tools import list_files
...
def get_interactive_tools(
    ...
    Both `shadowbot tui launch` and `praison "prompt"` should use this.
