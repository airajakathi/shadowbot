"""
Main TUI Application for ShadowBot.
...
if TEXTUAL_AVAILABLE:
    ...
    from shadowbot.cli.session import get_session_store, UnifiedSession

    class TUIApp(App):
        """
        ShadowBot Terminal User Interface Application.
...
"""
    ...
    class TUIApp:
        ...
        def __init__(self, *args, **kwargs):
            raise ImportError(
                "Textual is required for TUI. Install with: pip install shadowbot[tui]"
            )
