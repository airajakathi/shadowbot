"""
Debug and Simulation CLI Commands for ShadowBot TUI.
...
def create_debug_app():
    ...
    def tui_main(
        ...
        chat, use: shadowbot chat
        
        Examples:
            shadowbot tui
            shadowbot tui --workspace ./project
            shadowbot tui --session abc123
        """
    ...
    def tui_snapshot(
        ...
        if json_output:
            ...
            # Pretty print
            console.print("─" * 60)
            console.print(f"◉ ShadowBot Snapshot │ {time.strftime('%Y-%m-%d %H:%M:%S')}")
            console.print("─" * 60)
...
def create_doctor_command():
    ...
    def doctor_tui():
        ...
        # Print results
        console.print("\n[bold]ShadowBot TUI Diagnostics[/bold]\n")
        ...
        if all_ok:
            ...
            console.print("\n[red]Some checks failed. Run 'pip install shadowbot[tui]' to install missing dependencies.[/red]")
            raise typer.Exit(1)
