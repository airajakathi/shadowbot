"""
Thinking Budgets CLI Feature for ShadowBot.

Provides CLI commands for managing thinking budgets.

Commands:
- shadowbot thinking status      # Show current budget
- shadowbot thinking set <level> # Set budget level
- shadowbot thinking stats       # Show usage statistics
"""
...
def handle_thinking_command(args: list) -> int:
    ...
    if command == "status":
        ...
        if len(args) < 2:
            handler._print_error("Usage: shadowbot thinking set <level>")
...
[cyan]shadowbot thinking status[/cyan]
    Show current thinking budget settings

[cyan]shadowbot thinking set <level>[/cyan]
...
[cyan]shadowbot thinking stats[/cyan]
    Show usage statistics

[cyan]shadowbot thinking help[/cyan]
...
"""
        ...
        print("  shadowbot thinking status       - Show current settings")
        print("  shadowbot thinking set <level>  - Set budget level")
        print("  shadowbot thinking stats        - Show usage statistics")
        print("  shadowbot thinking help         - Show this help")
        print("")
