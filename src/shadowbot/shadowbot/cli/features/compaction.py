"""
Context Compaction CLI Feature for ShadowBot.

Provides CLI commands for managing context compaction.

Commands:
- shadowbot compaction status        # Show settings
- shadowbot compaction set <strategy> # Set strategy
- shadowbot compaction stats         # Show statistics
"""
...
def handle_compaction_command(args: list) -> int:
    ...
    if command == "status":
        ...
        if len(args) < 2:
            handler._print_error("Usage: shadowbot compaction set <strategy>")
...
[cyan]shadowbot compaction status[/cyan]
    Show current compaction settings

[cyan]shadowbot compaction set <strategy>[/cyan]
    Set compaction strategy
...
[cyan]shadowbot compaction stats[/cyan]
    Show compaction statistics

[cyan]shadowbot compaction help[/cyan]
...
"""
        ...
        print("  shadowbot compaction status         - Show current settings")
        print("  shadowbot compaction set <strategy> - Set compaction strategy")
        print("  shadowbot compaction stats          - Show statistics")
        print("  shadowbot compaction help           - Show this help")
        print("")
        print("Strategies: truncate, sliding, summarize, smart")
