...
class SkillsHandler:
    ...
    def validate_skill(self, skill_path: str) -> dict:
        ...
        """
        from shadowbotagents.skills import validate
    ...
    def create_skill(
        ...
        compatibility = compatibility or "Works with ShadowBot Agents"
...
description: {description}
license: Apache-2.0
compatibility: Works with ShadowBot Agents, Claude Code, and other Agent Skills compatible tools
metadata:
  author: user
  version: "1.0"
---
