...
class ObservabilityHandler(FlagHandler):
    ...
    Commands:
        shadowbot obs list          - List available providers
        shadowbot obs doctor        - Check provider connectivity
        shadowbot obs init <name>   - Initialize a provider
    """
    ...
    def check_dependencies(self) -> Tuple[bool, str]:
        ...
        try:
            from shadowbot_tools.observability import obs
            return True, ""
        except ImportError:
            return False, "Observability requires shadowbot-tools. Install with: pip install shadowbot-tools"
    ...
    def list_providers(self) -> Dict[str, Any]:
        ...
        try:
            from shadowbot_tools.observability.manager import ObservabilityManager
            from shadowbot_tools.observability.config import PROVIDER_ENV_KEYS
    ...
    def doctor(self, provider: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": "shadowbot-tools not installed",
                "enabled": False,
            }
    ...
    def _execute_init(self, provider: str, **kwargs) -> bool:
        ...
        if not provider:
            self.print_status("Provider name required. Usage: shadowbot obs init <provider>", "error")
            return False
    ...
    def apply_to_agent_config(self, config: Dict[str, Any], flag_value: Any) -> Dict[str, Any]:
        ...
        if flag_value:
            try:
                ...
                self.print_status("Observability requires shadowbot-tools", "warning")
