...
Usage: shadowbot todo list
       shadowbot todo add "New task"
       shadowbot "Plan project" --todo
"""
...
class TodoHandler(CommandHandler, FlagHandler):
    ...
    Example:
        shadowbot todo list
        shadowbot todo add "Implement feature X"
        shadowbot todo complete 1
        shadowbot "Plan project" --todo
    """
    ...
    def get_help_text(self) -> str:
        return """
Todo Commands:
  shadowbot todo list                    - List all todos
  shadowbot todo add <task>              - Add a new todo
  shadowbot todo complete <id>           - Mark todo as complete
  shadowbot todo delete <id>             - Delete a todo
  shadowbot todo clear                   - Clear all todos

Flag Usage:
  shadowbot "Plan project" --todo        - Generate todos from task
"""
    ...
    def action_add(self, args: List[str], **kwargs) -> Dict[str, Any]:
        ...
        """
        if not args:
            self.print_status("Usage: shadowbot todo add <task>", "error")
            return {}
    ...
    def action_complete(self, args: List[str], **kwargs) -> bool:
        ...
        """
        if not args:
            self.print_status("Usage: shadowbot todo complete <id>", "error")
            return False
    ...
    def action_delete(self, args: List[str], **kwargs) -> bool:
        ...
        """
        if not args:
            self.print_status("Usage: shadowbot todo delete <id>", "error")
            return False
