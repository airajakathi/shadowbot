"""
Git Commit Attribution for ShadowBot CLI.
...
class AttributionManager:
    ...
    Usage:
        ...
        # "Fix bug in parser\n\nAssisted-by: gpt-4o via ShadowBot <ai@praison.ai>"
    """
    ...
    def remove_attribution(self, message: str) -> str:
        """Remove ShadowBot attribution from commit message."""
        lines = message.split("\n")
        filtered = [
            line for line in lines
            if not (
                "ShadowBot" in line and
