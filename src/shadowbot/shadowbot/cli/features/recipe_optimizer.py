"""
Recipe Optimizer for ShadowBot.
...
def _crawl_url_for_optimizer(url: str) -> str:
    ...
    try:
        ...
        from shadowbotagents.tools import web_crawl
...
class RecipeOptimizer:
    ...
    Usage:
        ...
        from shadowbotagents.eval import Judge, JudgeCriteriaConfig
    ...
    def run_iteration(
        ...
        from shadowbot.replay import ContextTraceReader, ContextEffectivenessJudge
        ...
        try:
            ...
            from shadowbot.replay.judge import JudgeReport
            return JudgeReport(
...
"""
        ...
        prompt = f"""You are an expert at optimizing ShadowBot agent recipes. Your goal is to INCREASE the score from {overall_score}/10 to 8.0+/10.
{input_context_section}
...
"""
    ...
    def _validate_yaml_structure(self, yaml_content: str) -> Tuple[bool, List[str]]:
        """
        Validate YAML structure for ShadowBot recipe requirements.
    ...
    def apply_improvements(
        ...
        prompt = f"""You are an expert at modifying ShadowBot agent YAML files.
