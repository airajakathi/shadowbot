"""
Feature Parity Tracker for ShadowBot SDKs.
...
Usage:
    python -m shadowbot._dev.parity.generator --write
    python -m shadowbot._dev.parity.generator --check
    
Documentation Parity:
    python -m shadowbot._dev.parity.docs_generator --write
    python -m shadowbot._dev.parity.docs_generator --check
"""
