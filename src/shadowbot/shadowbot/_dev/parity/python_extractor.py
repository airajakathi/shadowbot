"""
Python Feature Extractor for ShadowBot SDK.

Extracts features from shadowbotagents package using AST analysis.
...
class PythonFeatureExtractor:
    ...
    def extract(self) -> PythonFeatures:
        ...
        # Extract from shadowbotagents __init__.py
    ...
    def _categorize(self, module_path: str) -> str:
        ...
        # Remove 'shadowbotagents.' prefix
        if module_path.startswith('shadowbotagents.'):
            module_path = module_path[len('shadowbotagents.'):]
