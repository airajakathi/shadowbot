"""
Rust Feature Extractor for ShadowBot SDK.

Extracts features from shadowbot-rust package using regex-based analysis.
"""
...
class RustFeatureExtractor:
    """
    Extracts features from shadowbot-rust package using regex analysis.
    ...
    def __init__(self, repo_root: Optional[Path] = None):
        ...
        self.rust_pkg = self.repo_root / "src" / "shadowbot-rust" / "shadowbot"
