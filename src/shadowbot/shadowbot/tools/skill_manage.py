...
from shadowbotagents.skills import SkillMutatorProtocol
...
class BasicSkillMutator(SkillMutatorProtocol):
    ...
    Writes to ~/.shadowbot/skills/pending/ by default.
    Skills are promoted to ~/.shadowbot/skills/ only after approval.
    """
    ...
    def __init__(self, skills_dir: Optional[str] = None):
        ...
        Args:
            skills_dir: Base skills directory (defaults to ~/.shadowbot/skills)
        """
        if skills_dir is None:
            home = Path.home()
            skills_dir = home / ".shadowbot" / "skills"
