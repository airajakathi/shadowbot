...
Maps ShadowBot memory operations to MCP tools.
"""
...
def register_memory_tools() -> None:
    ...
    @register_tool("shadowbot.memory.show")
    ...
    @register_tool("shadowbot.memory.add")
    def memory_add(
        content: str,
    ...
    @register_tool("shadowbot.memory.search")
    def memory_search(
        query: str,
        limit: int = 10,
    ) -> str:
    ...
    @register_tool("shadowbot.memory.clear")
    ...
    @register_tool("shadowbot.memory.sessions")
