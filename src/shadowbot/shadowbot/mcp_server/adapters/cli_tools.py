...
Maps ShadowBot CLI features to MCP tools:
- Workflow management
- Rules management
- Hooks management
- Session management
...
def register_cli_tools() -> None:
    ...
    # Workflow tools
    @register_tool("shadowbot.workflow.list")
    ...
    @register_tool("shadowbot.workflow.validate")
    ...
    @register_tool("shadowbot.workflow.show")
    ...
    @register_tool("shadowbot.workflow.auto")
    ...
    @register_tool("shadowbot.rules.list")
    def rules_list() -> str:
        """List active rules."""
        try:
            import os
    ...
    @register_tool("shadowbot.rules.show")
    ...
    @register_tool("shadowbot.rules.create")
    ...
    @register_tool("shadowbot.rules.delete")
    ...
    # Hooks tools
    @register_tool("shadowbot.hooks.list")
    def hooks_list() -> str:
        """List registered hooks."""
        try:
            from shadowbotagents.hooks import get_hook_manager
    ...
    @register_tool("shadowbot.hooks.stats")
    def hooks_stats() -> str:
    ...
    # Session tools
    @register_tool("shadowbot.session.list")
    def session_list() -> str:
        """List active sessions."""
        try:
            from shadowbotagents.session import SessionManager
    ...
    @register_tool("shadowbot.session.info")
    ...
    @register_tool("shadowbot.session.delete")
    ...
    # Todo tools
    @register_tool("shadowbot.todo.list")
    def todo_list() -> str:
        """List todo items."""
        try:
            import os
    ...
    @register_tool("shadowbot.todo.add")
    ...
    @register_tool("shadowbot.todo.complete")
    ...
    @register_tool("shadowbot.todo.delete")
    ...
    # Tools discovery
    @register_tool("shadowbot.tools.list")
    def tools_list() -> str:
        """List available tools."""
        try:
            from shadowbotagents.tools import get_available_tools
    ...
    @register_tool("shadowbot.tools.info")
    def tools_info(tool_name: str) -> str:
        """Get information about a tool."""
        try:
            from shadowbotagents.tools import get_tool_info
    ...
    @register_tool("shadowbot.tools.search")
    def tools_search(query: str) -> str:
        """Search for tools by name or description."""
        try:
            from shadowbotagents.tools import search_tools
    ...
    # Schedule tools
    @register_tool("shadowbot.schedule.list")
    def schedule_list() -> str:
        """List scheduled tasks."""
        try:
            from shadowbotagents.tools.schedule_tools import schedule_list as _schedule_list
    ...
    @register_tool("shadowbot.schedule.add")
    def schedule_add(
        task_name: str,
        cron: str,
        workflow_path: str,
        ...
        try:
            from shadowbotagents.tools.schedule_tools import schedule_add as _schedule_add
    ...
    @register_tool("shadowbot.schedule.remove")
    def schedule_remove(task_name: str) -> str:
        """Remove a scheduled task."""
        try:
            from shadowbotagents.tools.schedule_tools import schedule_remove as _schedule_remove
    ...
    # Deploy tools
    @register_tool("shadowbot.deploy.validate")
    ...
    @register_tool("shadowbot.deploy.status")
    def deploy_status(deployment_name: Optional[str] = None) -> str:
        """Get deployment status."""
        try:
            from shadowbot.deploy import get_deployment_status
    ...
    @register_tool("shadowbot.doctor.env")
    def doctor_env() -> str:
    ...
    @register_tool("shadowbot.doctor.config")
    ...
    @register_tool("shadowbot.doctor.mcp")
    def doctor_mcp() -> str:
    ...
    # Eval tools
    @register_tool("shadowbot.eval.accuracy")
    def eval_accuracy(
        agent_config: str,
        input_text: str,
        expected_output: str,
        ...
        try:
            from shadowbotagents.eval import AccuracyEval
    ...
    @register_tool("shadowbot.eval.performance")
    def eval_performance(
        ...
        try:
            from shadowbotagents.eval import PerformanceEval
            from shadowbotagents import Agent
    ...
    @register_tool("shadowbot.mcp_config.list")
    def mcp_config_list() -> str:
        """List MCP server configurations."""
        try:
            from shadowbotagents.memory.mcp_config import MCPConfigManager
    ...
    @register_tool("shadowbot.mcp_config.show")
    ...
    @register_tool("shadowbot.mcp_config.enable")
    ...
    @register_tool("shadowbot.mcp_config.disable")
