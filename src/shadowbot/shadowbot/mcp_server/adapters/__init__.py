...
Adapters that convert ShadowBot capabilities, CLI features, and agent operations
...
def __getattr__(name):
    ...
    elif name == "register_shadowbot_tools":
        from .tools_bridge import register_shadowbot_tools
        return register_shadowbot_tools
