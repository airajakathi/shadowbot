...
Registers MCP resources for ShadowBot:
- shadowbot://memory/sessions
- shadowbot://memory/{session_id}
- shadowbot://workflows
- shadowbot://tools
- shadowbot://agents
- shadowbot://knowledge/sources
"""
...
def register_mcp_resources() -> None:
    ...
    @register_resource("shadowbot://memory/sessions")
    ...
    @register_resource("shadowbot://workflows")
    ...
    @register_resource("shadowbot://tools")
    ...
    @register_resource("shadowbot://agents")
    ...
    @register_resource("shadowbot://knowledge/sources")
    ...
    @register_resource("shadowbot://config")
    ...
    @register_resource("shadowbot://mcp/status")
