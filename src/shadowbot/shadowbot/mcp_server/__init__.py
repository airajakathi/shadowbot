"""
ShadowBot MCP Server Module

Exposes ShadowBot capabilities as an MCP server that any MCP client can connect to.
...
Usage:
    ...
    # Programmatic usage
    from shadowbot.mcp_server import MCPServer, RecipeMCPAdapter
