"""
ShadowBot Profiler Module

Standardized profiling for performance monitoring across shadowbot and shadowbot-agents.
...
Usage:
    from shadowbot.profiler import Profiler, profile, profile_imports
...
class Profiler:
    ...
    def _generate_simple_flamegraph_svg(cls, data: List[Dict[str, Any]]) -> str:
        ...
        svg_parts = [
            ...
            f'<text x="10" y="20">ShadowBot Profiling Flamegraph (Total: {total_time:.2f}ms)</text>'
        ]
...
<html>
<head>
    <title>ShadowBot Profiling Report</title>
    <style>
...
<body>
    <h1>ShadowBot Profiling Report</h1>
