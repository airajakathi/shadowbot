...
Provides versioned discovery document format for all ShadowBot serve features.
...
class DiscoveryDocument:
    """
    Unified discovery document for ShadowBot servers.
    
    This document is served at /__shadowbot__/discovery and provides
    a consistent interface for discovering endpoints across all provider types.
    """
    schema_version: str = SCHEMA_VERSION
    server_name: str = "shadowbot"
