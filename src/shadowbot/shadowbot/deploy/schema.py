...
"""
  ...
  cloud:
    provider: aws
    region: us-east-1
    service_name: shadowbot-service
    cpu: "256"
    memory: "512"
    min_instances: 1
    max_instances: 10
    # image: your-registry/shadowbot-app:latest
    # cluster_name: shadowbot-cluster
"""
  ...
  cloud:
    ...
    region: eastus
    service_name: shadowbot-service
    resource_group: shadowbot-rg
    subscription_id: your-subscription-id
    cpu: "0.5"
    memory: "1.0"
    min_instances: 1
    max_instances: 10
    # image: your-registry.azurecr.io/shadowbot-app:latest
"""
  ...
  cloud:
    ...
    min_instances: 1
    max_instances: 10
    # image: gcr.io/your-project-id/shadowbot-app:latest
"""
        else:
            deploy_yaml = """deploy:
  type: cloud
