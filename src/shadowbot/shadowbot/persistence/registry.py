...
def _register_builtin_conversation_stores():
    ...
    def _json(url=None, path=None, **kwargs):
        ...
        return JSONConversationStore(path=url or path or "./shadowbot_conversations", **kwargs)
...
CONVERSATION_STORES = StoreRegistry("conversation", "shadowbot.conversation_stores")
KNOWLEDGE_STORES = StoreRegistry("knowledge", "shadowbot.knowledge_stores") 
STATE_STORES = StoreRegistry("state", "shadowbot.state_stores")
