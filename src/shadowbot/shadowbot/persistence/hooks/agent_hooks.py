...
Provides wrapper functions to add persistence capabilities to ShadowBot agents
...
def wrap_agent_with_persistence(
    ...
    Example:
        from shadowbot.persistence import PersistenceOrchestrator
        from shadowbot.persistence.hooks import wrap_agent_with_persistence
...
class PersistentAgent:
    ...
    Example:
        from shadowbot.persistence import PersistenceOrchestrator
        from shadowbot.persistence.hooks import PersistentAgent
        from shadowbotagents import Agent
...
def create_persistent_session(
    ...
    Example:
        from shadowbot.persistence import PersistenceOrchestrator
        from shadowbot.persistence.hooks import create_persistent_session
        from shadowbotagents import Agent
