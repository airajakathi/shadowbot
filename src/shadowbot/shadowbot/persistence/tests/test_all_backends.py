...
Run with: python -m pytest shadowbot/persistence/tests/test_all_backends.py -v
"""
...
sys.path.insert(0, '/Users/praison/shadowbot-package/src/shadowbot')

from shadowbot.persistence.conversation.base import ConversationStore, ConversationSession, ConversationMessage
from shadowbot.persistence.knowledge.base import KnowledgeStore, KnowledgeDocument
from shadowbot.persistence.state.base import StateStore
from shadowbot.persistence.orchestrator import PersistenceOrchestrator
from shadowbot.persistence.factory import create_conversation_store, create_knowledge_store, create_state_store
...
def test_postgresql_conversation_store():
    ...
    try:
        ...
        store = PostgresConversationStore(
            host='localhost', port=5432, database='shadowbot',
...
def test_qdrant_knowledge_store():
    ...
    try:
        from shadowbot.persistence.knowledge.qdrant import QdrantKnowledgeStore
...
def test_chroma_knowledge_store():
    ...
    try:
        from shadowbot.persistence.knowledge.chroma import ChromaKnowledgeStore
...
def test_memory_state_store():
    ...
    try:
        from shadowbot.persistence.state.memory import MemoryStateStore
...
def run_all_tests():
    ...
    print("=" * 60)
    print("ShadowBot Persistence Layer - Comprehensive TDD Tests")
    print("=" * 60)
