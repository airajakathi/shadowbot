"""
Configuration handling for ShadowBot persistence layer.
...
class PersistenceConfig:
    """
    Configuration for ShadowBot persistence layer.
    
    Example:
        config = PersistenceConfig(
            conversation_store="postgres",
            conversation_url="postgresql://localhost:5432/shadowbot",
