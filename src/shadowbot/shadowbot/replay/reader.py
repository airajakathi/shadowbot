"""
Context Trace Reader for ShadowBot.
...
class ContextTraceReader:
    ...
    def _load_events(self) -> List:
        ...
        try:
            from shadowbotagents.trace.context_events import ContextEvent
        except ImportError:
            # Fallback: return raw dicts if shadowbotagents not available
            ContextEvent = None
