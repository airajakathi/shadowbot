"""ShadowBot Bot UI — Bot interface with step visualization.

Loaded by ``shadowbot ui bot`` → ``aiui run app.py``.
...
aiui.set_branding(title="ShadowBot Bot", logo="🤖")
...
async def on_welcome():
    ...
    await aiui.say("🤖 Hi! I'm your ShadowBot Bot. I can help with various tasks and show you step-by-step reasoning.")
