"""
n8n Integration for ShadowBot Workflows

This module provides bidirectional conversion between ShadowBot YAML workflows
...
Example:
    from shadowbot.n8n import YAMLToN8nConverter, preview_workflow
