"""
systemd service management for ShadowBot bots (Linux).
...
def _generate_unit(config_path: str) -> str:
    ...
    return f"""[Unit]
Description=ShadowBot Bot Service
After=network.target

[Service]
Type=simple
WorkingDirectory={working_dir}
ExecStart={python} -m shadowbot gateway start --config {abs_config}
Restart=always
RestartSec=5
