"""
Base components for ShadowBot Scheduler.
...
- PraisonAgentExecutor: Executor for ShadowBot agents
"""
...
class PraisonAgentExecutor(ExecutorInterface):
    ...
    def __init__(self, agent):
        ...
        Args:
            agent: ShadowBot Agent instance (must have start() method)
        """
        self.agent = agent
