"""
Agent Scheduler for ShadowBot - Run agents periodically 24/7.

This module provides scheduling capabilities for running ShadowBot agents
...
class AgentScheduler:
    """
    Scheduler for running ShadowBot agents periodically.
    ...
    def _update_state_if_daemon(self):
        ...
        try:
            ...
            state_dir = os.path.expanduser("~/.shadowbot/schedulers")
    ...
    def from_recipe(
        ...
        *,
        ...
        """
        from shadowbot.recipe.bridge import resolve, execute_resolved_recipe, get_recipe_task_description
