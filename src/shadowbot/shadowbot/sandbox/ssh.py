"""
SSH Sandbox implementation for ShadowBot.
...
class SSHSandbox:
    ...
    Example:
        from shadowbot.sandbox import SSHSandbox
    ...
    Requires: asyncssh package (install with pip install shadowbot[ssh])
    """
    ...
    async def start(self) -> None:
        ...
        if not self.is_available:
            raise RuntimeError(
                "SSH backend not available. Install with: pip install shadowbot[ssh]"
            )
