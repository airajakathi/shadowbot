"""
Sandlock Sandbox implementation for ShadowBot.
...
class SandlockSandbox:
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install 'shadowbot[sandbox]' or pip install sandlock"
            )
    ...
    async def start(self) -> None:
        ...
        self._temp_dir = tempfile.mkdtemp(prefix="shadowbot_sandlock_")
