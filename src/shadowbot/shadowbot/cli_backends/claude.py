...
try:
    from shadowbotagents import CliBackendProtocol, CliBackendConfig, CliSessionBinding, CliBackendResult, CliBackendDelta
except ImportError:
    # Fallback for testing or development
    from shadowbotagents.cli_backend.protocols import CliBackendProtocol, CliBackendConfig, CliSessionBinding, CliBackendResult, CliBackendDelta
