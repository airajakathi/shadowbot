...
class TextReader:
    ...
    def load(
        ...
        *, 
        ...
        """Load a text file."""
        from shadowbotagents.knowledge.readers import Document
...
class DirectoryReader:
    ...
    def load(
        ...
        *, 
        ...
        from shadowbotagents.knowledge.readers import get_reader_registry
...
class AutoReader:
    ...
    def load(
        ...
        *, 
        ...
        from shadowbotagents.knowledge.readers import get_reader_registry, detect_source_kind
