"""
Vector Store Adapters for ShadowBot.
...
class ChromaVectorStore:
    ...
    def add(
        ...
        if metadatas is None:
            metadatas = [{"_source": "shadowbot"} for _ in texts]
        else:
            # Ensure no empty dicts - add placeholder if empty
            metadatas = [
                m if m else {"_source": "shadowbot"} 
                for m in metadatas
            ]
    ...
    def query(
        ...
        from shadowbotagents.knowledge.vector_store import VectorRecord
...
class PineconeVectorStore:
    ...
    def __init__(
        ...
        self.index_name = index_name or self.config.get("index_name", "shadowbot")
...
def register_default_vector_stores():
    ...
    from shadowbotagents.knowledge.vector_store import get_vector_store_registry
