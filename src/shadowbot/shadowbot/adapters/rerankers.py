"""
Reranker Implementations for ShadowBot.
...
class LLMReranker:
    ...
    def rerank(
        ...
        **kwargs
        ...
        from shadowbotagents.knowledge.rerankers import RerankResult
...
Relevance score (0-10):"""
            ...
            # Check if client has a callable 'chat' method (ShadowBot Agent)
            if client is not None and hasattr(client, 'chat') and callable(getattr(client, 'chat', None)):
                # ShadowBot Agent or similar with callable chat method
...
def register_default_rerankers():
    ...
    from shadowbotagents.knowledge.rerankers import get_reranker_registry
