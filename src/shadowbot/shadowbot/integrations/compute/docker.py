...
class DockerCompute:
    ...
    Example::
        ...
        from shadowbotagents.managed import ComputeConfig
        from shadowbot.integrations.compute import DockerCompute
    ...
    def _provision_sync(self, config) -> Any:
        ...
        container = client.containers.run(
            ...
            detach=True,
            name=f"shadowbot_{instance_id}",
            environment=env,
            working_dir=config.working_dir,
            mem_limit=mem_limit,
            nano_cpus=int(cpu_count * 1e9),
            remove=False,
            labels={"shadowbot": "managed", "instance_id": instance_id},
        )
