"""
Langfuse TraceSinkProtocol Implementation for ShadowBot.
...
Architecture:
- Core SDK (shadowbotagents): Defines TraceSinkProtocol
- Wrapper (shadowbot): Implements LangfuseSink adapter (this file)
...
from shadowbotagents.trace.protocol import ActionEvent, ActionEventType, TraceSinkProtocol
from shadowbotagents.trace.context_events import ContextEvent, ContextEventType, ContextTraceSinkProtocol
...
class LangfuseSink:
    ...
    Maps ShadowBot ActionEvents to Langfuse v3+ observation API:
    ...
    def _initialize_client(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "Langfuse is not installed. Install with: pip install shadowbot[langfuse]"
            )
