"""
Docs Code Execution System for ShadowBot.
...
Usage:
    shadowbot docs run                    # Run all Python blocks
    shadowbot docs run --docs-path /path  # Custom docs path
    shadowbot docs list                   # List discovered blocks
