...
DRY: Follows the same pattern as shadowbotagents.memory.learn.stores.BaseStore.
"""
...
# DRY: Import base classes from shadowbotagents.storage
from shadowbotagents.storage.models import BaseSessionInfo
from shadowbotagents.storage.base import BaseJSONStore, list_json_sessions, cleanup_old_sessions as _cleanup_old_sessions

if TYPE_CHECKING:
    from shadowbotagents.storage.protocols import StorageBackendProtocol
...
def list_training_sessions(
    ...
    DRY: Uses list_json_sessions from shadowbotagents.storage.base.
...
def cleanup_old_sessions(
    ...
    DRY: Uses cleanup_old_sessions from shadowbotagents.storage.base.
