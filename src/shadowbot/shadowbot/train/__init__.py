...
2. **Agent Training** (`shadowbot train agents`)
...
Usage:
    ...
    shadowbot train dataset.json
    
    # Agent Training (new)
    shadowbot train agents my_agent.yaml
    shadowbot train agents my_agent.yaml --human
    shadowbot train agents my_agent.yaml --iterations 5
