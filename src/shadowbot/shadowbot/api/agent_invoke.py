...
Provides an endpoint for n8n workflows to invoke ShadowBot agents,
enabling bidirectional n8n ↔ ShadowBot integration.
"""
...
if FASTAPI_AVAILABLE and APIRouter is not None:
    ...
    async def invoke_agent(
        ...
        """
        Invoke a ShadowBot agent with a message.
        
        This endpoint is designed for n8n workflows to call ShadowBot agents,
        enabling bidirectional integration between n8n and ShadowBot.
        ...
        {
          "method": "POST",
          "url": "http://shadowbot:8000/api/v1/agents/my-agent/invoke",
          "body": {
...
def create_example_agents():
    ...
    try:
        ...
        logger.warning("shadowbotagents not available, skipping example agents")
