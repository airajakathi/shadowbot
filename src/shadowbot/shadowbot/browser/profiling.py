...
CLI:
    shadowbot browser launch "goal" --profile         # Timing summary
    shadowbot browser launch "goal" --deep-profile    # cProfile trace
"""
...
logger = logging.getLogger("shadowbot.browser.profiling")
