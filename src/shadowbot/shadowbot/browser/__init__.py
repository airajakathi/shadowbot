"""Browser automation package for ShadowBot.

Provides a bridge server for Chrome Extension ↔ ShadowBot Agent communication.

Example:
    # Start the browser server
    shadowbot browser start --port 8765
    ...
    from shadowbot.browser import CDPBrowserAgent, run_hybrid
