...
Bridges the Chrome Extension to ShadowBot agents for browser automation.
"""
...
logger = logging.getLogger("shadowbot.browser.server")
...
class BrowserServer:
    ...
    Handles communication between Chrome Extension and ShadowBot agents.
    ...
    def _get_app(self):
        ...
        app = FastAPI(
            title="ShadowBot Browser Server",
    ...
    async def _handle_connection(self, websocket):
        ...
        await websocket.send_json({
            "type": "status",
            "status": "connected",
            "message": "Connected to ShadowBot Browser Server",
            "session_id": "",
        })
    ...
    def start(self):
        ...
        logger.info(f"Starting ShadowBot Browser Server on {self.host}:{self.port}")
        print(f"\n🌐 ShadowBot Browser Server")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ShadowBot Browser Server")
