...
without requiring the ShadowBot Chrome extension. Useful for:
- Headless automation
- Environments where extensions can't be loaded
- Simpler deployment scenarios

Usage:
    shadowbot browser run "Search for AI" --engine cdp
"""
...
logger = logging.getLogger("shadowbot.browser.cdp_agent")
...
class CDPBrowserAgent:
    ...
    Example:
        ...
        await agent.run("Search for shadowbot on Google")
...
async def run_cdp_only(
    ...
    Example:
        result = await run_cdp_only(
            "Search for ShadowBot on Google",
