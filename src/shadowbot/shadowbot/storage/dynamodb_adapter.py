"""
DynamoDB Storage Adapter for ShadowBot.
...
class DynamoDBStorageAdapter:
    ...
    Implements StorageBackendProtocol from shadowbotagents.storage.protocols.
    
    Example:
        ```python
        from shadowbot.storage import DynamoDBStorageAdapter
        
        adapter = DynamoDBStorageAdapter(
            table_name="shadowbot-storage",
    ...
    def __init__(
        self,
        table_name: str = "shadowbot-storage",
        ...
        if self._table is None:
            try:
                ...
                raise ImportError(
                    ...
                    "Install with: pip install 'shadowbot[dynamodb]'"
                )
