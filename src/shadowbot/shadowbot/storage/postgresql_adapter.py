"""
PostgreSQL Storage Adapter for ShadowBot.
...
class PostgreSQLStorageAdapter:
    ...
    Example:
        ```python
        from shadowbot.storage import PostgreSQLStorageAdapter
                ...
                if self._pool is None:  # Double-check locking
                    try:
                        ...
                        raise ImportError(
                            ...
                            "Install with: pip install 'shadowbot[postgresql]'"
                        )
