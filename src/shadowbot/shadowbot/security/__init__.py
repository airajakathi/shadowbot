"""
shadowbot.security — Agent security utilities for ShadowBot.
...
Usage (selective):
    from shadowbot.security import enable_injection_defense, enable_audit_log
...
def enable_audit_log(
    ...
    Args:
        log_path: Path to the audit log file.
                  Defaults to ~/.shadowbot/audit.jsonl.
    ...
    Example:
        >>> from shadowbot.security import enable_audit_log
        >>> enable_audit_log()
    """
    from .audit import AuditLogHook
    from shadowbotagents.hooks import add_hook
...
def enable_security(
    ...
    Args:
        log_path: Audit log path (default: ~/.shadowbot/audit.jsonl).
