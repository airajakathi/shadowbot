...
DEFAULT_CREDS_DIR = os.path.join(str(Path.home()), ".shadowbot", "whatsapp")
...
class WhatsAppWebAdapter:
    ...
    rest of ShadowBot is shielded from neonize version changes.
    ...
    def __init__(
        ...
        bot_name: str = "shadowbot_whatsapp",
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install 'shadowbot[bot-whatsapp-web]' "
