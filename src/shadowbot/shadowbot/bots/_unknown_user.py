...
from shadowbotagents.bots import BotMessage
from shadowbotagents.bots.pairing_types import PairingReply, UnknownUserPolicy
    ...
    async def _send_cli_fallback(
        ...
        if bot_ctx.adapter:
            await bot_ctx.adapter.reply(
                ...
                f"Ask the owner to run: shadowbot pairing approve {channel_type} {code}"
            )