"""
Telegram Bot implementation for ShadowBot.
...
from shadowbot.bots._protocol_mixin import ChatCommandMixin, MessageHookMixin
from shadowbotagents.bots import (
    BotConfig,
    BotMessage,
    BotUser,
    BotChannel,
...
class TelegramBot(ChatCommandMixin, MessageHookMixin):
    """Telegram bot runtime for ShadowBot agents.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            from shadowbotagents.session import get_default_session_store
