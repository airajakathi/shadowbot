...
Usage:
    from shadowbot.context import OutputQueue, create_queue_middleware
...
from shadowbotagents.context.artifacts import (
    ArtifactRef,
    ArtifactMetadata,
    QueueConfig,
)
from shadowbotagents.hooks import ToolRequest, ToolResponse
