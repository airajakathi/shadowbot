"""
Server for ShadowBot Async Jobs API.
...
def start_server(
    ...
    logger.info(f"Starting ShadowBot Jobs API on {host}:{port}")
    
    uvicorn.run(
        "shadowbot.jobs.server:create_app",
        host=host,
        port=port,
        reload=reload,
        workers=workers,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ShadowBot Jobs API Server")
