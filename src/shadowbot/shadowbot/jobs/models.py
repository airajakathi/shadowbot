"""
Job Models for ShadowBot Async Jobs API.
...
class JobSubmitRequest(BaseModel):
    ...
    framework: Optional[str] = Field("shadowbot", description="Framework to use (shadowbot, crewai, autogen)")
