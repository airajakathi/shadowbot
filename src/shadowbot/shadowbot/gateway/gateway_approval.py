"""
Gateway-backed approval backend for ShadowBot.

Routes tool-execution approval requests through the ShadowBot gateway's
:class:`ExecApprovalManager`.  Implements
:class:`shadowbotagents.approval.protocols.ApprovalProtocol` so it can be
...
class GatewayApprovalBackend:
    ...
    Example::
        ...
        from shadowbot.gateway.gateway_approval import GatewayApprovalBackend
        from shadowbotagents import Agent, ApprovalConfig
    ...
    async def request_approval(self, request: ApprovalRequest) -> ApprovalDecision:
        ...
        Satisfies :class:`shadowbotagents.approval.protocols.ApprovalProtocol`.
        """
