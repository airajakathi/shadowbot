#!/usr/bin/env python3
"""
Release script for ShadowBot package.

Usage:
    python src/shadowbot/scripts/release.py

This script:
1. Reads version from shadowbot/version.py
2. Runs uv lock
3. Runs uv build
4. Commits changes
5. Creates git tag
...
def get_version() -> str:
    ...
    version_file = get_shadowbot_dir() / "shadowbot/version.py"
