...
This directory contains examples for using ShadowBot with the Agent Client Protocol (ACP).

## What is ACP?

The Agent Client Protocol (ACP) is a standardized JSON-RPC 2.0 protocol that allows code editors and IDEs to communicate with AI coding agents. It enables seamless integration between ShadowBot and editors like:
...
# Allow file writes
shadowbot acp --allow-write

# Use a specific model
shadowbot acp -m gpt-4o

# Resume last session
shadowbot acp --resume --last
```

### Python API

```python
from shadowbot.acp import serve
