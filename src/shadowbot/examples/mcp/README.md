...
shadowbot mcp list-tools --limit 10
shadowbot mcp list-tools --cursor <cursor> --json

# Search tools
shadowbot mcp tools search "query"
shadowbot mcp tools search --category memory
shadowbot mcp tools search --read-only
shadowbot mcp tools search --json

# Get tool info
shadowbot mcp tools info <tool-name>
shadowbot mcp tools info <tool-name> --json
...
```python
from shadowbot.mcp_server.registry import MCPToolRegistry
...
```python
from shadowbot.mcp_server.registry import MCPToolDefinition
