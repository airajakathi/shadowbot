...
def example_output_queue():
    ...
    from shadowbotagents.context.artifacts import ArtifactMetadata, ArtifactRef, QueueConfig
...
def example_history_store():
    ...
    from shadowbot.context import HistoryStore
...
def example_terminal_logger():
    ...
    from shadowbot.context import TerminalLogger
...
def example_setup_dynamic_context():
    ...
    from shadowbot.context import setup_dynamic_context
