...
def main():
    ...
    from shadowbot.cli.features.jobs import JobsHandler
    ...
    try:
        ...
        print("   python -m uvicorn shadowbot.jobs.server:create_app --port 8005 --factory")
