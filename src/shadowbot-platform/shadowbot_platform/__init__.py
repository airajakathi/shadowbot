"""
ShadowBot Platform — workspace, auth, issues, projects.

A separate package providing multi-tenancy, authentication, issue tracking,
and project management on top of the shadowbotagents core SDK.

Quick start::

    from shadowbot_platform import PlatformClient, create_app
...
def __getattr__(name: str):
    ...
    raise AttributeError(f"module 'shadowbot_platform' has no attribute '{name}'")
