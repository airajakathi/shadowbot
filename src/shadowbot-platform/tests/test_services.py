...
from shadowbot_platform.services.member_service import MemberService
from shadowbot_platform.services.project_service import ProjectService
...
class TestAuthService:
    ...
    async def test_authorize(self, session):
        svc = AuthService(session)
        from shadowbotagents.auth import AuthIdentity
