...
from shadowbot_platform.db.models import Workspace, Agent, _uuid, _utcnow
from shadowbot_platform.services.workspace_context import PlatformWorkspaceContext
...
class TestWorkspaceContext:
    ...
    async def test_protocol_compliance(self, session: AsyncSession):
        ...
        from shadowbotagents.auth import WorkspaceContextProtocol
        ws_id = _uuid()
        ctx = PlatformWorkspaceContext(ws_id, session)
