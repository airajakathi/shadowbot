...
from shadowbot_platform.services.auth_service import AuthService
from shadowbot_platform.services.workspace_service import WorkspaceService
from shadowbot_platform.services.issue_service import IssueService
from shadowbot_platform.services.agent_service import AgentService
from shadowbot_platform.services.label_service import LabelService
from shadowbot_platform.services.dependency_service import DependencyService
from shadowbot_platform.services.comment_service import CommentService
from shadowbot_platform.services.activity_service import ActivityService
...
class TestIssueNumbering:
    ...
    async def test_custom_issue_prefix(self, session):
        ...
        from shadowbot_platform.db.models import Workspace
