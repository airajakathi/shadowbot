# ShadowBot TypeScript Node.js AI Agents Framework

ShadowBot is a production-ready Multi AI Agents framework, designed to create AI Agents to automate and solve problems ranging from simple tasks to complex challenges. It provides a low-code solution to streamline the building and management of multi-agent LLM systems, emphasising simplicity, customisation, and effective human-agent collaboration.
...
Here are examples of different ways to use ShadowBot:

### 1. Single Agent Example

```typescript
import { Agent, AgentTeam } from 'shadowbot';
...
```typescript
import { Agent, Task, AgentTeam } from 'shadowbot';
