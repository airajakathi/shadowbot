...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts n8n trigger my-webhook \'{"data": "test"}\'',
      'shadowbot-ts n8n trigger webhook-id --base-url https://n8n.example.com',
      'shadowbot-ts n8n export my-workflow',
      'shadowbot-ts n8n export workflow --steps "Process:agent,Validate:condition"'
    ]
  };
