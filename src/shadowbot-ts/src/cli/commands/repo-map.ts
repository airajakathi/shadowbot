...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts repo-map',
      'shadowbot-ts repo-map tree ./src',
      'shadowbot-ts repo-map tree --depth 3',
      'shadowbot-ts repo-map symbols ./src',
      'shadowbot-ts repo-map tree --symbols'
    ]
  };
