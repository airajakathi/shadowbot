...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts external-agents list',
      'shadowbot-ts external-agents check claude',
      'shadowbot-ts external-agents run claude "Explain this code"',
      'shadowbot-ts external-agents run gemini "Refactor this function" --cwd ./src'
    ]
  };
