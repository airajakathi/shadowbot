 ...
 * 
 * Usage:
 *   shadowbot-ts agent chat "Hello, how are you?"
 *   shadowbot-ts agent run --instructions "You are helpful" "Tell me a joke"
 */
  ...
  switch (subcommand) {
    ...
    default:
      ...
      if (options.json || options.output === 'json') {
        ...
        await pretty.error('Usage: shadowbot-ts agent [chat|run] <prompt>');
