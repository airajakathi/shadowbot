...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts fast-context query "What is the main topic?"',
      'shadowbot-ts fast-context query "summarize" --sources "text1,text2,text3"',
      'shadowbot-ts fast-context query "find relevant" --max-tokens 2000',
      'shadowbot-ts fast-context stats',
      'shadowbot-ts fast-context clear'
    ]
  };
