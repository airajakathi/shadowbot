...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts autonomy status',
      'shadowbot-ts autonomy set suggest',
      'shadowbot-ts autonomy set auto_edit',
      'shadowbot-ts autonomy set full_auto',
      'shadowbot-ts autonomy policies suggest',
      'shadowbot-ts autonomy reset'
    ]
  };
