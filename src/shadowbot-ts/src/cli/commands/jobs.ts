...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts jobs add my-job \'{"input": "data"}\'',
      'shadowbot-ts jobs add task --priority high',
      'shadowbot-ts jobs list --status pending',
      'shadowbot-ts jobs get <job-id>',
      'shadowbot-ts jobs cancel <job-id>',
      'shadowbot-ts jobs stats',
      'shadowbot-ts jobs cleanup --days 30'
    ]
  };
