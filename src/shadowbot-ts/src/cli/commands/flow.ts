...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts flow show "Input,Process,Output"',
      'shadowbot-ts flow show "Start:start,Agent:agent,End:end"',
      'shadowbot-ts flow show --boxes',
      'shadowbot-ts flow dot "Step1,Step2,Step3" > workflow.dot'
    ]
  };
