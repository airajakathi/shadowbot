...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'shadowbot-ts checkpoints create my-checkpoint',
      'shadowbot-ts checkpoints create --state \'{"key": "value"}\'',
      'shadowbot-ts checkpoints list',
      'shadowbot-ts checkpoints restore <id>',
      'shadowbot-ts checkpoints restore  # restores latest',
      'shadowbot-ts checkpoints export <id> > checkpoint.json',
      'shadowbot-ts checkpoints import \'{"name": "imported"}\'',
      'shadowbot-ts checkpoints delete <id>'
    ]
  };
