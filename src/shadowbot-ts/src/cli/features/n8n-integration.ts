...
export class N8NIntegration {
  ...
  /**
   * Export ShadowBot workflow to n8n format
   */
  exportWorkflow(
    name: string,
    steps: Array<{
  ...
  /**
   * Map ShadowBot step type to n8n node type
   */
...
return input;
  ...
  /**
   * Import n8n workflow and convert to ShadowBot format
   */
  ...
  /**
   * Map n8n node type to ShadowBot step type
   */
