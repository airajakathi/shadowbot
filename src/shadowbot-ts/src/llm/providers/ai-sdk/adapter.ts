 ...
 * AI SDK Adapter
 * 
 * Converts between shadowbot-ts message/tool formats and AI SDK formats.
...
/**
 * Convert shadowbot-ts messages to AI SDK prompt format
 */
...
/**
 * Convert shadowbot-ts tool definitions to AI SDK format
...
/**
 * Convert AI SDK tool call to shadowbot-ts format
 */
...
/**
 * Convert shadowbot-ts tool result to AI SDK format
 */
...
/**
 * Convert AI SDK generate result to shadowbot-ts format
 */
export function fromAISDKResult(result: {
  ...
  // Map finish reason to shadowbot-ts format
...
/**
 * Map AI SDK finish reason to shadowbot-ts provider format
...
/**
 * Convert AI SDK stream chunk to shadowbot-ts format
 */
...
/**
 * Map shadowbot-ts tool choice to AI SDK format
 */
