/**
 * AI SDK Integration for shadowbot-ts
 * 
 ...
 * @example Basic usage
 * ```typescript
 * import { createAISDKBackend, registerAISDKProviders } from 'shadowbot';
 * 
...
/**
 * Register AI SDK providers with the shadowbot-ts provider registry
 ...
 * @example
 * ```typescript
 * import { registerAISDKProviders, createProvider } from 'shadowbot';
 * 
