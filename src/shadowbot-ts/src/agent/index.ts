/**
 * Agent Module - Core agent classes for ShadowBot
 * 
 * The primary exports are:
 * - Agent: Single agent with instructions, tools, and optional persistence
 * - Agents: Multi-agent orchestration (alias for ShadowBotAgents)
...
export { Agent, AgentTeam, ShadowBotAgents, Agents } from './simple';
export type { SimpleAgentConfig, AgentTeamConfig, ShadowBotAgentsConfig } from './simple';
