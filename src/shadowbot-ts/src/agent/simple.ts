 ...
 * Agent Configuration
 * 
 * The Agent class is the primary entry point for ShadowBot.
 ...
 */
export type ShadowBotAgentsConfig = AgentTeamConfig;
...
/**
 * ShadowBotAgents - Silent alias for AgentTeam (backward compatibility)
 * @deprecated Use AgentTeam instead
 */
export const ShadowBotAgents = AgentTeam;
