 ...
 * ```typescript
 * import { createRouteHandler } from 'shadowbot/ai';
 * import { streamText } from 'shadowbot/ai';
 * 
 ...
 * ```typescript
 * import { createPagesHandler } from 'shadowbot/ai';
 * import { streamText } from 'shadowbot/ai';
 * 
 ...
 * ```
 * 
 * The shadowbot package focuses on server-side functionality.
