 ...
 * ```typescript
 * import { Agent, Agents } from 'shadowbot';
...
// AgentTeam is the primary class (Python parity), Agents/ShadowBotAgents are silent aliases
export { Agent, AgentTeam, Agents, ShadowBotAgents, Router } from './agent';
export type { SimpleAgentConfig, AgentTeamConfig, ShadowBotAgentsConfig, SimpleRouterConfig, SimpleRouteConfig } from './agent';
...
// RAG Module (Python parity with shadowbotagents/rag)
export {
  RAG, createRAG,
...
// Export skills (Python parity with shadowbotagents/skills)
export {
...
// Export Telemetry (Agent-focused) - Python parity with shadowbotagents/telemetry
...
// Export Planning (simplified API) - Python parity with shadowbotagents/planning
export {
  // Core classes
...
// Export Config Module (Python parity with shadowbotagents/config)
export {
  // Enums
...
export {
  ...
  // Fast Context (Python parity with shadowbotagents/context/fast)
...
// Export Plugin Module (Python parity with shadowbotagents/plugins)
export {
  // Enums
...
// Export Display Module (Python parity with shadowbotagents/display)
export {
  // Types
...
// Export Embeddings Module (Python parity with shadowbotagents/knowledge)
export {
  // Types
...
// Export Trace Module (Python parity with shadowbotagents/trace)
export {
  // Enums
...
// Export Conditions Module (Python parity with shadowbotagents/conditions)
export {
  // Types
...
// Export Gateway/Bot Module (Python parity with shadowbotagents/gateway)
export {
  // Bot types
...
// Export Task Module (Python parity with shadowbotagents/task)
export {
