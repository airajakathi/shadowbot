/**
 * Plugin Module for ShadowBot TypeScript SDK
 * 
 * Python parity with shadowbotagents/plugins module
 * 
 * Provides:
...
/**
 * Plugin hook points.
 * Python parity: shadowbotagents/plugins/plugin.py
 */
...
/**
 * Plugin metadata.
 * Python parity: shadowbotagents/plugins/parser.py
 */
 ...
 * Python parity: shadowbotagents/plugins/protocols.py
 */
 ...
 * Python parity: shadowbotagents/plugins/manager.py
 */
 ...
 * Python parity: shadowbotagents/plugins/discovery.py
 */
...
import { Plugin, PluginHook, PluginType } from 'shadowbot';
 ...
 * Python parity: shadowbotagents/plugins/__init__.py
 */
