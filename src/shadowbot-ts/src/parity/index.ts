/**
 * Parity Module for ShadowBot TypeScript SDK
 * 
 ...
 * Python parity: shadowbotagents/agent/audio_agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/code_agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/ocr_agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/vision_agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/video_agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/realtime_agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/embedding_agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/agent.py
 */
 ...
 * Python parity: shadowbotagents/agent/deep_research.py
 */
 ...
 * Python parity: shadowbotagents/llm
 */
 ...
 * Python parity: shadowbotagents/agent/handoff.py
 */
 ...
 * Python parity: shadowbotagents/workflows/workflows.py
 */
export class Loop {
  private agents: any[];
 ...
 * Python parity: shadowbotagents/knowledge/chunking.py
 */
 ...
 * Python parity: shadowbotagents/knowledge/knowledge.py
 */
 ...
 * Python parity: shadowbotagents/session/session.py
 */
 ...
 * Python parity: shadowbotagents/context/fast.py
 */
 ...
 * Python parity: shadowbotagents/rag/rag.py
 */
 ...
 * Python parity: shadowbotagents/guardrails/guardrails.py
 */
 ...
 * Python parity: shadowbotagents/mcp/mcp.py
 */
export class MCP {
 ...
 * Python parity: shadowbotagents/agents/agents.py
 */
 ...
 * Python parity: shadowbotagents/telemetry/telemetry.py
 */
...
/**
 * Plan - Execution plan.
 * Python parity: shadowbotagents/planning/planning.py
 */
export class Plan {
  id: string;
  steps: PlanStep[];
 ...
 * Python parity: shadowbotagents/skills/loader.py
 */
 ...
 * Python parity: shadowbotagents/telemetry
 */
 ...
 * Python parity: shadowbotagents/main.py
 */
...
/**
 * Plugin class.
 * Python parity: shadowbotagents/plugins
 */
export class Plugin {
  name: string;
  version: string;
 ...
 * Python parity: shadowbotagents/trace
 */
 ...
 * Python parity: shadowbotagents/conditions
 */
 ...
 * Python parity: shadowbotagents/embedding
 */
 ...
 * Python parity: shadowbotagents/flow_display
 */
 ...
 * Python parity: shadowbotagents/llm/failover.py
 */
 ...
 * Python parity: shadowbotagents/sandbox
 */
 ...
 * Python parity: shadowbotagents/task/task.py
 */
export class Task {
  name: string;
  description: string;
 ...
 * Python parity: shadowbotagents/gateway
 */
 ...
 * Python parity: shadowbotagents/bots
 */
 ...
 * Python parity: shadowbotagents/config/presets.py
 */
 ...
 * Python parity: shadowbotagents/memory
 */
 ...
 * Python parity: shadowbotagents/config
 */
 ...
 * Python parity: shadowbotagents/config/param_resolver.py
 */
 ...
 * Python parity: shadowbotagents/config/resolvers.py
 */
 ...
 * Python parity: shadowbotagents/ui/agui
 */
export class AGUI {
...
export function get_default_plugin_dirs(): string[] {
  return ['./plugins', './shadowbot_plugins', '~/.shadowbot/plugins'];
}
...
/**
 * Evaluate condition.
 * Python parity: shadowbotagents/conditions/evaluator.py
 */
 ...
 * Python parity: shadowbotagents/embedding/dimensions.py
 */
...
/**
 * Track workflow execution.
 * Python parity: shadowbotagents/flow_display.py
 */
