/**
 * Protocols Module for ShadowBot TypeScript SDK
 * 
 * Python parity with shadowbotagents protocols
 * 
 * Provides:
...
/**
 * A2A Task state.
 * Python parity: shadowbotagents/ui/a2a/types.py
 */
 ...
 * Python parity: shadowbotagents/ui/a2a/a2a.py
 */
export class A2A {
 ...
 * Python parity: shadowbotagents/ui/agui/agui.py
 */
export class AGUI {
  private config: {
    name: string;
 ...
 * Python parity: shadowbotagents/agents/auto_rag_agent.py
 */
 ...
 * Python parity: shadowbotagents/tools
 */
export class Tools {
 ...
 * Python parity: shadowbotagents.obs
 */
 ...
 * Python parity: shadowbotagents.workflows
 */
