/**
 * Session - Unified session management for ShadowBot
 * 
 * Python parity with shadowbotagents/session/api.py
...
/**
 * A unified session management class for ShadowBot.
 * 
 * Provides:
